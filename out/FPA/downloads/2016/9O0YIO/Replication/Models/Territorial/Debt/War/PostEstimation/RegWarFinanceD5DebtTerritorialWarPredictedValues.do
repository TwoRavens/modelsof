...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Territorial/Debt/War/PostEstimation/PredictedValues.log", replace;


**************************************************************;
*Author: Jeff Carter                                         *;
*Date: Monday, December 8, 2014  09:29                             *;
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Territorial/Debt/War/PostEstimation/SimData.dta";
...
generate x_betahat0 = MG_b1*h_AutLag
    ...
    + MG_b5*h_Polity
    + MG_b6*h_Polity_War
    + MG_b7*h_TerritorialPeace
    + MG_b8*(h_TerritorialPeace*h_Polity)    
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC 
...
generate x_betahat2 =  MG_b1*x_betahat0 
    ...
    + MG_b5*h_Polity
    + MG_b6*h_Polity_War
    + MG_b7*h_TerritorialWar
    + MG_b8*(h_TerritorialWar*h_Polity)    
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC 
...
generate x_betahat01 = MG_b1*h_DemLag
    ...
    + MG_b6*h_Polity_War
    + MG_b7*h_TerritorialPeace
    + MG_b8*(h_TerritorialPeace*(h_Polity+20))    
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC 
...
generate x_betahat21 =  MG_b1*x_betahat01
    ...
    + MG_b6*(h_Polity_War+20)
    + MG_b7*h_TerritorialWar
    + MG_b8*(h_TerritorialWar*(h_Polity+20))    
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC 
...
replace x_betahat21 = exp(x_betahat21);
...
saveold "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Territorial/Debt/War/PostEstimation/PredictedValues.dta", replace;
