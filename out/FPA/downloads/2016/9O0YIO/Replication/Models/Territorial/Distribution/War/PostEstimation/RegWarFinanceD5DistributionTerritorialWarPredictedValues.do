...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Territorial/Distribution/War/PostEstimation/PredictedValues.log", replace;


**************************************************************;
*Author: Jeff Carter                                         *;
*Date: Tuesday, December 9, 2014  12:17                          *;
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Territorial/Distribution/War/PostEstimation/SimData.dta";
...
generate x_betahat0 = MG_b1*h_AutLag
    ...
    + MG_b4*h_Polity
    + MG_b5*h_Polity_War
    + MG_b6*h_TerritorialPeace
    + MG_b7*(h_TerritorialPeace*h_Polity)    
    + MG_b8*h_Cap
    + MG_b9*h_GDPpc
    + MG_b10*h_Number
    + MG_b11*h_RPC 
...
generate x_betahat2 =  MG_b1*x_betahat0 
    ...
    + MG_b4*h_Polity
    + MG_b5*h_Polity_War
    + MG_b6*h_TerritorialWar
    + MG_b7*(h_TerritorialWar*h_Polity)    
    + MG_b8*h_Cap
    + MG_b9*h_GDPpc
    + MG_b10*h_Number
    + MG_b11*h_RPC 
...
generate x_betahat01 = MG_b1*h_DemLag
    ...
    + MG_b5*h_Polity_War
    + MG_b6*h_TerritorialPeace
    + MG_b7*(h_TerritorialPeace*(h_Polity+20))    
    + MG_b8*h_Cap
    + MG_b9*h_GDPpc
    + MG_b10*h_Number
    + MG_b11*h_RPC 
...
generate x_betahat21 =  MG_b1*x_betahat01
    ...
    + MG_b5*(h_Polity_War+20)
    + MG_b6*h_TerritorialWar
    + MG_b7*(h_TerritorialWar*(h_Polity+20))    
    + MG_b8*h_Cap
    + MG_b9*h_GDPpc
    + MG_b10*h_Number
    + MG_b11*h_RPC 
...
saveold "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Territorial/Distribution/War/PostEstimation/PredictedValues.dta", replace;
