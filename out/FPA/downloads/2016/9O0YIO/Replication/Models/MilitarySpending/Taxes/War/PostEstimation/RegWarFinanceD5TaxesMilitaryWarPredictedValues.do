...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/MilitarySpending/Taxes/War/PostEstimation/PredictedValues.log", replace;


**************************************************************;
*Author: Jeff Carter                                         *;
*Date: Sunday, December 7, 2014                              *;
*Purpose: Simulating Taxes Predictions                *;
**************************************************************;
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/MilitarySpending/Taxes/War/PostEstimation/SimData.dta";
...
generate x_betahat0 = MG_b1*h_AutLag
    ...
    + MG_b3*h_Polity
    + MG_b4*h_DMilPeace
    + MG_b5*h_Polity*h_Peace
    + MG_b6*h_Polity*h_DMilPeace
    + MG_b7*h_Peace*h_DMilPeace
    + MG_b8*(h_Polity*h_Peace*h_DMilPeace)
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC
...
generate x_betahat1 =  MG_b1*x_betahat0 
    ...
    + MG_b3*h_Polity
    + MG_b4*`a'
    + MG_b5*h_Polity*h_War
    + MG_b6*(h_Polity*`a')
    + MG_b7*(h_War*`a')
    + MG_b8*(h_Polity*h_War*`a')
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC
...
generate x_betahat01 = MG_b1*h_DemLag
    ...
    + MG_b3*h_Polity
    + MG_b4*h_DMilPeace
    + MG_b5*((h_Polity+20)*h_Peace)
    + MG_b6*((h_Polity+20)*h_DMilPeace)
    + MG_b7*h_Peace*h_DMilPeace
    + MG_b8*((h_Polity+20)*h_Peace*h_DMilPeace)
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC
...
generate x_betahat11 =  MG_b1*x_betahat01
    ...
    + MG_b3*(h_Polity+20)
    + MG_b4*`a'
    + MG_b5*((h_Polity+20)*h_War)
    + MG_b6*((h_Polity+20)*`a')
    + MG_b7*(h_War*`a')
    + MG_b8*((h_Polity+20)*h_War*`a')
    + MG_b9*h_Cap
    + MG_b10*h_GDPpc
    + MG_b11*h_Number
    + MG_b12*h_RPC
