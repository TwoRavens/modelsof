...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Duration/Inflation/PostEstimation/PredictedValues.log", replace;

***********************************************************************************;
*Author: Jeff Carter                                                              *;
*Date: Wednesday, December 10, 2014                                                   *;
*Purpose: Predicted Inflation with Duration                                    *;
***********************************************************************************;



use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Duration/Inflation/PostEstimation/SimData.dta", clear;
...
generate x_betahat5 = MG_b1*x_betahat4
    + MG_b2*(h_Duration+.5)
    + MG_b3*(h_Duration+2.5)
    + MG_b4*(h_Duration+12.5)
    + MG_b5*h_Polity
    + MG_b6*h_PolityDuration
    + MG_b7*(h_PolityDuration)
    + MG_b8*(h_PolityDuration)
...
generate x_betahat6 = MG_b1*x_betahat5
    + MG_b2*(h_Duration+.6)
    + MG_b3*(h_Duration+3.6)
    + MG_b4*(h_Duration+21.6)
    + MG_b5*h_Polity
    + MG_b6*h_PolityDuration
    + MG_b7*(h_PolityDuration)
    + MG_b8*(h_PolityDuration)
...
generate x_betahat7 = MG_b1*x_betahat6
    + MG_b2*(h_Duration+.7)
    + MG_b3*(h_Duration+4.9)
    + MG_b4*(h_Duration+34.3)
    + MG_b5*h_Polity
    + MG_b6*h_PolityDuration
    + MG_b7*(h_PolityDuration)
    + MG_b8*(h_PolityDuration)
...
generate x_betahat8 = MG_b1*x_betahat7
    + MG_b2*(h_Duration+.8)
    + MG_b3*(h_Duration+6.4)
    + MG_b4*(h_Duration+51.2)
    + MG_b5*h_Polity
    + MG_b6*h_PolityDuration
    + MG_b7*(h_PolityDuration)
    + MG_b8*(h_PolityDuration)
...
generate x_betahat9 = MG_b1*x_betahat8
    + MG_b2*(h_Duration+.9)
    + MG_b3*(h_Duration+8.1)
    + MG_b4*(h_Duration+72.9)
    + MG_b5*h_Polity
    + MG_b6*h_PolityDuration
    + MG_b7*(h_PolityDuration)
    + MG_b8*(h_PolityDuration)
