...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Duration/Debt/PostEstimation/PredictedValues.log", replace;

***********************************************************************************;
*Author: Jeff Carter                                                              *;
*Date: Wednesday, December 10, 2014                                                   *;
*Purpose: Predicted Debt with Duration                                    *;
***********************************************************************************;



use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Duration/Debt/PostEstimation/SimData.dta", clear;
...
generate x_betahat0 = MG_b1*h_AutLag
    ...
    + MG_b10*(h_PolityDuration)
    + MG_b11*h_Cap
    + MG_b12*h_GDPpc
    + MG_b13*h_Number
    + MG_b14*h_RPC + MG_b15*h_Constant;
...
generate x_betahat4 = MG_b1*x_betahat3
    ...
    + MG_b3*x_betahat1
    + MG_b4*(h_Duration+.4)
    + MG_b5*(h_Duration+1.6)
    + MG_b6*(h_Duration+6.4)
    + MG_b7*h_Polity
    + MG_b8*h_PolityDuration
    + MG_b9*(h_PolityDuration)
    + MG_b10*(h_PolityDuration)
...
generate x_betahat5 = MG_b1*x_betahat4
    ...
    + MG_b3*x_betahat2
    + MG_b4*(h_Duration+.5)
    + MG_b5*(h_Duration+2.5)
    + MG_b6*(h_Duration+12.5)
    + MG_b7*h_Polity
    + MG_b8*h_PolityDuration
    + MG_b9*(h_PolityDuration)
    + MG_b10*(h_PolityDuration)
...
generate x_betahat6 = MG_b1*x_betahat5
    ...
    + MG_b3*x_betahat3
    + MG_b4*(h_Duration+.6)
    + MG_b5*(h_Duration+3.6)
    + MG_b6*(h_Duration+21.6)
    + MG_b7*h_Polity
    + MG_b8*h_PolityDuration
    + MG_b9*(h_PolityDuration)
    + MG_b10*(h_PolityDuration)
...
generate x_betahat7 = MG_b1*x_betahat6
    ...
    + MG_b3*x_betahat4
    + MG_b4*(h_Duration+.7)
    + MG_b5*(h_Duration+4.9)
    + MG_b6*(h_Duration+34.3)
    + MG_b7*h_Polity
    + MG_b8*h_PolityDuration
    + MG_b9*(h_PolityDuration)
    + MG_b10*(h_PolityDuration)
...
generate x_betahat9 = MG_b1*x_betahat8
    ...
    + MG_b3*x_betahat6
    + MG_b4*(h_Duration+.9)
    + MG_b5*(h_Duration+8.1)
    + MG_b6*(h_Duration+72.9)
    + MG_b7*h_Polity
    + MG_b8*h_PolityDuration
    + MG_b9*(h_PolityDuration)
    + MG_b10*(h_PolityDuration)
...
replace x_betahat2 = exp(x_betahat2);
replace x_betahat3 = exp(x_betahat3);
replace x_betahat4 = exp(x_betahat4);
replace x_betahat5 = exp(x_betahat5);
replace x_betahat6 = exp(x_betahat6);
replace x_betahat7 = exp(x_betahat7);
replace x_betahat8 = exp(x_betahat8);
replace x_betahat9 = exp(x_betahat9);
replace x_betahat10 = exp(x_betahat10);

replace x_betahatd0 = exp(x_betahatd0);
replace x_betahatd1 = exp(x_betahatd1);
replace x_betahatd2 = exp(x_betahatd2);
replace x_betahatd3 = exp(x_betahatd3);
replace x_betahatd4 = exp(x_betahatd4);
replace x_betahatd5 = exp(x_betahatd5);
replace x_betahatd6 = exp(x_betahatd6);
replace x_betahatd7 = exp(x_betahatd7);
replace x_betahatd8 = exp(x_betahatd8);
replace x_betahatd9 = exp(x_betahatd9);
replace x_betahatd10 = exp(x_betahatd10);
