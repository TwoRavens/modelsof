...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Inflation/PredictedValuesDistribution.log", replace;
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/SimData.dta";
...
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat0 diff_lo0 diff_hi0
                ...
                using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Inflation/PredictedValuesInflation", replace;
...
generate x_betahat0 = MG_b33*h_AutLag
    + MG_b34*h_AutLag
    + MG_b35*h_AutLag
    + MG_b36*h_War
    + MG_b37*h_Polity
...
generate x_betahat1 =  MG_b33*x_betahat0 
    + MG_b34*h_AutLag
    + MG_b35*h_AutLag
    + MG_b36*(h_War+1)
    + MG_b37*h_Polity
...
generate x_betahat01 = MG_b33*h_DemLag
    + MG_b34*h_DemLag
    + MG_b35*h_DemLag
    + MG_b36*h_War
    + MG_b37*(h_Polity+20)
...
generate x_betahat11 =  MG_b33*x_betahat01
    + MG_b34*h_DemLag
    + MG_b35*h_DemLag
    + MG_b36*(h_War+1)
    + MG_b37*(h_Polity+20)
    + MG_b38*(h_Polity_War+20)
    + MG_b39*h_Cap
    + MG_b40*h_GDPpc
    + MG_b41*h_Number
    + MG_b42*h_RPC
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Inflation/PredictedValuesInflation.dta", clear;
sum;

saveold "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Inflation/PredictedValuesInflation.dta", replace;
