...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Taxes/PredictedValuesDistribution.log", replace;
...
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat0 diff_lo0 diff_hi0
                ...
                using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Taxes/PredictedValuesTaxes", replace;
...
generate x_betahat0 = MG_b12*h_AutLag
    + MG_b13*h_AutLag
    + MG_b14*h_War
    + MG_b15*h_Polity
    + MG_b16*h_Polity_War
...
generate x_betahat1 =  MG_b12*x_betahat0 
    + MG_b13*h_AutLag
    + MG_b14*(h_War+1)
    + MG_b15*h_Polity
    + MG_b16*h_Polity_War
...
generate x_betahat01 = MG_b12*h_DemLag
    + MG_b13*h_DemLag
    + MG_b14*h_War
    + MG_b15*(h_Polity+20)
    + MG_b16*h_Polity_War
...
generate x_betahat11 =  MG_b12*x_betahat01
    + MG_b13*h_DemLag
    + MG_b14*(h_War+1)
    + MG_b15*(h_Polity+20)
    + MG_b16*(h_Polity_War+20)
    + MG_b17*h_Cap
    + MG_b18*h_GDPpc
    + MG_b19*h_Number
    + MG_b20*h_RPC
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Taxes/PredictedValuesTaxes.dta", clear;
sum;

saveold "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Taxes/PredictedValuesTaxes.dta", replace;
