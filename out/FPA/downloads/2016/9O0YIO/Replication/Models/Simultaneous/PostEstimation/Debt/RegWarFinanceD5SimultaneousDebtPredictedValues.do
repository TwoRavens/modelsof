...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Debt/PredictedValuesDistribution.log", replace;
...
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat0 diff_lo0 diff_hi0
                ...
                using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Debt/PredictedValuesDebt", replace;
...
generate x_betahat0 = MG_b22*h_AutLag
    + MG_b23*h_AutLag
    + MG_b24*h_AutLag
    + MG_b25*h_War
    + MG_b26*h_Polity
...
generate x_betahat1 =  MG_b22*x_betahat0 
    + MG_b23*h_AutLag
    + MG_b24*h_AutLag
    + MG_b25*(h_War+1)
    + MG_b26*h_Polity
...
generate x_betahat01 = MG_b22*h_DemLag
    + MG_b23*h_DemLag
    + MG_b24*h_DemLag
    + MG_b25*h_War
    + MG_b26*(h_Polity+20)
...
generate x_betahat11 =  MG_b22*x_betahat01
    + MG_b23*h_DemLag
    + MG_b24*h_DemLag
    + MG_b25*(h_War+1)
    + MG_b26*(h_Polity+20)
    + MG_b27*(h_Polity_War+20)
    + MG_b28*h_Cap
    + MG_b29*h_GDPpc
    + MG_b30*h_Number
    + MG_b31*h_RPC
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Debt/PredictedValuesDebt.dta", clear;
sum;

saveold "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Simultaneous/PostEstimation/Debt/PredictedValuesDebt.dta", replace;
