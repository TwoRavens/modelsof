...
log using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Endogenous/PostEstimation/Taxes/PredictedValuesDistribution.log", replace;
...
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat0 diff_lo0 diff_hi0
                ...
                using "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Endogenous/PostEstimation/Taxes/PredictedValuesTaxes", replace;
...
generate x_betahat0 = MG_b15*h_AutLag
    + MG_b16*h_AutLag
    + MG_b17*h_War
    + MG_b18*h_Polity
    + MG_b19*h_Polity_War
    ...
    + MG_b22*h_Number
    + MG_b23*h_RPC
    + MG_b24*h_Distribution
    + MG_b25*h_Debt
    + MG_b26*h_Inflation 
    + MG_b27*h_Constant ;

 
generate x_betahat1 =  MG_b15*x_betahat0 
    + MG_b16*h_AutLag
    + MG_b17*(h_War+1)
    + MG_b18*h_Polity
    + MG_b19*h_Polity_War
...
generate x_betahat01 = MG_b15*h_DemLag
    + MG_b16*h_DemLag
    + MG_b17*h_War
    + MG_b18*(h_Polity+20)
    + MG_b19*h_Polity_War
...
generate x_betahat11 =  MG_b15*x_betahat01
    + MG_b16*h_DemLag
    + MG_b17*(h_War+1)
    + MG_b18*(h_Polity+20)
    + MG_b19*(h_Polity_War+20)
    + MG_b20*h_Cap
    + MG_b21*h_GDPpc
    + MG_b22*h_Number
    + MG_b23*h_RPC
...
use "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Endogenous/PostEstimation/Taxes/PredictedValuesTaxes.dta", clear;
sum;

saveold "/Users/Jeff/Dropbox/RegimeWarFinance/D5/Analysis/Models/Endogenous/PostEstimation/Taxes/PredictedValuesTaxes.dta", replace;
