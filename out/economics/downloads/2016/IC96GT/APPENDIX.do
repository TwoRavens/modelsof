clear
log using "\\file\UsersW$\wrr15\Home\My Documents\My Files\XINDONG XUE\ECONOMICS E-JOURNAL (Revision)\DATA AND PROGRAMS\APPENDIX.log", replace
set more off
set scheme s2mono
set type double
...
// 2005 URBAN 
sum SRH3 stdtrust stdsocial stdsp stdsn age female han partymember lnfamilyincome ///
lowses midses highses unmarried married divorced widowed informaleduc ///
primaryeduc junioreduc univeduc gini lpincom murbphone murbcare hsize if urban==1

// 2005 RURAL 
sum SRH3 stdtrust stdsocial stdsp stdsn age female han partymember lnfamilyincome ///
lowses midses highses unmarried married divorced widowed informaleduc ///
primaryeduc junioreduc univeduc gini lpincom mrurphone pub kin hsize if urban==0
...
// 2006 URBAN
sum SRH1 stdtrust stdsocial stdsp stdsn age female han partymember lnfamilyincome ///
lowses midses highses unmarried married divorced widowed informaleduc ///
primaryeduc junioreduc univeduc gini lpincom position hsize if urbann==1

// 2006 RURAL
sum SRH1 stdtrust stdsocial stdsp stdsn age female han partymember lnfamilyincome ///
lowses midses highses unmarried married divorced widowed informaleduc ///
primaryeduc junioreduc univeduc gini lpincom discretion hsize if urbann==0
