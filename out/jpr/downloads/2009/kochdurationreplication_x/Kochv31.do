...
capture log close
log using "C:jprbootv31", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv31.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:\btscoefv31.dta"
save"C:btscoefv31.dta", replace
restore
end
