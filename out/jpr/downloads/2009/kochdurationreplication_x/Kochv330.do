...
capture log close
log using "C:jprbootv330", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv330.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv330.dta"
save"C:btscoefv330.dta", replace
restore
end
