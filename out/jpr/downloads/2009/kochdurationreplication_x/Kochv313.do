...
capture log close
log using "C:jprbootv313", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv313.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv313.dta"
save"C:btscoefv313.dta", replace
restore
end
