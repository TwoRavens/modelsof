...
capture log close
log using "C:jprbootv315", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv315.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv315.dta"
save"C:btscoefv315.dta", replace
restore
end
