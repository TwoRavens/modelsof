...
capture log close
log using "C:jprbootv34", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv34.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv34.dta"
save"C:btscoefv34.dta", replace
restore
end
