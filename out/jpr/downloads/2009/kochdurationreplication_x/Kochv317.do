...
capture log close
log using "C:jprbootv317", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv317.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv317.dta"
save"C:btscoefv317.dta", replace
restore
end
