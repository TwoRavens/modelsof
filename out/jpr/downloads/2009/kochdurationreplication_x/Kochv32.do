...
capture log close
log using "C:jprbootv32", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv32.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv32.dta"
save"C:btscoefv32.dta", replace
restore
end
