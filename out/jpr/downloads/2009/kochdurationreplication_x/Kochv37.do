...
capture log close
log using "C:jprbootv37", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv37.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv37.dta"
save"C:btscoefv37.dta", replace
restore
end
