...
capture log close
log using "C:jprbootv38", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv38.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv38.dta"
save"C:btscoefv38.dta", replace
restore
end
