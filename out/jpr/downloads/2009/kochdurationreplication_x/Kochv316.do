...
capture log close
log using "C:jprbootv316", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv316.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv316.dta"
save"C:btscoefv316.dta", replace
restore
end
