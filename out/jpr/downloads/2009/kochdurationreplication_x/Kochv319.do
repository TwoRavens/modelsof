...
capture log close
log using "C:jprbootv319", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv319.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv319.dta"
save"C:btscoefv319.dta", replace
restore
end
