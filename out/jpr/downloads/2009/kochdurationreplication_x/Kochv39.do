...
capture log close
log using "C:jprbootv39", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv39.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv39.dta"
save"C:btscoefv39.dta", replace
restore
end
