...
capture log close
log using "C:jprbootv322", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv322.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv322.dta"
save"C:btscoefv322.dta", replace
restore
end
