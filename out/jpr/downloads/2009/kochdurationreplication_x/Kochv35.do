...
capture log close
log using "C:jprbootv35", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv35.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv35.dta"
save "C:btscoefv35.dta", replace
restore
end
