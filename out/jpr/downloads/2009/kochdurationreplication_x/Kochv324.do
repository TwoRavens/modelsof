...
capture log close
log using "C:jprbootv324", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv324.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv324.dta"
save"C:btscoefv324.dta", replace
restore
end
