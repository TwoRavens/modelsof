...
capture log close
log using "C:jprbootv326", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv326.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv326.dta"
save"C:btscoefv326.dta", replace
restore
end
