...
capture log close
log using "C:jprbootv310", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv310.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv310.dta"
save"C:btscoefv310.dta", replace
restore
end
