...
capture log close
log using "C:jprbootv328", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv328.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv328.dta"
save"C:btscoefv328.dta", replace
restore
end
