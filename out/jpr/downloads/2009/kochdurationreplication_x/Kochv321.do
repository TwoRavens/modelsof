...
capture log close
log using "C:jprbootv321", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv321.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv321.dta"
save"C:btscoefv321.dta", replace
restore
end
