...
capture log close
log using "C:jprbootv327", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv327.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv327.dta"
save"C:\btscoefv327.dta", replace
restore
end
