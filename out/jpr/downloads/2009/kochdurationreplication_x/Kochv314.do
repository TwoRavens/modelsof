...
capture log close
log using "C:jprbootv314", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv314.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv314.dta"
save"C:btscoefv314.dta", replace
restore
end
