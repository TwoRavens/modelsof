...
capture log close
log using "C:jprbootv36", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv36.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv36.dta"
save"C:btscoefv36.dta", replace
restore
end
