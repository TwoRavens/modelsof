...
capture log close
log using "C:jprbootv312", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv312.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv312.dta"
save"C:btscoefv312.dta", replace
restore
end
