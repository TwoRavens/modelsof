...
capture log close
log using "C:jprbootv33", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv33.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv33.dta"
save"C:btscoefv33.dta", replace
restore
end
