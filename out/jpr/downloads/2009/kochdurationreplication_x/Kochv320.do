...
capture log close
log using "C:jprbootv320", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv320.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv320.dta"
save"C:btscoefv320.dta", replace
restore
end
