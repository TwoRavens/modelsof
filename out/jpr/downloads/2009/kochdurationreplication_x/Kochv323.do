...
capture log close
log using "C:jprbootv323", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv323.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv323.dta"
save"C:btscoefv323.dta", replace
restore
end
