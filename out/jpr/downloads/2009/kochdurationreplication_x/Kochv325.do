...
capture log close
log using "C:jprbootv325", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv325.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv325.dta"
save"C:btscoefv325.dta", replace
restore
end
