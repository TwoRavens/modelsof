...
capture log close
log using "C:jprbootv329", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv329.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv329.dta"
save"C:btscoefv329.dta", replace
restore
end
