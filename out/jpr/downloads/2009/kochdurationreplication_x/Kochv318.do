...
capture log close
log using "C:jprbootv318", replace
clear
set more off
set mem 500m
...
capture save "C:btscoefv318.dta",replace
capture clear
...
matrix b=get(_b)
capture svmat b
capture append using "C:btscoefv318.dta"
save"C:btscoefv318.dta", replace
restore
end
