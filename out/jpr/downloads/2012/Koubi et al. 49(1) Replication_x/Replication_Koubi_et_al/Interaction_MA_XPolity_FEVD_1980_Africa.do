...
#delimit ;
	xtfevd	PENN_grgdpch temp_ma_30_GPCC preci_ma_30_GPCC  lag_xpolity pop_growth lpop lag_lGDP_pc   
			Oil ethfrac lmtnest GDP_initial if year>=1980& NAF==1 | SSA==1, 
...
#delimit ;
	xtfevd	x1x2a_1 temp_ma_30_GPCC preci_ma_30_GPCC interact2 interact3 lag_xpolity pop_growth lpop lag_lGDP_pc   
			Oil ethfrac lmtnest GDP_initial if year>=1980& NAF==1 | SSA==1, 
			invariant(Oil ethfrac lmtnest GDP_initial) ar1 corr;
#delimit cr
...
graph export "Interaction_XPolity_Separate_MA_FEVD_1980_Africa.pdf", replace
