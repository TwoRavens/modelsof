...
******* Diagnostics for carryover effects
* This diagnostic test requires estimating the model in (1) adding interactions between attribute and task indicators.
* This means that we cannot use the grouping option required by the conditional logit command. We therefore employ the logit command.
...
logit Y i.education i.income i.corruption i.taxspend i.samesex ///
...
education#taxspend education#samesex surv_edu2 surv_edu3 surv_inc2 surv_inc3 surv_corr2 surv_corr3 surv_tax2 surv_tax3 surv_ssex2 surv_ssex3 /// 
i.n_contest education#n_contest, vce(cl IDContatto)
estimates store m10_coeEDU
estimates save m10_coeEDU.ster, replace
...
ita_tax2 ita_tax3 ita_ssex2 ita_ssex3 stu_tax2 stu_tax3 stu_ssex2 stu_ssex3 lyc_tax2 lyc_tax3 lyc_ssex2 lyc_ssex3 imp_tax2 imp_tax3 imp_ssex2 imp_ssex3 ///
education#taxspend education#samesex surv_edu2 surv_edu3 surv_inc2 surv_inc3 surv_corr2 surv_corr3 surv_tax2 surv_tax3 surv_ssex2 surv_ssex3 /// 
i.n_contest income#n_contest, vce(cl IDContatto)
estimates store m10_coeINC
estimates save m10_coeINC.ster, replace
...
ita_tax2 ita_tax3 ita_ssex2 ita_ssex3 stu_tax2 stu_tax3 stu_ssex2 stu_ssex3 lyc_tax2 lyc_tax3 lyc_ssex2 lyc_ssex3 imp_tax2 imp_tax3 imp_ssex2 imp_ssex3 ///
education#taxspend education#samesex surv_edu2 surv_edu3 surv_inc2 surv_inc3 surv_corr2 surv_corr3 surv_tax2 surv_tax3 surv_ssex2 surv_ssex3 /// 
i.n_contest corruption#n_contest, vce(cl IDContatto)
estimates store m10_coeCOR
estimates save m10_coeCOR.ster, replace
...
ita_tax2 ita_tax3 ita_ssex2 ita_ssex3 stu_tax2 stu_tax3 stu_ssex2 stu_ssex3 lyc_tax2 lyc_tax3 lyc_ssex2 lyc_ssex3 imp_tax2 imp_tax3 imp_ssex2 imp_ssex3 ///
education#taxspend education#samesex surv_edu2 surv_edu3 surv_inc2 surv_inc3 surv_corr2 surv_corr3 surv_tax2 surv_tax3 surv_ssex2 surv_ssex3 /// 
i.n_contest taxspend#n_contest, vce(cl IDContatto)
estimates store m10_coeTAX
estimates save m10_coeTAX.ster, replace
...
ita_tax2 ita_tax3 ita_ssex2 ita_ssex3 stu_tax2 stu_tax3 stu_ssex2 stu_ssex3 lyc_tax2 lyc_tax3 lyc_ssex2 lyc_ssex3 imp_tax2 imp_tax3 imp_ssex2 imp_ssex3 ///
education#taxspend education#samesex surv_edu2 surv_edu3 surv_inc2 surv_inc3 surv_corr2 surv_corr3 surv_tax2 surv_tax3 surv_ssex2 surv_ssex3 /// 
i.n_contest samesex#n_contest, vce(cl IDContatto)
estimates store m10_coeSEX
estimates save m10_coeSEX.ster, replace
