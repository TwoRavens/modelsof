...
+ MG_b52*h_lyceum + MG_b58*(`a') + MG_b100 + MG_b109 + MG_b114*h_survey
...
use sim.dta, clear
gen MV = _n
eclplot diff_hat diff_hi diff_lo MV, estopts(msize(small)) rplottype(rspike) ciopts(msize(small)) graphregion(fcolor(white)) ysca(noline) xsca(noline r(1/31)) ytitle(" ", size(3)) xtitle(Saliency education, size(3)) ///
...
yline(0, lcolor(black) lwidth(medthin)) saving(Edu2_saliency, replace)
...
+ MG_b53*h_lyceum + MG_b59*(`a') + MG_b103 + MG_b112 + MG_b115*h_survey
gen prob0=normal(x_betahat0)
gen prob1=normal(x_betahat1)
gen diff=prob1-prob0
egen probhat0=mean(prob0)
...
yline(0, lcolor(black) lwidth(medthin)) saving(Edu3_saliency, replace)

graph combine Edu2_saliency.gph Edu3_saliency.gph, graphregion(fcolor(white)) ycommon xcommon saving(Education_saliency, replace)
restore, not
...
+ MG_b54*h_lyceum + MG_b60*(`a') + MG_b116*h_survey
...
use sim.dta, clear
gen MV = _n
eclplot diff_hat diff_hi diff_lo MV, estopts(msize(small)) rplottype(rspike) ciopts(msize(small)) graphregion(fcolor(white)) ysca(noline) xsca(noline r(1/31)) ytitle(" ", size(3)) xtitle(Saliency income, size(3)) ///
xlabel(1 "none" 11 "some" 21 "fair" 31 "high", labsize(3)) ylabel(.2 "0.2" .1 "0.1" 0 "0" -.1 "-0.1" -.2 "-0.2" -.3 "-0.3" -.4 "-0.4", labsize(3)) title(Middle vs. low income, size(3)) ///
yline(0, lcolor(black) lwidth(medthin)) saving(Inc2_saliency, replace)
...
+ MG_b55*h_lyceum + MG_b61*(`a') + MG_b117*h_survey
...
yline(0, lcolor(black) lwidth(medthin)) saving(Inc3_saliency, replace)

graph combine Inc2_saliency.gph Inc3_saliency.gph, graphregion(fcolor(white)) ycommon xcommon saving(Income_saliency, replace)
restore, not
...
+ MG_b56*h_lyceum + MG_b62*(`a') + MG_b118*h_survey
...
use sim.dta, clear
gen MV = _n
eclplot diff_hat diff_hi diff_lo MV, estopts(msize(small)) rplottype(rspike) ciopts(msize(small)) graphregion(fcolor(white)) ysca(noline) xsca(noline r(1/31)) ytitle(" ", size(3)) xtitle(Saliency integrity, size(3)) ///
xlabel(1 "none" 11 "some" 21 "fair" 31 "high", labsize(3)) ylabel(.5 "0.5" .4 "0.4" .3 "0.3" .2 "0.2" .1 "0.1" 0 "0" -.1 "-0.1" -.2 "-0.2" -.3 "-0.3" -.4 "-0.4" -.5 "-0.5", labsize(3)) title(Investigated vs. clean sheet, size(3)) ///
yline(0, lcolor(black) lwidth(medthin)) saving(Corr2_saliency, replace)
...
+ MG_b57*h_lyceum + MG_b63*(`a') + MG_b119*h_survey
...
yline(0, lcolor(black) lwidth(medthin)) saving(Corr3_saliency, replace)

graph combine Corr2_saliency.gph Corr3_saliency.gph, graphregion(fcolor(white)) ycommon xcommon saving(Corruption_saliency, replace)
restore, not
...
+ MG_b88*h_lyceum + MG_b92*(`a') + MG_b100 + MG_b120*h_survey
...
use sim.dta, clear
gen MV = _n
eclplot diff_hat diff_hi diff_lo MV, estopts(msize(small)) rplottype(rspike) ciopts(msize(small)) graphregion(fcolor(white)) ysca(noline) xsca(noline r(1/31)) ytitle(" ", size(3)) xtitle(Saliency tax-spend, size(3)) ///
...
yline(0, lcolor(black) lwidth(medthin)) saving(Tax2_saliency, replace)
...
+ MG_b89*h_lyceum + MG_b93*(`a') + MG_b101 + MG_b121*h_survey
...
yline(0, lcolor(black) lwidth(medthin)) saving(Tax3_saliency, replace)

graph combine Tax2_saliency.gph Tax3_saliency.gph, graphregion(fcolor(white)) ycommon xcommon saving(Taxspend_saliency, replace)
restore, not
...
+ MG_b90*h_lyceum + MG_b94*(`a') + MG_b109 + MG_b122*h_survey
...
use sim.dta, clear
gen MV = _n
eclplot diff_hat diff_hi diff_lo MV, estopts(msize(small)) rplottype(rspike) ciopts(msize(small)) graphregion(fcolor(white)) ysca(noline) xsca(noline r(1/31)) ytitle(" ", size(3)) xtitle(Saliency same-sex rights, size(3)) ///
xlabel(1 "none" 11 "some" 21 "fair" 31 "high", labsize(3)) ylabel(.1 "0.1" 0 "0" -.1 "-0.1" -.2 "-0.2" -.3 "-0.3" -.4 "-0.4" -.5 "-0.5", labsize(3)) title(Some rights vs. same rights, size(3)) ///
yline(0, lcolor(black) lwidth(medthin)) saving(Ssex2_saliency, replace)
...
+ MG_b91*h_lyceum + MG_b95*(`a') + MG_b110 + MG_b123*h_survey
gen prob0=normal(x_betahat0)
gen prob1=normal(x_betahat1)
gen diff=prob1-prob0
egen probhat0=mean(prob0)
...
yline(0, lcolor(black) lwidth(medthin)) saving(Ssex3_saliency, replace)

graph combine Ssex2_saliency.gph Ssex3_saliency.gph, graphregion(fcolor(white)) ycommon xcommon saving(Samesex_saliency, replace)

graph combine Education_saliency.gph Income_saliency.gph Corruption_saliency.gph Taxspend_saliency.gph Samesex_saliency.gph hist_allimp.gph, graphregion(fcolor(white)) ycommon xcommon ///
imargin(0 0 0 0) saving(Figure_1c, replace) 
exit
