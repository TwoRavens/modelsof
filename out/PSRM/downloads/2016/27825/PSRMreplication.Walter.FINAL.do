* cd "C:\Users\dalaro\Desktop\Walter\Replication package"
clear
cd "/Users/walter/Documents/Papers/abgeschlossene Projekte/2015.Globalization.PSRM/submission PSRM/FINAL.ReplicationPackage"

 
*log using replication_Laroze, replace
log using replication_Walter_9Oct15, replace
...
use "/Users/walter/Documents/Papers/abgeschlossene Projekte/2015.Globalization.PSRM/submission PSRM/R&R PSRM/FINAL.PSRM.R2/submission R2 PSRM/Replication package/Data.Glob_PSRM.Oct14.dta"
...
replace primary=sector==1 
replace primary=. if sector==.
replace secondary=sector==2 
replace secondary =. if sector==.
replace servicesector=sector==3 
...
* -------------------------------------------------------
* 2.1.3 FIGURE 2a: TRADE DUMMY (Model 1 and 4)
* -------------------------------------------------------
...
* --------------------------------------------------------------
* 2.2.2 Figure 2b: Trade Dummy (Model 8)
* --------------------------------------------------------------
estimates restore est5
...
* ----------------- 
prvalue, x(tradeable=0 eduyrs=8 tradeable_eduy=0 ) rest(median) level(95) bootstrap save
prvalue, x(tradeable =0 eduyrs=19 tradeable_eduy =0 ) rest(median)   level(95) bootstrap diff // see footnote 26
prvalue, x(tradeable =0 eduyrs=19 tradeable_eduy =0 ) rest(median)   level(95) bootstrap
...
* ----------------- 	
prvalue, x(tradeable=1 eduyrs=8 tradeable_eduy=8 ) rest(median) level(95)  bootstrap save
prvalue, x(tradeable =1 eduyrs=19 tradeable_eduy =19 ) rest(median)   level(95)	bootstrap diff  // see footnote 26
prvalue, x(tradeable =1 eduyrs=19 tradeable_eduy =19 ) rest(median)   level(95)	bootstrap
...
*------------------------------------------------------------------------------------
* 2.2.4 Discussion of implications of Hiscox (2002) argument, see also footnote 24
*------------------------------------------------------------------------------------
estimates restore est7
...
gllamm lmrisk offshore2 off2_eduy eduyrs   s1 hinctnt female age union uempla church primary secondary  wave04 if pdwrk==1 | uempla==1 , i(cntry2)  link(ologit) adapt trace nip(15)
eststo, title("fn 33:multilvl DV: `e(depvar)' `e(cmd)' `e(model)'")
...
* use ess_cps_1june2010.dta, clear
use ReplicationData.Rehm.CPS.2009.dta, clear


* TRADABLES SECTOR DUMMY
* ================================================================================

* a) tsrehm: Based on Rehm's nontradables sector data (Rehm 2009, footnote 23)
* -----------------------------------------------------------------------------
gen tsrehm=(nt-1)*(-1)
label var tsrehm "Tradables sector"

gen tsrehm_edul=tsrehm*edulvl
