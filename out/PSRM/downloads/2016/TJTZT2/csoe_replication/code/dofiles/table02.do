...
reg todif2 elocal eother, cluster(lid)
estimates store m1

* (2) --------------------------------------------------------------------------

* "average turnout increase in states that introduced CSOE"
xtreg todif2 elocal eother i.year, i(lid) fe cluster(lid)
estimates store m2

* (3) --------------------------------------------------------------------------

* Trend in European Elections
xtreg turnout elocal eother i.year if level == "europa", fe cluster(lid) 
estimates store m3
