...
log using logs/analysis_usingnonperturbedprivatefiles_log.txt, text replace
set more off
clear
...
file open myfile using tables_using_nonperturbedprivatefiles/table01.out, write replace
...
file open myfile using tables_using_nonperturbedprivatefiles/tableSI.2.1.out, write replace
...
outreg2 using tables_using_nonperturbedprivatefiles/table02.out, title("Table 2: Effect of Outreach on 2012 Registration, Experimental Results") label bracket dec(3) replace
xtreg registered treat_combined if returntoprison==0, robust fe i(crime)
matrix list r(table) /*to calculate one-sided p-values*/
outreg2 using tables_using_nonperturbedprivatefiles/table02.out, label bracket dec(3) addstat("R-squared Within", `e(r2_w)') adec(3) append
...
matrix list r(table) /*to calculate one-sided p-values*/
outreg2 using tables_using_nonperturbedprivatefiles/table02.out, label bracket dec(3) append
...
matrix list r(table) /*to calculate one-sided p-values*/
outreg2 using tables_using_nonperturbedprivatefiles/table02.out, label bracket dec(3) addstat("R-squared Within", `e(r2_w)', "Mean of DV in Control Group", `mean_dv_control1') adec(3) append
...
matrix list r(table) /*to calculate one-sided p-values*/
outreg2 using tables_using_nonperturbedprivatefiles/table03.out, title("Table 3: Effect of Outreach on 2012 Voting, Experimental Results") label bracket dec(3) replace
xtreg v_pres_general_12 treat_combined if returntoprison==0, robust fe i(crime)
matrix list r(table) /*to calculate one-sided p-values*/
outreg2 using tables_using_nonperturbedprivatefiles/table03.out, label bracket dec(3) addstat("R-squared Within", `e(r2_w)') adec(3) append
...
matrix list r(table) /*to calculate one-sided p-values*/
outreg2 using tables_using_nonperturbedprivatefiles/table03.out, label bracket dec(3) append
...
matrix list r(table) /*to calculate one-sided p-values*/
outreg2 using tables_using_nonperturbedprivatefiles/table03.out, label bracket dec(3) addstat("R-squared Within", `e(r2_w)', "Mean of DV in Control Group", `mean_dv_control1') adec(3) append
...
file open myfile using tables_using_nonperturbedprivatefiles/tableSI.3.1.out, write replace
...
outreg2 treat_combinedXnreturn log_daysserved ageonelecday ageonelecday2 timesincerelease timesincerelease2 v08yes v08no using tables_using_nonperturbedprivatefiles/table04.out, title("Table 4: Complier Average Causal Effects (Adjusting for Returned Mail) of Outreach on 2012 Participation") label bracket dec(3) replace
...
local p3=`r(p)'
outreg2 log_daysserved ageonelecday ageonelecday2 timesincerelease timesincerelease2 v08yes v08no treat_v08yesXnreturn treat_v08noXnreturn treat_vnoeligXnreturn using tables_using_nonperturbedprivatefiles/table04.out, label bracket dec(3) addstat("P-value, treatment 08 voters = treatment 08 non-voters", `p1', "P-value, treatment 08 voters = treatment 08 not eligible", `p2',"P-value, treatment 08 non-voters = treatment 08 not eligible", `p3') adec(3) append
...
outreg2 treat_combinedXnreturn log_daysserved ageonelecday ageonelecday2 timesincerelease timesincerelease2 v08yes v08no using tables_using_nonperturbedprivatefiles/table04.out, label bracket dec(3) append
...
file open myfile using tables_using_nonperturbedprivatefiles/tableSI.3.2.out, write replace
