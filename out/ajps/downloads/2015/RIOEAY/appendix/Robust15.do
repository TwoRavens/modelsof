...
* Correction for grouped income in Gini calc.
* Following van Ourti and Clarke, Rev. Econ. Stat. 2010
* first order correction.factor: K^2/(K^2-1)
replace Rgini = Rgini*1.007 if year <= 2006
replace Rgini = Rgini*1.01 if year == 2008
