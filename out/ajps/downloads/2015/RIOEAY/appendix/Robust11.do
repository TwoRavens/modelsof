...
drop if hincsrc==2 | hincsrc==5 | hincsrc==6 | hincsrc==7
...
mi update
* (mi update since hincsrc changes N)
...
bootstrap, clu(region cntry) rep(100): cmp (rincd= c.incdist##c.Rgini fear c.fear#c.incdist age female eduyrs transue transnlf hhmmb lowsup smempl whcol blcol noclass skillshg skillslg skillssp Rforeign Ruerate Rtech Rgdp) (fear=incdist Rgini age female eduyrs transue transnlf hhmmb lowsup smempl whcol blcol noclass victim Rgdp Rforeign) if rincd!=., ind(5 5) nolr qui
end
