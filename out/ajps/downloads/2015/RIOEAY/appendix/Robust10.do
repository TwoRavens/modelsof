...
* Drop upper and lower income 5\% of sample
gen trim = 0
forvalues i = 1/5 {
    _pctile incdist if _mi_m==`i', n(20)
    replace trim = 1 if (incdist > `r(r19)' | incdist < `r(r1)') & _mi_m==`i'
}
drop if trim==1
...
mi est, esampvaryok noupdate: m1_rgini 4 
...
mi est, noupdate esampvaryok: m2_rgini 4 
...
mi est (diff21:_b[2._at]-_b[1._at]), esampvaryok noupdate: m2_fear 4
