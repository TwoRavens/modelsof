...
keep if inrange(tline,-24,24) & apprentice == 0 & brthmnth == 10 // Indv. born in october: 49 event-month oberservation window & excluding apprentices
...
preserve
	if `j' == 1{
		...
		global filnam E:\Data\workdata\703788\minwage\out\Figure_not_used_oct_cohort_dofile_analys07
		global range (0(25)175, nogrid)
		global label Hourly wage (DKK)
	}
	if `j' == 2{
		local var emplyd
		global filnam E:\Data\workdata\703788\minwage\out\Figure3A_oct_cohort_dofile_analys07
	...
	** Baseline regression 5 degree age polynomial including dummy at event time 0
	...
	local x = 3 + `j'
	di `x'
	putexcel set "$out\Figure3A_oct_cohort_dofile_analys07.xls", sheet(estimation) modify
		#d; 
