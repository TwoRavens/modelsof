...
ml display
est save Results/ML_CRRA_12_C0.ster, replace
	...
	ml display
	est save Results/ML_CRRA_12_C1.ster, replace
...
ml model gf0 MSL_CRRA_RC_12() (rra1: ${LHS_RA} repeat = ) (rra2: ) (LNmuRA: ) (c11: ) (c21: ) (c22: ), ///
				cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) init(start, copy)
ml display
est save Results/nrep${nrep}_MSL_CRRA_RC_12_C0.ster
	...
	ml model gf0 MSL_CRRA_RC_12() (rra1: ${LHS_RA} repeat = ${treat2_RA}) (rra2: ${treat2_RA}) (LNmuRA: ${treat2_RA}) (c11: ) (c21: ) (c22: ), ///
					cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) continue
	ml display	
	est save Results/nrep${nrep}_MSL_CRRA_RC_12_C1.ster		
	...
	est use Results/nrep50_MSL_CRRA_RC_12_C1.ster
	matrix start = e(b)
...
ml model gf0 MSL_CRRA_RC_H12() (sel1: ${LHS_RA} sample_1 sample_2 repeat first = ${RHS_1}) ///
							   ...
							   cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) init(start, copy) 
ml display
est save Results/nrep${nrep}_MSL_CRRA_RC_H12_C0.ster
	...
	ml model gf0 MSL_CRRA_RC_H12() (sel1: ${LHS_RA} sample_1 sample_2 repeat first = ${RHS_1}) ///
								   ...
								   cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) continue
	ml display
	est save Results/nrep${nrep}_MSL_CRRA_RC_H12_C1.ster
	...
	est use Results/nrep50_MSL_CRRA_RC_H12_C1.ster
	matrix start = e(b)
