//-----------------------------------------------------------------------------------------------------
// Post-estimation results for EUT model with selection + contextual utility: men vs women
//-----------------------------------------------------------------------------------------------------
...
log using Tables\Context\TableE1_EUT_Sel_MenVsWomen.log, replace text 
//-------------------------------------------
...
//-------------------------------------------
	...
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA_RC_H12_C3.ster
	qui est store RAW
	ereturn list
	estimates replay	
