//-----------------------------------------------------------------------------------------------------
// Post-estimation results for EUT model without selection + contextual utility
//-----------------------------------------------------------------------------------------------------
...
log using Tables\Context\TableC3_EUT_NoSel.log, replace text 
//-------------------------------------------
...
//-------------------------------------------
	...
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA_RC_12_C1.ster
	qui est store RAW
	ereturn list
	estimates replay	
...
//-----------------------------------------------------------------------------------------------------
// Post-estimation results for EUT model with selection + contextual utility
//-----------------------------------------------------------------------------------------------------
...
log using Tables\Context\TableC1_EUT_Sel.log, replace text 
//-------------------------------------------
// EUT with CRRA utility and contextual utility
//-------------------------------------------
	//----------------------------------------
	...
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA_RC_H12_C1.ster
	qui est store RAW
	ereturn list
	estimates replay	
