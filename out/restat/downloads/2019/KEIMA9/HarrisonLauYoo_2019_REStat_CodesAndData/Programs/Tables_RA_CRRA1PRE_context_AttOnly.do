//-----------------------------------------------------------------------------------------------------
// Post-estimation results for RDU model with attrition + contextual utility
//-----------------------------------------------------------------------------------------------------

	// set globals for latent preference parameters
	global parameters	"sel2 rra1 rra2 phi1 phi2"
	global labels		"sel2 rra1 rra2 phi1 phi2"
...
log using Tables\Context\TableC8_RDU_AttOnly, replace text 
//----------------------------------------------------------
...
//----------------------------------------------------------
	...
	//------------------------------------------
	est use  Results/nrep100_MSL_CRRA1PRE_RC_A12_CA1.ster
	qui est store RAW
	ereturn list
	estimates replay	
