//==========================================================================================================
// MSLdisplay for IDR models with endogenous sample selection
// NOTE: This code assumes that the first two random parameters listed in option -parameters()- 
//       are selection and attrition errors in models with endogenous sample selection: say, sel1 and sel2.
//		 The code computes variances, covariances and correlations involving sel1 and sel2.
//       The code does not compute means and standard deviations of sel1 and sel2.
//==========================================================================================================
	
program define MSLdisplayY
	...
	// normalize Cholesky factors to set Var(selection error) = 2 and Var(attrition error) = 2 + Cov(selection error, attrition error) 
	local c11 = 1 
	local c22 = 1
	...
	//---------------------------------------------------------------
	// variance of underlying normals (note that first two normals are selection and attrition errors)
	global var_UN1 (2)
	global var_UN2 (`c21'^2 + 2)
	forvalues f = 3/`neq' {		
		forvalues s = 1/`f' {
