//-----------------------------------------------------------------------------------------------------
// Post-estimation results for RDU model without selection + Fechner errors
//-----------------------------------------------------------------------------------------------------

	// set globals for latent preference parameters
	global parameters	"rra1 rra2 phi1 phi2"
	global labels		"rra1 rra2 phi1 phi2"
...
log using Tables\Fechner\TableF4_RDU_NoSel.log, replace text 
//----------------------------------------------------------
// RDU with CRRA utility, 1-param Prelec and Fechner errors
//----------------------------------------------------------
	//----------------------------------------
	// No correction for endogenous selection
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA1PRE_RC_12_V1.ster
	qui est store RAW
	ereturn list
	estimates replay	
...
//-----------------------------------------------------------------------------------------------------
// Post-estimation results for RDU model with selection + Fechner errors
//-----------------------------------------------------------------------------------------------------
...
log using Tables\Fechner\TableF2_RDU_Sel.log, replace text 
//----------------------------------------------------------
// RDU with CRRA utility, 1-param Prelec and Fechner errors
//----------------------------------------------------------
	//----------------------------------------
	...
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA1PRE_RC_H12_V1.ster
	qui est store RAW
	ereturn list
	estimates replay	
