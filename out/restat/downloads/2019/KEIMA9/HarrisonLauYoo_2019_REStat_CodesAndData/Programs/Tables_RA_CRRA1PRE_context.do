//-----------------------------------------------------------------------------------------------------
// Post-estimation results for RDU model without selection + contextual utility
//-----------------------------------------------------------------------------------------------------
...
log using Tables\Context\TableC4_RDU_NoSel.log, replace text 
//----------------------------------------------------------
...
//----------------------------------------------------------
	...
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA1PRE_RC_12_C1.ster
	qui est store RAW
	ereturn list
	estimates replay	
...
//-----------------------------------------------------------------------------------------------------
// Post-estimation results for RDU model with selection + contextual utility
//-----------------------------------------------------------------------------------------------------
...
log using Tables\Context\TableC2_RDU_Sel.log, replace text 
//----------------------------------------------------------
// RDU with CRRA utility, 1-param Prelec and contextual utility
//----------------------------------------------------------
	//----------------------------------------
	...
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA1PRE_RC_H12_C1.ster
	qui est store RAW
	ereturn list
	estimates replay	
