...
// Contextual utility. Allow for observed heterogeneity w.r.t. treatment indicators.
//==============================================================================
...
//-------------------------------------------------------
global nrep = 50
MSLinit, id(${id}) burn(${burn}) nrep(${nrep}) neq(3)

est use Results/probit_sample_2.ster
mat start_SEL = e(b)

est use Results/ML_CRRA_12_C0.ster
mat start_REST = e(b), 0, 0.1, 0, 0, 0.1

mat start = start_SEL, start_REST

ml model gf0 MSL_CRRA_RC_A12() (sel2: ${LHS_RA} sample_2 repeat first = ${RHS_2A}) (rra1: ) (rra2: ) (LNmuRA: ) (c21: ) (c22: ) (c31: ) (c32: ) (c33: ), ///
							   cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) init(start, copy) 
ml display
est save Results/nrep${nrep}_MSL_CRRA_RC_A12_CA0.ster
	...
	est use Results/nrep50_MSL_CRRA_RC_A12_CA0.ster

	ml model gf0 MSL_CRRA_RC_A12() (sel2: ${LHS_RA} sample_2 repeat first = ${RHS_2A}) (rra1: = ${treat2_RA}) (rra2: = ${treat2_RA}) (LNmuRA: ${treat2_RA}) (c21: ) (c22: ) (c31: ) (c32: ) (c33: ), ///
								   cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) continue
	ml display
	est save Results/nrep${nrep}_MSL_CRRA_RC_A12_CA1.ster
	...
	est use Results/nrep50_MSL_CRRA_RC_A12_CA1.ster
	matrix start = e(b)
