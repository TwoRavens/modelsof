...
//-----------------------------------------------------------------------------------------------------
	...
	global obshet 		"RAfirst RAhigh high_fee"

	// set global for tests of temporal stability
	global test_labels	"rra"

log using Tables\Context\TableC5_EUT_Sel_CondOnFee2.log, replace text 
//-------------------------------------------
...
//-------------------------------------------
	...
	//----------------------------------------
	est use  Results/nrep100_MSL_CRRA_RC_H12_C2_II.ster
	qui est store RAW
	ereturn list
	estimates replay	
