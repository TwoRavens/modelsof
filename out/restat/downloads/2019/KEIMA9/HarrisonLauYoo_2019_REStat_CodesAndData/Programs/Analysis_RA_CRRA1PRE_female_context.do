...
// Contextual Utility. Observed heterogeneity w.r.t. gender instead of treatment indicators.
//===========================================================================================
...
keep if (sample_1 == 1 & repeat == 0)| (sample_2 == 1 & repeat == 1)
	...
	ml display 
	est save Results/ML_CRRA1PRE_12_C3.ster
	...
	ml model gf0 MSL_CRRA1PRE_RC_12() (rra1: ${LHS_RA} repeat = female) (rra2: female) ///
									 ...
									 cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) continue
	ml display
	est save Results/nrep${nrep}_MSL_CRRA1PRE_RC_12_C3.ster
	...
	est use Results/nrep50_MSL_CRRA1PRE_RC_12_C3.ster
	matrix start = e(b)
...
est save Results/probit_sample_2.ster, replace
	...
	ml model gf0 MSL_CRRA1PRE_RC_H12() (sel1: ${LHS_RA} sample_1 sample_2 repeat first = ${RHS_1}) (sel2: = ${RHS_2A}) ///
									   ...
									   cluster(${id}) missing maximize diff technique(bfgs 5 nr 5) continue
	ml display
	est save Results/nrep${nrep}_MSL_CRRA1PRE_RC_H12_C3.ster
	...
	est use Results/nrep50_MSL_CRRA1PRE_RC_H12_C3.ster
	matrix start = e(b)
	...
	est use Results/nrep75_MSL_CRRA1PRE_RC_H12_C3.ster
	matrix start = e(b)
