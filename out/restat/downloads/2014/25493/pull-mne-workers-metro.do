...
log using "JPP/brazspil/logs/%stata/%1setup/pull-mne-workers-metro.log", replace

* PULL MNE SWITCHERS
use "JPP/brazspil/data/rais-draw-metro.dta"
keep if ano>1995
sort identificad ano
merge identificad ano using "JPP/brazspil/data/cnpj/aggcnpj-secex-fdi-match-metro.dta"
tab _merge
keep if _merge==3
drop _merge
compress
...
sort wid ano
save "JPP/brazspil/data/all-workers-metro.dta", replace
...
sort wid ano
save "JPP/brazspil/data/switchers-metro.dta", replace
...
drop fdi
sort identificad ano
save "JPP/brazspil/data/hiremne-metro.dta", replace

* Firms Hiring Other Domestic Workers
use "JPP/brazspil/data/switchers-metro.dta"
tsset wid ano
...
drop fdi
sort identificad ano
save "JPP/brazspil/data/hiredom-metro.dta", replace

* Find Employment in Domestic Firms Hiring Former MNE Workers & Other Domestic Workers
use "JPP/brazspil/data/all-workers-metro.dta"
sort identificad ano
merge identificad ano using "JPP/brazspil/data/hiremne-metro.dta"
tab _merge
drop _merge
...
sort identificad ano
merge identificad ano using "JPP/brazspil/data/hiredom-metro.dta"
tab _merge
drop _merge
...
sort identificad ano
compress
save "JPP/brazspil/data/wid/aggcnpj-workers-metro.dta", replace
