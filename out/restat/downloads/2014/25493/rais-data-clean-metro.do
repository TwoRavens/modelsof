...
* This program prepares a 5-percent random sample of RAIS metro male workers for merge and generates simple descriptive statistics.

log using "JPP/brazspil/logs/%stata/%1setup/rais-data-clean-metro.log", replace

* READ-IN 5-PERCENT RANDOM METRO SAMPLE OF RAIS WORKER DATA
insheet using "rais/draws/metro/wid-draw-workers-metro-male.csv"
count
...
save "JPP/brazspil/data/rais-draw-metro.dta", replace
count
