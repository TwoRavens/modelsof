...
global root1    = "$root/2014.06.04 BLP tight inner e06"
...
replace converged = 0 if exitinfo <-199   & optmethod_str == "DER8-KN4"		
replace converged = 0 if exitinfo <-199   & optmethod_str == "DER9-KN5"		
...
save "$figures/blp_fval_estim_e06.dta", replace

use "$figures/blp_fval_estim_e06.dta", clear
...
preserve
	...
	graph export "$figures/fig_hist_blp_e06.pdf", replace
	graph export "$figures/fig_hist_blp_e06.eps", replace
	...
	graph export "$figures/fig_hist_blp_e06_beam.pdf", replace
	graph export "$figures/fig_hist_blp_e06_beam.eps", replace
