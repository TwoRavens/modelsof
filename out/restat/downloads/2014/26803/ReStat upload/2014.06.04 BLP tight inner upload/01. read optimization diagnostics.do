...
global path     = "$root/2014.06.04 BLP tight inner/optimization results"
global scripts  = "$root/2014.06.04 BLP tight inner"
...
*******************************************************************************
* Track tolerances
* KNITRO in optmethod 15 is unbounded
*******************************************************************************
gen     tolfun = "1e-3"
gen     tolx   = "1e-3"
gen   tolnfp   = "DFS"

replace tolfun = "1e-3" if optmethod==11
replace tolnfp = "NEVO" if optmethod==11

replace tolfun = "1e-3" if optmethod==13
replace tolnfp = "DFS"  if optmethod==13

replace tolfun = "1e-6" if optmethod==12
...
replace tolnfp = "DFS"  if optmethod==15
