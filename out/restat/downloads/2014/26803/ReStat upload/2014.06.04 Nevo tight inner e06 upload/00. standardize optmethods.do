...
replace optmethod_str="DER5-KN1" if optmethod==12
replace optmethod_str="DER6-KN2" if optmethod==13
replace optmethod_str="DER7-KN3" if optmethod==15
replace optmethod_str="DER8-KN4" if optmethod==14
replace optmethod_str="DER9-KN5" if optmethod==16
...
replace optmethod_str="STO3-SIG" if optmethod==11
