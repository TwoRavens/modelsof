/*the code in this file produces the main estimates for the outcome variable proportion hispanic naturalized citizen.  The code and output from this program produce elements in Table 6*/
clear all
