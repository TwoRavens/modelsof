/*the code in this file produces the main estimates for the outcome variable proportion hispanic non-citizen 15 to 45 with high school or less.  
The code and output from this program produce elements in Tables 2,3, and 4*.  The code also produces teh data points for figure 1 and the actual figure 2 in the publication*/
clear all
