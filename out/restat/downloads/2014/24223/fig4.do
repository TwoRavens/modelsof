*Description: This file generates Figure 4 in the online appendix. 
...
title((a) Prediction 1: ABBGH) legend(off) xtitle("Competition") ytitle("Estimated CWP")), 
nodraw;
# delimit cr
...
sort lwidth(thick) color(black) ysc(r(0.3 0.8)) ylabel(0.4(0.1)0.8)
...
# delimit ;
graph twoway (line curveall Lc, ysc(r(0 5)) ylabel(1(1)5)
...
title((b) Prediction 1: US Data) legend(off) xtitle("Competition") ytitle("Estimated CWP")),
nodraw;
# delimit cr
...
sort lwidth(thick) color(black)  ysc(r(0 0.5)) ylabel(0.1(0.1)0.5)
...
* & c1>0.35
# delimit ;
graph twoway (line curveall c1 if curveall<40, ysc(r(0 40)) ylabel(0(10)40)
sort lwidth(thick) color(black) title((f) Prediction 3: US Data) legend(off) xtitle("Competition") ytitle("Estimated CWP")) 
(line curvenn c1 if c1gap2~=0 & curvenn<40, 
sort lwidth(thick) color(red)), nodraw;
# delimit cr
...
graph export fig4.ps, replace logo(off)
