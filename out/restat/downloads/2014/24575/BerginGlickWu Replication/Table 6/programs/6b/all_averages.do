...
local programpath "P:\BerginGlickWu Replication\Table 6\programs\6b"
local outpath1 "P:\BerginGlickWu Replication\Table 6\results\6b"
	...
	* run estimation only if there is more than one pair available for a good
	if `nopairs_`j'' > 1{
		...
		*for 3 vars
		...
		preserve
		ccep_main data3, vars(3) n1(1000) n2(2000)
		restore
...
#delimit ;
collapse pairs 
adj_b_coef_d0s_Q1 adj_t_coef_d0s_Q1 
adj_b_coef_d0s_qk1 adj_t_coef_d0s_qk1
adj_b_coef_d0P_Q1 adj_t_coef_d0P_Q1
adj_b_coef_d0P_qk1 adj_t_coef_d0P_qk1
adj_b_coef_d0pk_Q1 adj_t_coef_d0pk_Q1
adj_b_coef_d0pk_qk1 adj_t_coef_d0pk_qk1
;
...
collapse (sd) adj_b_coef_d0s_Q1 adj_b_coef_d0s_qk1 adj_b_coef_d0pk_Q1 adj_b_coef_d0pk_qk1 adj_b_coef_d0P_Q1 adj_b_coef_d0P_qk1 
...
order avg_observations avg_*
drop m _merge


* outsheeting the results
local filename "ccep_biascorrection_ecm_newPT3_demeanq_semiannual_PW_f1_indust_averages.csv"
