** Non-Traded goods in LOCAL currency, Semi-Annual observations
...
use "$datapath1\price_dispersion_nt_lc_semiannual_f1.dta", clear
...
**** Changing to directory with reshape .ado file
cd "$programPath"
...
save "$outpath1\semiannual_nt_nsc_drop1_f1_wide_indust.dta", replace
