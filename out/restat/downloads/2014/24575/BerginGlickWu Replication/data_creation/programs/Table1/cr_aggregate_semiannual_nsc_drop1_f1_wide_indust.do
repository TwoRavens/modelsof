** Traded goods in USD, Semiannual observations
...
use "$datapath1\semiannual_aggregate_f1.dta", clear
...
save "$outpath1\aggregate_semiannual_nsc_drop1_f1_wide_indust.dta", replace
