...
local lin_reg "count11 count12 count13 count14 count15 bra11 bra12 bra13 bra14 bra15 `lMlist1' `lregionxbrand' wexpreg1 wexpreg2 wexpreg3 wexpreg4 wexpreg5 `linplistreg'";
local lin_light "count21 count22 count23 count24 bra21 bra22 bra23 bra24 `lMlist2' `lregionxbrand2' wexplight21 wexplight22 wexplight23 wexplight24 `linplistlight'";
local lin_mid "`femid' `Mlistmid' nest1 nest2 wexp1 wexp2 count1 count2 p1_1 p1_2 p2_1 p2_2";
...
drawnorm `lin_reg', n(`its') mean(linB) cov(linVC);
drawnorm `lin_light', n(`its') mean(linB2) cov(linVC2); 
drawnorm `lin_mid', n(`its') mean(linMidB) cov(linMidVC);
drawnorm `lin_top', n(`its') mean(lin_b_top) cov(lin_vc_top);
...
svmat bslinp
svmat bslinfocs
log using syrtable2col5, replace
...
save c:\data\restat_12_9\bootstrap_results\olslin, replace
