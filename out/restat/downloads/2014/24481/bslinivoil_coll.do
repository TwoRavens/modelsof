...
mata:
    ...
    for(i=1;i<=10;i++){
		...
		D[1,2]=B[2,1]+theta[2]*top*sbar[i,1]
		D[1,3]=B[3,1]+theta[3]*top*sbar[i,1]
		D[1,4]=B[4,1]+theta[4]*top*sbar[i,1]
		D[1,5]=B[5,1]+theta[5]*top*sbar[i,1]
		D[1,6]=B[6,1]+theta[6]*top*sbar[i,1]
		D[1,7]=B[7,1]+theta[7]*top*sbar[i,1]
		
		D[2,1]=B[1,2]+theta[1]*top*sbar[i,2]
		D[2,3]=B[3,2]+theta[3]*top*sbar[i,2]
		D[2,4]=B[4,2]+theta[4]*top*sbar[i,2]
		D[2,5]=B[5,2]+theta[5]*top*sbar[i,2]
		D[2,6]=B[6,2]+theta[6]*top*sbar[i,2]
		D[2,7]=B[7,2]+theta[7]*top*sbar[i,2]
		
		D[3,1]=B[1,3]+theta[1]*top*sbar[i,3]
		D[3,2]=B[2,3]+theta[2]*top*sbar[i,3]
		D[3,4]=B[4,3]+theta[4]*top*sbar[i,3]
		D[3,5]=B[5,3]+theta[5]*top*sbar[i,3]
		D[3,6]=B[6,3]+theta[6]*top*sbar[i,3]
		D[3,7]=B[7,3]+theta[7]*top*sbar[i,3]
		
		D[4,1]=B[1,4]+theta[1]*top*sbar[i,4]
		D[4,2]=B[2,4]+theta[2]*top*sbar[i,4]
		D[4,3]=B[3,4]+theta[3]*top*sbar[i,4]
		D[4,5]=B[5,4]+theta[5]*top*sbar[i,4]
		D[4,6]=B[6,4]+theta[6]*top*sbar[i,4]
		D[4,7]=B[7,4]+theta[7]*top*sbar[i,4]
		
		D[5,1]=B[1,5]+theta[1]*top*sbar[i,5]
		D[5,2]=B[2,5]+theta[2]*top*sbar[i,5]
		D[5,3]=B[3,5]+theta[3]*top*sbar[i,5]
		D[5,4]=B[4,5]+theta[4]*top*sbar[i,5]
		D[5,6]=B[6,5]+theta[6]*top*sbar[i,5]
		D[5,7]=B[7,5]+theta[7]*top*sbar[i,5]
		
		D[6,1]=B[1,6]+theta[1]*top*sbar[i,6]
		D[6,2]=B[2,6]+theta[2]*top*sbar[i,6]
		D[6,3]=B[3,6]+theta[3]*top*sbar[i,6]
		D[6,4]=B[4,6]+theta[4]*top*sbar[i,6]
		D[6,5]=B[6,6]+theta[6]*top*sbar[i,6]
		D[6,7]=B[7,6]+theta[7]*top*sbar[i,6]
		
		D[7,1]=B[1,7]+theta[1]*top*sbar[i,6]
		D[7,2]=B[2,7]+theta[2]*top*sbar[i,6]
		D[7,3]=B[3,7]+theta[3]*top*sbar[i,6]
		D[7,4]=B[4,7]+theta[4]*top*sbar[i,6]
		D[7,5]=B[5,7]+theta[5]*top*sbar[i,6]
		D[7,6]=B[6,7]+theta[6]*top*sbar[i,6]
		
		

        c[.,i]=luinv(D)*a[.,i]+luinv(D)*(B+D)*pbar[.,i]
    }
...
mata:
   ...
   for(i=1;i<=10;i++){
    ...
    for(i=1;i<=10;i++){
		...
		ivD[1,2]=ivB[2,1]+ivtheta[2]*ivtop*sbar[i,1]
		ivD[1,3]=ivB[3,1]+ivtheta[3]*ivtop*sbar[i,1]
		ivD[1,4]=ivB[4,1]+ivtheta[4]*ivtop*sbar[i,1]
		ivD[1,5]=ivB[5,1]+ivtheta[5]*ivtop*sbar[i,1]
		ivD[1,6]=ivB[6,1]+ivtheta[6]*ivtop*sbar[i,1]
		ivD[1,7]=ivB[7,1]+ivtheta[7]*ivtop*sbar[i,1]
		
		ivD[2,1]=ivB[1,2]+ivtheta[1]*ivtop*sbar[i,2]
		ivD[2,3]=ivB[3,2]+ivtheta[3]*ivtop*sbar[i,2]
		ivD[2,4]=ivB[4,2]+ivtheta[4]*ivtop*sbar[i,2]
		ivD[2,5]=ivB[5,2]+ivtheta[5]*ivtop*sbar[i,2]
		ivD[2,6]=ivB[6,2]+ivtheta[6]*ivtop*sbar[i,2]
		ivD[2,7]=ivB[7,2]+ivtheta[7]*ivtop*sbar[i,2]
		
		ivD[3,1]=ivB[1,3]+ivtheta[1]*ivtop*sbar[i,3]
		ivD[3,2]=ivB[2,3]+ivtheta[2]*ivtop*sbar[i,3]
		ivD[3,4]=ivB[4,3]+ivtheta[4]*ivtop*sbar[i,3]
		ivD[3,5]=ivB[5,3]+ivtheta[5]*ivtop*sbar[i,3]
		ivD[3,6]=ivB[6,3]+ivtheta[6]*ivtop*sbar[i,3]
		ivD[3,7]=ivB[7,3]+ivtheta[7]*ivtop*sbar[i,3]
		
		ivD[4,1]=ivB[1,4]+ivtheta[1]*ivtop*sbar[i,4]
		ivD[4,2]=ivB[2,4]+ivtheta[2]*ivtop*sbar[i,4]
		ivD[4,3]=ivB[3,4]+ivtheta[3]*ivtop*sbar[i,4]
		ivD[4,5]=ivB[5,4]+ivtheta[5]*ivtop*sbar[i,4]
		ivD[4,6]=ivB[6,4]+ivtheta[6]*ivtop*sbar[i,4]
		ivD[4,7]=ivB[7,4]+ivtheta[7]*ivtop*sbar[i,4]
		
		ivD[5,1]=ivB[1,5]+ivtheta[1]*ivtop*sbar[i,5]
		ivD[5,2]=ivB[2,5]+ivtheta[2]*ivtop*sbar[i,5]
		ivD[5,3]=ivB[3,5]+ivtheta[3]*ivtop*sbar[i,5]
		ivD[5,4]=ivB[4,5]+ivtheta[4]*ivtop*sbar[i,5]
		ivD[5,6]=ivB[6,5]+ivtheta[6]*ivtop*sbar[i,5]
		ivD[5,7]=ivB[7,5]+ivtheta[7]*ivtop*sbar[i,5]
		
		ivD[6,1]=ivB[1,6]+ivtheta[1]*ivtop*sbar[i,6]
		ivD[6,2]=ivB[2,6]+ivtheta[2]*ivtop*sbar[i,6]
		ivD[6,3]=ivB[3,6]+ivtheta[3]*ivtop*sbar[i,6]
		ivD[6,4]=ivB[4,6]+ivtheta[4]*ivtop*sbar[i,6]
		ivD[6,5]=ivB[6,6]+ivtheta[6]*ivtop*sbar[i,6]
		ivD[6,7]=ivB[7,6]+ivtheta[7]*ivtop*sbar[i,6]
		
		ivD[7,1]=ivB[1,7]+ivtheta[1]*ivtop*sbar[i,6]
		ivD[7,2]=ivB[2,7]+ivtheta[2]*ivtop*sbar[i,6]
		ivD[7,3]=ivB[3,7]+ivtheta[3]*ivtop*sbar[i,6]
		ivD[7,4]=ivB[4,7]+ivtheta[4]*ivtop*sbar[i,6]
		ivD[7,5]=ivB[5,7]+ivtheta[5]*ivtop*sbar[i,6]
		ivD[7,6]=ivB[6,7]+ivtheta[6]*ivtop*sbar[i,6]
...
drawnorm `ivlind', n(`its') mean(ivlinB) cov(ivlinVC);
drawnorm `ivtoplin', n(`its') mean(ivlin_b_top) cov(ivlin_vc_top);
		...
		for(z=1;z<=1000;z++){
		  ...
		  B=B'	
			...
			for(i=1;i<=10;i++){
				...
				D[1,2]=B[2,1]+wexp[2]*top*s[1]
				D[1,3]=B[3,1]+wexp[3]*top*s[1]
				D[1,4]=B[4,1]+wexp[4]*top*s[1]
				D[1,5]=B[5,1]+wexp[5]*top*s[1]
				D[1,6]=B[6,1]+wexp[6]*top*s[1]
				D[1,7]=B[7,1]+wexp[7]*top*s[1]
				
				D[2,1]=B[1,2]+wexp[1]*top*s[2]
				D[2,3]=B[3,2]+wexp[3]*top*s[2]
				D[2,4]=B[4,2]+wexp[4]*top*s[2]
				D[2,5]=B[5,2]+wexp[5]*top*s[2]
				D[2,6]=B[6,2]+wexp[6]*top*s[2]
				D[2,7]=B[7,2]+wexp[7]*top*s[2]
				
				D[3,1]=B[1,3]+wexp[1]*top*s[3]
				D[3,2]=B[2,3]+wexp[2]*top*s[3]
				D[3,4]=B[4,3]+wexp[4]*top*s[3]
				D[3,5]=B[5,3]+wexp[5]*top*s[3]
				D[3,6]=B[6,3]+wexp[6]*top*s[3]
				D[3,7]=B[7,3]+wexp[7]*top*s[3]
				
				D[4,1]=B[1,4]+wexp[1]*top*s[4]
				D[4,2]=B[2,4]+wexp[2]*top*s[4]
				D[4,3]=B[3,4]+wexp[3]*top*s[4]
				D[4,5]=B[5,4]+wexp[5]*top*s[4]
				D[4,6]=B[6,4]+wexp[6]*top*s[4]
				D[4,7]=B[7,4]+wexp[7]*top*s[4]
				
				D[5,1]=B[1,5]+wexp[1]*top*s[5]
				D[5,2]=B[2,5]+wexp[2]*top*s[5]
				D[5,3]=B[3,5]+wexp[3]*top*s[5]
				D[5,4]=B[4,5]+wexp[4]*top*s[5]
				D[5,6]=B[6,5]+wexp[6]*top*s[5]
				D[5,7]=B[7,5]+wexp[7]*top*s[5]
				
				D[6,1]=B[1,6]+wexp[1]*top*s[6]
				D[6,2]=B[2,6]+wexp[2]*top*s[6]
				D[6,3]=B[3,6]+wexp[3]*top*s[6]
				D[6,4]=B[4,6]+wexp[4]*top*s[6]
				D[6,5]=B[5,6]+wexp[5]*top*s[6]
				D[6,7]=B[7,6]+wexp[7]*top*s[6]
				
				D[7,1]=B[1,7]+wexp[1]*top*s[7]
				D[7,2]=B[2,7]+wexp[2]*top*s[7]
				D[7,3]=B[3,7]+wexp[3]*top*s[7]
				D[7,4]=B[4,7]+wexp[4]*top*s[7]
				D[7,5]=B[5,7]+wexp[5]*top*s[7]
				D[7,6]=B[6,7]+wexp[6]*top*s[7]
...
save c:/data/restat_12_9/bootstrap_results/bsivlinoil_coll, replace
