* TABLE5_5_RESULTS.DO
*
* This program obtains results in Table 5 "line" 5 (MNL with alternative set of covariates 2)
...
* Alternative model #2: demographics+some overall history on welfare dependency and housing and moves
local xvars "`xdem' `xfam' `xeduc' pshous moves1t2 movesge3 oadclt2y oadc2t5y oadc5t10" 
local xgps 	"`xvars'" 
