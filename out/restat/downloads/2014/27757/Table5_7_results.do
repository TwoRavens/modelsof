* TABLE5_7_RESULTS.DO
*
* This program obtains results in Table 5 "line" 7 (MNL with alternative set of covariates 4)
* of the paper (as well as corresponding appendix results)
*
...
local xextragps 			"tot_emp_popg0_2 tot_emp_popg2_0"
...
* Alternative list of covariates for GPS estimation and partial mean model
* Alternative model #4: demographics+some overall history on welfare dependency and housing and moves
*                       +earnings and employment history, up to 8 qtrs before RA
local xvars "`xdem' `xfam' `xeduc' pshous moves1t2 movesge3 oadclt2y oadc2t5y oadc5t10 `xemp' `xearn'" 
