* MAIN_RESULTS_BENCHMARK.DO
*
* This program obtains benchmark model results
* for Tables 2, 3 and 4 in the paper
*
...
* Data to be used
use "`datadir'benchmark_analysis.dta", clear 
