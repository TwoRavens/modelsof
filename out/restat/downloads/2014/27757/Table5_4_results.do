* TABLE5_4_RESULTS.DO
*
* This program obtains results in Table 5 "line" 4 (MNL with alternative set of covariates 1)
...
* Alternative model #1: no history variables of any sort (only pure demographics)
local xvars "`xdem' `xfam' `xeduc'" 
local xgps 	"`xvars'" 
