* TABLE5_6_RESULTS.DO
*
* This program obtains results in Table 5 "line" 6 (MNL with alternative set of covariates 3)
...
* Alternative model #3: demographics+some overall history on welfare dependency and housing and moves
*                       +Food Stamps and welfare use prior 7 qtrs before RA
local xvars "`xdem' `xfam' `xeduc' `xhist'" 
local xgps 	"`xvars'" 
