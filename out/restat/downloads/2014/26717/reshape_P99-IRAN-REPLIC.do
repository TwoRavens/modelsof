...
preserve
	...
	* Rename for Reshape
	...
	foreach pl of numlist `placebosfor_P99_93'{
	  ...
	  reshape long  gdppccteus_b100_93_PL                                                                     , i(YearsFromLD) j(Placebo)

	sort  YearsFromLD Placebo
	save	 gdppccteus_Placebos_P99-IRAN.dta, replace
...
preserve
	...
	* Rename for Reshape
	...
	foreach pl of numlist `placebosfor_P99_93'{
	  ...
	  reshape long  gdppccteus_b100synth_93_PL                                                                                    , i(YearsFromLD) j(Placebo)

	sort  YearsFromLD Placebo
	save	 gdppccteus_Placebos_synthetic_P99-IRAN.dta, replace

restore

use gdppccteus_Placebos_P99-IRAN.dta
merge YearsFromLD Placebo using gdppccteus_Placebos_synthetic_P99-IRAN.dta
...
saveold diffs_Placebos_P99-IRAN.dta, replace
