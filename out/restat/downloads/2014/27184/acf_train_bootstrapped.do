...
program define acf_trainingbootstrap, rclass
	...
	***********making data for second step
	...
	gen `tag'  = missing(`phihat_lag', k , k_lag, l, av, m, trainlshare , trainlshare_lag) 
	

	****GMM

	gen `sample' = missing(`phi_hat', `phihat_lag', k, l, av, l_lag, k_lag, trainlshare, trainlshare_lag )
