...
cap n log close; log using p-prep5-ran-do3b.log, replace;
...
sort scat; list; drop if scat<=19; for any 39 49 59 69: drop if scat==X;
...
forvalues LLB=1(1)1000 {;
  ...
  * Save output file;
  sort dist; save ./../../../svdata-do/random3/do-ran-density-`KKB'-`LLB', replace;
  *cap n erase ./../../../svdata-do/random3/do-ran-density-`KKB'-`LLB'.dta.gz;;
  !gzip ./../../../svdata-do/random3/do-ran-density-`KKB'-`LLB'.dta;
