...
cap n log close; log using p-prep5-ran-do3a.log, replace;
...
sort scat; list; keep if (scat>=10 & scat<=15);
...
forvalues LLA=1(1)1000 {;

  * Load collapse distance data (true distances with spacers, has both zero and one);
  use ./../../../svdata-do/dist-template, clear;
  !gunzip ./../../../svdata-do/random2/do-dist-cross-`KKA'-`LLA'.dta;
  sort dist; merge dist using ./../../../svdata-do/random2/do-dist-cross-`KKA'-`LLA', nok;
  ...
  * Save output file;
  sort dist; save ./../../../svdata-do/random3/do-ran-density-`KKA'-`LLA', replace;
  *cap n erase ./../../../svdata-do/random3/do-ran-density-`KKA'-`LLA'.dta.gz;;
