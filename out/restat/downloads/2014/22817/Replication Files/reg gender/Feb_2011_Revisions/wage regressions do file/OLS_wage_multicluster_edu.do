...
clear
log using "Feb_2011_Revisions\log_wage\OLS_`sx'_wg_edu_3clust_omb_obs`xobs'_`yr'.log", replace  
...
forvalues pop= 1(1)5 { 
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/**ln hour wage interaction*/
	xi: cgmreg lnwage_hr occpop_distc  `controls' i.bpl i.pwmetro i.region, cluster(pwmetro occ1990 bpl)
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */	
	xi: cgmreg lnwage_wk occpop  `controls' i.bpl i.pwmetro i.region, cluster(pwmetro occ1990 bpl)
	if `pop'==1 & `yr'==00 {
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/*ln weekly wage interaction*/
	xi: cgmreg lnwage_wk occpop_distc  `controls' i.bpl i.pwmetro i.region, cluster(pwmetro occ1990 bpl)
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/*ln hour wage interaction*/
	xi: cgmreg lnwage_hr occpop_distc  `controls' i.bpl i.pwmetro i.region if bpl!=200, cluster(pwmetro occ1990 bpl)
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwgint_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_hrwgint_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */
	xi: cgmreg lnwage_wk occpop  `controls' i.bpl i.pwmetro i.region if bpl!=200, cluster(pwmetro occ1990 bpl)
	if `pop'==1 & `yr'==00 {
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/*ln weekly wage interaction*/
	xi: cgmreg lnwage_wk occpop_distc  `controls' i.bpl i.pwmetro i.region if bpl!=200, cluster(pwmetro occ1990 bpl)
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwgint_edu_obs`xobs'_3clust_omb_nomex.xls.", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc  `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\OLS_`sx'_wkwgint_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
