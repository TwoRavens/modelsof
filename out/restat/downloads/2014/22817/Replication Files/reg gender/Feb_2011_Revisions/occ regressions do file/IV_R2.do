...
log using "Feb_2011_Revisions\log\IV_R2_Matrix_obs`xobs'.log", replace
log close
...
mat b =(0\0)
matrix rownames b = iv_`xobs' OLS_`xobs'_nomex
mat a =(0\0)
...
log using "Feb_2011_Revisions\log\iv_R2_Matrix_obs`xobs'.log", append
matrix list b
log close
