...
log using "Feb_2011_Revisions\log\OLS_R2_ed_eng_Matrix_obs`xobs'.log", replace
log close
...
mat b =(0\0)
matrix rownames b = OLS_`xobs' OLS_`xobs'_nomex
mat a =(0\0)
...
log using "Feb_2011_Revisions\log\OLS_R2_ed_eng_Matrix_obs`xobs'.log", append
log close
