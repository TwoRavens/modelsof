...
foreach xobs in 100 {
log using "Feb_2011_Revisions\log\iv_R2_Matrix_occ_edu_obs`xobs'.log", replace
log close
...
mat b =(0\0)
matrix rownames b = iv_`xobs' IV_`xobs'_nomex
mat a =(0\0)
...
log using "Feb_2011_Revisions\log\iv_R2_Matrix_occ_edu_obs`xobs'.log", append
matrix list b
log close
