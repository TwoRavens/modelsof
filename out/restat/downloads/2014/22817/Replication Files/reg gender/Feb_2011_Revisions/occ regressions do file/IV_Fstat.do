...
log using "Feb_2011_Revisions\log\IVFstatMatrix.log", replace
log close
...
clear
log using "Feb_2011_Revisions\log\IVFstat_`sx'_3clust_omb_obs`xobs'_`yr'.log", replace  
...
/*****************  IV ******************/
if `yr'==80 {
local controls "age age2 male english edu2 edu3 edu4 marst2 marst3 marst4 marst5 marst6"
}
else {
local controls "age age2 male english edu2 edu3 edu4 edu5 edu6 marst2 marst3 marst4 marst5 marst6"
}


mat b=(0,0,0,0)
matrix colnames b = p_occ_old_country  p_native_occ  p_occ_met  cntry_met
mat a = (0,0,0,0)
...
forvalues pop= 1(1)5 { 
	...
	xi:  regress p_occ_old_country p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region  
	mat a[1,1]=e(F)
	xi:  regress p_nat_occ p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region 
	mat a[1,2]=e(F)
	xi:  regress p_occmet p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region 
	mat a[1,3]=e(F)
	xi:  regress cntry_met p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region 
	mat a[1,4]=e(F)
	matrix rownames a =reg_`sx'_`yr'_poplr`pop'_obs`xobs'
	...
	xi:  regress p_occ_old_country p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region if bpl!=200  
	mat a[1,1]=e(F)
	xi:  regress p_nat_occ p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region if bpl!=200 
	mat a[1,2]=e(F)
	xi:  regress p_occmet p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region if bpl!=200 
	mat a[1,3]=e(F)
	xi:  regress cntry_met p_occ_countrymet`pop'_`ivyr' p_native_occ`pop'_`ivyr' p_occ_met`pop'_`ivyr' cntry_met_`ivyr'  mean_occedu `controls' i.bpl i.pwmetro i.region if bpl!=200 
	mat a[1,4]=e(F)
	matrix rownames a =reg_`sx'_`yr'_poplr`pop'_obs`xobs'_nomex
...
log using "Feb_2011_Revisions\log\IVFstatMatrix.log", append  
matrix list b
log close
