...
log using "Feb_2011_Revisions\log_panel\Panel_R2_Matrix_obs`xobs'.log", replace
log close
...
mat b =(0\0)
matrix rownames b = Panel_`xobs' Panel_`xobs'_nomex
mat a =(0\0)
...
log using "Feb_2011_Revisions\log_panel\Panel_R2_Matrix_obs`xobs'.log", append
matrix list b
log close
