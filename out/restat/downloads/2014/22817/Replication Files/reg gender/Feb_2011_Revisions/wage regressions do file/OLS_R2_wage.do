...
foreach xobs in 100 {
log using "Feb_2011_Revisions\log_wage\OLS_R2_Matrix_wage_obs`xobs'.log", replace
log close
...
log using "Feb_2011_Revisions\log_wage\OLS_R2_Matrix_wage_obs`xobs'.log", append
matrix list b
log close
