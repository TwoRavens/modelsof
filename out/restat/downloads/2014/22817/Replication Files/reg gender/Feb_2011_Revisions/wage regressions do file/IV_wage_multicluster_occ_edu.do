...
clear
cd "C:\Users\kp\Documents\thesis_topic occdist\reg_gender" 
log using "Feb_2011_Revisions\log_wage\IV_`sx'_wg_occedu_3clust_omb_obs`xobs'_`yr'.log", replace  
...
forvalues pop= 1(1)5 { 
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwg_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwg_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwgint_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwgint_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwg_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwg_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwgint_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwgint_occedu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}	
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwg_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwg_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/**ln hour wage interaction*/
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwgint_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_hrwgint_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwg_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwg_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/**ln weekly wage interaction*/
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwgint_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_occ_edu\IV_`sx'_wkwgint_occedu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}	
