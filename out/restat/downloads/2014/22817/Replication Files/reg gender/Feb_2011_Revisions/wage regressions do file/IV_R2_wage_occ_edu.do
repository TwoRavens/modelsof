...
log using "Feb_2011_Revisions\log_wage\IV_R2_Matrix_wage_occ_edu_obs`xobs'.log", replace
log close
...
matrix rownames b = IV_hr_`xobs' IV_hrint_`xobs' IV_wk_`xobs' IV_wkint_`xobs' IV__hr_`xobs'_nomex IV__hrint_`xobs'_nomex IV__wk_`xobs'_nomex IV__wkint_`xobs'_nomex
...
log using "Feb_2011_Revisions\log_wage\IV_R2_Matrix_wage_occ_edu_obs`xobs'.log", append
matrix list b
log close
