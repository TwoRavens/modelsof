...
clear
log using "Feb_2011_Revisions\log_wage\IV_`sx'_wg_edu_eng_3clust_omb_obs`xobs'_`yr'.log", replace  
...
/*****************  IV ******************/
if `yr'==80 {
local controls "age age2 male english edu2 edu3 edu4 mean_occ_edu marst2 marst3 marst4 marst5 marst6"
}
else {
local controls "age age2 male english edu2 edu3 edu4 edu5 edu6 mean_occ_edu marst2 marst3 marst4 marst5 marst6"
}
forvalues pop= 1(1)5 { 
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwg_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwg_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwgint_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwgint_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwg_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwg_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwgint_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwgint_edu_eng_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}	
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwg_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwg_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/**ln hour wage interaction*/
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwgint_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_hrwgint_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwg_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwg_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/**ln weekly wage interaction*/
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwgint_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu_eng\IV_`sx'_wkwgint_edu_eng_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}	
