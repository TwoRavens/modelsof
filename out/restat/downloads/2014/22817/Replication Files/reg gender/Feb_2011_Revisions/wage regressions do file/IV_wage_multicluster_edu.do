...
clear
log using "Feb_2011_Revisions\log_wage\IV_`sx'_wg_edu_3clust_omb_obs`xobs'_`yr'.log", replace  
...
forvalues pop= 1(1)5 { 
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwg_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwgint_edu_obs`xobs'_3clust_omb.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}	
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/**ln hour wage interaction*/
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwgint_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_hrwgint_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/** ln weekly wage */
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwg_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}
	/**ln weekly wage interaction*/
	...
	if `pop'==1 & `yr'==00 {
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwgint_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket replace
	}
	else { 
	outreg occpop_distc p_native_occ p_occ_met cntry_met `controls' using "Feb_2011_Revisions\reg_wage_output\wage_edu\IV_`sx'_wkwgint_edu_obs`xobs'_3clust_omb_nomex.xls", bdec(3) rdec(3) sigsymb(**,*,+) 10pct coefastr ctitle(occpop) bracket append
	}	
