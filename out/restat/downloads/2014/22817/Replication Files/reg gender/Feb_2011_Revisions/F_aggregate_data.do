...
sort pwmetro bpl;
save F_agg_data90.dta, replace;

/**********merge 2000 and 1990 and run regressions***********/
#delimit;
clear;
log using "reg_agg_data\F_output\F_regression.log", replace; 
use F_agg_data00.dta;
merge pwmetro bpl using F_agg_data90.dta;
drop _merge;
...
outreg using "reg_agg_data\F_output\clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket replace;
...
outreg using "reg_agg_data\F_output\clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket append;
...
outreg using "reg_agg_data\F_output\clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket append;
...
outreg using "reg_agg_data\F_output\clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket append;
...
outreg using "reg_agg_data\F_output\clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket append;
...
xi:  regress occpop1 p_occ_old_country1 p_native_occ1 p_occ_met1  cntry_met age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu1  marst1 marst2 marst3 marst4 marst5 marst6  , cluster(bpl);
outreg using "reg_agg_data\F_output\clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket replace;
xi:  regress occpop2 p_occ_old_country2 p_native_occ2 p_occ_met2 cntry_met  age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu2  marst1 marst2 marst3 marst4 marst5 marst6 , cluster(bpl);
outreg using "reg_agg_data\F_output\clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket append;
xi:  regress occpop3 p_occ_old_country3 p_native_occ3 p_occ_met3 cntry_met  age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu3  marst1 marst2 marst3 marst4 marst5 marst6 , cluster(bpl);
outreg using "reg_agg_data\F_output\clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket append;
xi:  regress occpop4 p_occ_old_country4 p_native_occ4 p_occ_met4  cntry_met age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu4  marst1 marst2 marst3 marst4 marst5 marst6 , cluster(bpl);
outreg using "reg_agg_data\F_output\clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket append;
xi:  regress occpop5 p_occ_old_country5 p_native_occ5 p_occ_met5  cntry_met age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu5  marst1 marst2 marst3 marst4 marst5 marst6  , cluster(bpl);
outreg using "reg_agg_data\F_output\clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket append;
...
log using "reg_agg_data\F_output\F_regression_avg.log", replace;
/***OLS***/
...
outreg using "reg_agg_data\F_output\avg_clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket replace;
...
outreg using "reg_agg_data\F_output\avg_clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket append;
...
outreg using "reg_agg_data\F_output\avg_clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket append;
...
outreg using "reg_agg_data\F_output\avg_clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket append;
...
outreg using "reg_agg_data\F_output\avg_clust.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket append;
/**********no mexicans**************/
drop if bpl==200;
xi:  regress occpop1 p_occ_old_country1 p_native_occ1 p_occ_met1  cntry_met age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu1  marst1 marst2 marst3 marst4 marst5 marst6  , cluster(bpl) noconstant;
outreg using "reg_agg_data\F_output\avg_clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket replace;
xi:  regress occpop2 p_occ_old_country2 p_native_occ2 p_occ_met2 cntry_met  age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu2  marst1 marst2 marst3 marst4 marst5 marst6 , cluster(bpl) noconstant;
outreg using "reg_agg_data\F_output\avg_clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket append;
xi:  regress occpop3 p_occ_old_country3 p_native_occ3 p_occ_met3 cntry_met age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu3  marst1 marst2 marst3 marst4 marst5 marst6 , cluster(bpl) noconstant;
outreg using "reg_agg_data\F_output\avg_clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket append;
xi:  regress occpop4 p_occ_old_country4 p_native_occ4 p_occ_met4  cntry_met age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu4  marst1 marst2 marst3 marst4 marst5 marst6 , cluster(bpl) noconstant;
outreg using "reg_agg_data\F_output\avg_clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket append;
xi:  regress occpop5 p_occ_old_country5 p_native_occ5 p_occ_met5  cntry_met age age2 sex english edu1 edu2 edu3 edu4 edu5 edu6 mean_occ_edu5  marst1 marst2 marst3 marst4 marst5 marst6  , cluster(bpl) noconstant;
outreg using "reg_agg_data\F_output\avg_clust_nomex.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket append;
...
log using "reg_agg_data\F_output\F_regression_avg_wt.log", replace;
...
outreg using "reg_agg_data\F_output\avg_clust1_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket replace;
...
outreg using "reg_agg_data\F_output\avg_clust2_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket replace;
...
outreg using "reg_agg_data\F_output\avg_clust3_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket replace;
...
outreg using "reg_agg_data\F_output\avg_clust4_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket replace;
...
outreg using "reg_agg_data\F_output\avg_clust5_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket replace;
...
regress occpop1_wt p_occ_old_country1_wt p_native_occ1_wt p_occ_met1_wt cntry_met_wt  age_wt age2_wt sex_wt english_wt edu1_wt edu2_wt edu3_wt edu4_wt edu5_wt edu6_wt mean_occ_edu1_wt marst1_wt marst2_wt marst3_wt marst4_wt marst5_wt marst6_wt, cluster(bpl) noconstant ;
outreg using "reg_agg_data\F_output\avg_clust1_nomex_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket replace;
regress occpop2_wt p_occ_old_country2_wt p_native_occ2_wt p_occ_met2_wt cntry_met_wt  age_wt age2_wt sex_wt english_wt edu1_wt edu2_wt edu3_wt edu4_wt edu5_wt edu6_wt mean_occ_edu2_wt marst2_wt marst2_wt marst3_wt marst4_wt marst5_wt marst6_wt, cluster(bpl) noconstant ;
outreg using "reg_agg_data\F_output\avg_clust2_nomex_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket replace;
regress occpop3_wt p_occ_old_country3_wt p_native_occ3_wt p_occ_met3_wt cntry_met_wt  age_wt age2_wt sex_wt english_wt edu1_wt edu2_wt edu3_wt edu4_wt edu5_wt edu6_wt mean_occ_edu3_wt marst3_wt marst2_wt marst3_wt marst4_wt marst5_wt marst6_wt, cluster(bpl) noconstant ;
outreg using "reg_agg_data\F_output\avg_clust3_nomex_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket replace;
regress occpop4_wt p_occ_old_country4_wt p_native_occ4_wt p_occ_met4_wt cntry_met_wt  age_wt age2_wt sex_wt english_wt edu1_wt edu2_wt edu3_wt edu4_wt edu5_wt edu6_wt mean_occ_edu4_wt marst4_wt marst2_wt marst3_wt marst4_wt marst5_wt marst6_wt, cluster(bpl) noconstant ;
outreg using "reg_agg_data\F_output\avg_clust4_nomex_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket replace;
regress occpop5_wt p_occ_old_country5_wt p_native_occ5_wt p_occ_met5_wt cntry_met_wt  age_wt age2_wt sex_wt english_wt edu1_wt edu2_wt edu3_wt edu4_wt edu5_wt edu6_wt mean_occ_edu5_wt marst5_wt marst2_wt marst3_wt marst4_wt marst5_wt marst6_wt, cluster(bpl) noconstant ;
outreg using "reg_agg_data\F_output\avg_clust5_nomex_wt.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket replace;
