...
#delimit;
clear;
log using "reg2output\log\stats_2000.log", replace;
...
table  imm_new5, row col;
table imm_new5 if bpl!=200, row col;
...
table rank_oldimm_occ if rank_oldimm_occ<=5  & rank_oldimm_occ>=1, contents( freq mean p_occ_old_countrymet ) row col;


table occpop1, contents( freq mean p_occ_old_countrymet ) row col;
table occpop2, contents( freq mean p_occ_old_countrymet ) row col;
table occpop3, contents( freq mean p_occ_old_countrymet ) row col;
table occpop4, contents( freq mean p_occ_old_countrymet ) row col;
table occpop5, contents( freq mean p_occ_old_countrymet ) row col;

summarize p_occ_old_countrymet p_native_occ p_occ_met age sex english mean_occ_edu;
table edu, row col;
table marst, row col;
...
#delimit;
clear;
log using "reg2output\log\stats_1990.log", replace;
...
#delimit;
clear;
log using "reg2output\log\stats_1980.log", replace;
