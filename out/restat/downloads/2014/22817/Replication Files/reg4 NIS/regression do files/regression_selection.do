...
log using "log\regression1_selection.log", replace;
...
xi:  heckman occpop1_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg using "output_select\heck.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket onecol replace;
xi:  heckman occpop2_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg using "output_select\heck.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket onecol  append;
xi:  heckman occpop3_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg using "output_select\heck.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket onecol  append;
xi:  heckman occpop4_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg using "output_select\heck.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket onecol  append;
xi:  heckman occpop5_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg using "output_select\heck.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket onecol  append;


/***with controls***/
xi:  heckman occpop1_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\heck_contr.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket onecol  replace;
xi:  heckman occpop2_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\heck_contr.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket onecol  append;
xi:  heckman occpop3_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\heck_contr.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket onecol  append;
xi:  heckman occpop4_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\heck_contr.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket onecol  append;
xi:  heckman occpop5_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\heck_contr.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket onecol  append;


/*** with controls plus ***/
xi:  heckman occpop1_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state  i.country_state i.b78oc90 i.country_yr i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\contr2.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop1) bracket onecol  replace;
xi:  heckman occpop2_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state  i.country_state i.b78oc90 i.country_yr i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\contr2.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop2) bracket onecol  append;
xi:  heckman occpop3_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state  i.country_state i.b78oc90 i.country_yr i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\contr2.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop3) bracket onecol  append;
xi:  heckman occpop4_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state  i.country_state i.b78oc90 i.country_yr i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\contr2.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop4) bracket onecol  append;
xi:  heckman occpop5_chg p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat  age age2 i.gendr eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us i.ciscobinsmo i.b78state  i.country_state i.b78oc90 i.country_yr i.b75yr, twostep select(occ_change = spouse_hh age i.gendr eng yrs_schl) rhosigma;
outreg  p_occ_old_countrystat   p_occ_old_imm_stat p_occ_nat_stat   age age2  _Igendr_2 eng mean_occ_edu  married empvisa yrs_us_schl yrs_schl expc_for expc_us  using "output_select\contr2.xls",   bdec(3) rdec(3) sigsymb(*,**,+) 10pct coefastr ctitle(occpop5) bracket onecol  append;
