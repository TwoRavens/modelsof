...
regress `endog' IV1 IV2 IV3 lMT250_00b lALemp8202 lALemp8202SQ lbaPct1970 lhou lden lpop lJul lJan _I*;
predict pred_`endog',;
};
...
* QR;
bs, rep(100) cl(cl) id(i) seed(1001): iqrdiff GRemp8202T lALsize8202 lALemp8202 lALemp8202SQ lbaPct1970 lhou lden lpop lJul lJan;
bs, rep(100) cl(cl) id(i) seed(1001): iqrdiff GRemp8202T lBSHempT8202 lALemp8202 lALemp8202SQ lbaPct1970 lhou lden lpop lJul lJan;
