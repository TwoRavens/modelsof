...
log using "mines_bstest_all_4inst_seed.log", append;
...
regress `endog' lMT250_00b IV1 IV2 IV3 lALemp8202 lALemp8202SQ lbaPct1970 lhou lden lpop lJul lJan lWTR_DO coast _I*;
predict pred_`endog',;
};
...
version 10.1;
if replay() {;
 syntax [anything] [, Level(real 90) ];
 eret di, level(`level');
 };
else {;
 syntax [varlist] [, Q1(real .90) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .91) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .92) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .93) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .94) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .95) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .96) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .97) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .98) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
...
if replay() {;
 ...
 syntax [varlist] [, Q1(real .99) Level(real 90) *];
 tab i, gen(_d);
 drop _d1;
 gettoken depv v1:varlist;
 tempname b1 beta;
