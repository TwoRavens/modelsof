#delimit;
cap n log close; log using /rdcprojects/br1/br00598/data/lbd10/lbd-bcd-st-sum.log, replace;
...
*** Combine files;
!gunzip ./st2/lbdc-bcd-1.dta;
use ./st2/lbdc-bcd-1.dta, clear;
cap n drop bir1* bir6* bir21* bir101*;
!gzip ./st2/lbdc-bcd-1.dta;
foreach S1 of local Ist {;
!gunzip ./st2/lbdc-bcd-`S1'.dta;
append using ./st2/lbdc-bcd-`S1'.dta;
cap n drop bir1* bir6* bir21* bir101*;
!gzip ./st2/lbdc-bcd-`S1'.dta;
};
...
save lbdc-bcd-2010-1.dta, replace;
