...
log using "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\regression results\table13.log", replace

*********************************
*FALSIFICATION YEAR+1 OF RESULTS IN TABLE 8 (REDUCED FORM) 
*********************************
...
outreg2 [*] using table13, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
...
use "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\stata dataset\dataset avec sinistres2 rain deviation monthly revision falsification.dta", clear
tsset id year
** Sans la Corse
 drop if id==20
