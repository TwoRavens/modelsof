...
log using "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\regression results\tableA10.log", replace


**
*LIML 1st stage No September
...
ivreg2 logrepublican iyear_*   (  tax =  logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) savefirst
outreg2 [*] using tableA10, aster se bd(3) br  addstat(R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
...
ivreg2 logrepublican iyear_*  logfertility logp_illiterate logp_urbanpop logp_industry logp_service log_roads log_aid   (  tax =  logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) savefirst
outreg2 [*] using tableA10, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
...
ivreg2 logrepublican iyear_*   (  logper_capita_tax = logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) savefirst
outreg2 [*] using tableA10, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
...
ivreg2 logrepublican iyear_*   logfertility logp_illiterate logp_urbanpop logp_industry logp_service  log_roads  log_aid (  logper_capita_tax = logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) savefirst
outreg2 [*] using tableA10, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
...
ivreg2 logrepublican iyear_*   (  logboisson_indirect_tax =   logjanvier logfevrier logmars logavril logjuin logjuillet logaout   ), liml    robust cluster(id) savefirst
outreg2 [*] using tableA10, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
...
ivreg2 logrepublican iyear_* logfertility logp_illiterate logp_urbanpop logp_industry logp_service  log_roads log_aid  (  logboisson_indirect_tax =  logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) savefirst
outreg2 [*] using tableA10, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
