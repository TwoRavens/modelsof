...
log using "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\regression results\tableA9.log", replace


***
*LIML 2nd stage NO SEPTEMBER
**
...
ivreg2 logrepublican iyear_*   (  tax =  logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) first
outreg2 using tableA9,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
...
ivreg2 logrepublican iyear_*  logfertility logp_illiterate logp_urbanpop logp_industry logp_service  log_roads log_aid  (  tax =  logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) first
outreg2 using tableA9,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
...
ivreg2 logrepublican iyear_*   (  logper_capita_tax = logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) first
outreg2 using tableA9,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
...
ivreg2 logrepublican iyear_*   logfertility logp_illiterate logp_urbanpop logp_industry logp_service  log_roads  log_aid (  logper_capita_tax = logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) first
outreg2 using tableA9,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
...
ivreg2 logrepublican iyear_*   (  logboisson_indirect_tax =   logjanvier logfevrier logmars logavril logjuin logjuillet logaout   ), liml    robust cluster(id) first
outreg2 using tableA9,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
...
ivreg2 logrepublican iyear_* logfertility logp_illiterate logp_urbanpop logp_industry logp_service  log_roads log_aid  (  logboisson_indirect_tax =  logjanvier logfevrier logmars logavril logjuin logjuillet logaout  ), liml    robust cluster(id) first
outreg2 using tableA9,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
