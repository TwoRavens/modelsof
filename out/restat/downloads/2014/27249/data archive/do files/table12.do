...
log using "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\regression results\table12.log", replace




****
*FALSIFICATION YEAR+4 OF RESULTS IN TABLES 6 & 7
****
...
use "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\stata dataset\dataset avec sinistres cont ind2 rain deviation monthly revision falsification4.dta", clear
...
outreg2 using table12,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
...
use "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\stata dataset\dataset avec sinistres2 rain deviation monthly revision falsification4.dta", clear
tsset id year
** Sans la Corse
 drop if id==20
