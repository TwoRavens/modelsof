...
log using "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\regression results\table8.log", replace

****
* REDUCED FORM ESTIMATES
****

** Columns 1 to 6:    absolute rainfall deviation from average
** Columns 7 to 12:   squared rainfall deviation from average
** Columns 13 to 18:  one-sided rainfall deviation from average
...
outreg2 [*] using table8, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
