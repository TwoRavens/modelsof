...
log using "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\regression results\tableA8.log", replace
...
outreg2 [*] using tableA8, aster se bd(3) br  addstat(Centered R2, e(r2), Uncentered R2, e(r2_a), F-stat, e(F), Prob > F, e(Fp), Obs., e(N)) adec(3) label excel
