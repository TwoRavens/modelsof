...
log using "C:\Documents and Settings\user\My Documents\Income, democracy and religion\Income, democracy and religion, 1876-1889\regression results\table9.log", replace




****
*FALSIFICATION YEAR+1 OF RESULTS IN TABLES 6 & 7
****
...
outreg2 using table9,aster se bd(3) br  addstat(Hansen J-test, e(arubin), Prob J-test , e(arubinp), Clusters, e(N_clust),  Obs., e(N)) adec(3) label excel 
