...
foreach type of local typeAll {;
	...
	file write `hh' "\multicolumn{8}{l}{Full Sample" _char(36) "{}^*" _char(36) "---Absolute Average} " $eolString _n;
	...
	******************************************************************************************************************************;
	file write `hh' "\midrule" _n "\multicolumn{9}{l}{Booms" _char(36) "{}^\dagger" _char(36) "} " $eolString _n;
	...
	******************************************************************************************************************************;
	file write `hh' "\midrule" _n "\multicolumn{9}{l}{Recessions" _char(36) "{}^\dagger" _char(36) "} " $eolString _n;
	...
	file write `hh' "Interest Rate & " %4.2f (r3mmean`type'Recessioncn) " & "   %4.2f (r3mmean`type'Recessionfr) " & "  %4.2f (r3mmean`type'Recessionge) " & "  %4.2f (r3mmean`type'Recessionit) " & "  %4.2f (r3mmean`type'Recessionjp) " & "  %4.2f (r3mmean`type'Recessionuk) " & "  %4.2f (r3mmean`type'Recessionus)  " & "  %4.2f (r3mmean`type'RecessionAll) $eolString _n;
	...
	******************************************************************************************************************************;
	file write `hh' "\midrule" _n "\multicolumn{9}{l}{Pre-1999" _char(36) "{}^\dagger" _char(36) "} " $eolString _n;
	...
	******************************************************************************************************************************;
	file write `hh' "\midrule" _n "\multicolumn{9}{l}{1999+" _char(36) "{}^\dagger" _char(36) "} " $eolString _n;

	file write `hh' "Inflation & " %4.2f (inflmean`type'2ndHalfcn) " & "   %4.2f (inflmean`type'2ndHalffr) " & "  %4.2f (inflmean`type'2ndHalfge) " & "  %4.2f (inflmean`type'2ndHalfit) " & "  %4.2f (inflmean`type'2ndHalfjp) " & "  %4.2f (inflmean`type'2ndHalfuk) " & "  %4.2f (inflmean`type'2ndHalfus) " & "  %4.2f (inflmean`type'2ndHalfAll)  $eolString _n;
	...
	file write `hh' " \bottomrule" _n "\multicolumn{9}{p{11.5cm}}{" _n "\showEstTime{Estimated: $S_DATE, $S_TIME}" _n _n;

	file write `hh' " {\scriptsize Notes: *:  Absolute average (across the full sample). $\dagger$: Averages relative to full-sample averages (shown in the top panel). All averages taken across time periods. }" _n "}" _n;
