...
cd "`basepath'stata/";
capture log close;
log using disagreementAnalysis_aggregate_panel.log, replace;
...
qui do "`basepath'stata/write/writeSumStatAllCountriesAllVars_v2.do";			
