...
forvalues j=1/$nb_e {
    ...
    mat drop tata
    mat objR`j'_${tt}= -DSII`j'*IR`j'${tt}*sj_p_star
            }
mat obj${tt}=IR1${tt}*objR1_${tt}
forvalues i=2/$nb_e {
    mat obj${tt}=obj${tt}+IR`i'${tt}*objR`i'_${tt}
        }
...
forvalues j=1/$nb_e{
    mat SP2`j'PGSP`t'=SP2`j'PG*IR`j'${tt} +sp_star*IR`j'${tt} + IR`j'${tt}*(sp_star)'*IR`j'${tt}
    mat drop SP2`j'PG
...
save simulRPM_WRPM_unif_MS_cost10.dta,replace
