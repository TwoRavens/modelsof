/*Summary statistics of the MMP107: McKenzie and Rapoport sample*/
clear
capture log close
set matsize 800
set memory 900m
set more off
log using summarystatisticsrevmmp71allmr107.log, replace

use mmp71allmr, clear

gen include = 1 if edad > 14 & edad < 50 & relhead==1
