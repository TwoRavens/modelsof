/*Summary statistics of the MMP: it only includes household heads*/
clear
capture log close
set matsize 800
set memory 900m
set more off
log using summarystatisticsrevmmpnew.log, replace

use mmp107headsnew, clear
...
_pctile rhwage [pw=weight] if mujer == 0 & mig == 0 & include == 1 
matrix resultsmen[27,1] = r(r1)
_pctile rhwage [pw=weight] if mujer == 0 & mig == 1 & include == 1 
...
_pctile rhwage [pw=weight] if mujer == 1 & mig == 0 & include == 1 
matrix resultswomen[27,1] = r(r1)
_pctile rhwage [pw=weight] if mujer == 1 & mig == 1 & include == 1 
