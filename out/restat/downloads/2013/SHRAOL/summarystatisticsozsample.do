/*Summary statistics of the MMP Orrenius and Zavodny sample*/
clear
capture log close
set matsize 800
set memory 900m
set more off
log using summarystatisticsozsample.log, replace

use mmpozsample, clear

gen include = 1 if edad > 14 & edad < 65 & surveyyr<1998
