...
*Create the sample in the same way as Orrenius and Zavodny (2005)*
clear
capture log close
set matsize 800
set memory 900m
log using mmpozsample.log, replace
...
*Restrict the dataset to observations in the 1987-1997 period*
drop if surveyyr < 1987
drop if surveyyr > 2004
drop if year < 1965
...
*Migration variable: Orrenius and Zavodny (2005)*
gen mig = 0 if usyr1==8888
replace mig = 1 if usyr1 == year & usdoc1==8
