...
*Adjust information on wages just to keep those wages referring to pre-migration status*
clear
capture log close
set matsize 800
set memory 900m
log using mmpruralurbanlifenew.log, replace
