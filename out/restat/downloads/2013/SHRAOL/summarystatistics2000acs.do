...
set memory 900m
set more off
log using summarystatisticsacs2000.log, replace

use year rhwage schoolyears migplac1 mujer perwt edad using usdataset, clear
compress

gen include = 1 if edad > 15 & edad < 66 & migplac1==200 & year == 2000
