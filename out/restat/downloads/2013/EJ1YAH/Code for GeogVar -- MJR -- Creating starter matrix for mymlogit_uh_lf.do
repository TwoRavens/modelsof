...
*** Assemble the starter matrix, using 2.6 (about 93%) as the starting group probability ***
*** -- the starting probability choice is somewhat arbitrary, based on the results from  ***
***    a few preliminary regressions                                                     ***
...
matrix starter = (afirst,asecond,constfirst-0.5,constfirst+0.5,2.6,constsecond-0.5,constsecond+0.5)
matrix list starter
