...
infix ///
 ...
 byte    deducts                            285 ///
 int     poverty                            286-288 ///
 using "$startdir/$inputdata\ipums\1920\usa_1920.dat"
...
save "$startdir/$outputdata\usa_1920.dta", replace
...
save "$startdir/$outputdata\population_1920.dta", replace;

use "$startdir/$outputdata\usa_1920.dta";
gen cohort=year-age;
...
save "$startdir/$outputdata\usa_1920_sample.dta", replace;
