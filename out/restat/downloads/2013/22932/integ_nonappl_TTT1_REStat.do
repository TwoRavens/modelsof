...
replace prob_nu0_`i' = (z/2)*(normalden((nu0-0.5*z),0,csig_nu0)+normalden((nu+0.5*z),0,csig_nu0)) if applicant ==0
local t=0
local m=-1
while `t'<`p'+1 {
replace e= -`r' + `t'*z
...
gen prob_1_`i'=.
replace prob_1_`i' = prob_nu0_`i' *prob_1a_`p' if applicant==0
gen e1func_`i'=.
replace e1func_`i' = prob_1_`i' if applicant==0
replace e1func_`i' = cond(`i'>0,(e1func_`i'+ e1func_`j'),e1func_`i')
gen prob_2_`i'=.
replace prob_2_`i' = prob_nu0_`i' *prob_2a_`p' if applicant==0
gen e2func_`i'=.
replace e2func_`i' = prob_2_`i' if applicant==0
replace e2func_`i' = cond(`i'>0,(e2func_`i'+ e2func_`j'),e2func_`i')
gen prob_3_`i'=.
replace prob_3_`i' = prob_nu0_`i' *prob_3a_`p' if applicant==0
gen e3func_`i'=.
replace e3func_`i' = prob_3_`i' if applicant==0
replace e3func_`i' = cond(`i'>0,(e3func_`i'+ e3func_`j'),e3func_`i')
gen prob_4_`i'=.
replace prob_4_`i' = prob_nu0_`i' *prob_4a_`p' if applicant==0
gen e4func_`i'=.
replace e4func_`i' = prob_4_`i' if applicant==0
replace e4func_`i' = cond(`i'>0,(e4func_`i'+ e4func_`j'),e4func_`i')
gen prob_5_`i'=.
replace prob_5_`i' = prob_nu0_`i' *prob_5a_`p' if applicant==0
gen e5func_`i'=.
replace e5func_`i' = prob_5_`i' if applicant==0
replace e5func_`i' = cond(`i'>0,(e5func_`i'+ e5func_`j'),e5func_`i')
gen prob_6_`i'=.
replace prob_6_`i' = prob_nu0_`i' *prob_6a_`p' if applicant==0
gen e6func_`i'=.
replace e6func_`i' = prob_6_`i' if applicant==0
replace e6func_`i' = cond(`i'>0,(e6func_`i'+ e6func_`j'),e6func_`i')
gen prob_7_`i'=.
replace prob_7_`i' = prob_nu0_`i' *prob_7a_`p' if applicant==0
gen e7func_`i'=.
replace e7func_`i' = prob_7_`i' if applicant==0
replace e7func_`i' = cond(`i'>0,(e7func_`i'+ e7func_`j'),e7func_`i')
gen prob_8_`i'=.
replace prob_8_`i' = prob_nu0_`i' *prob_8a_`p' if applicant==0
gen e8func_`i'=.
replace e8func_`i' = prob_8_`i' if applicant==0
replace e8func_`i' = cond(`i'>0,(e8func_`i'+ e8func_`j'),e8func_`i')
gen prob_9_`i'=.
replace prob_9_`i' = prob_nu0_`i' *prob_9a_`p' if applicant==0
gen e9func_`i'=.
replace e9func_`i' = prob_9_`i' if applicant==0
replace e9func_`i' = cond(`i'>0,(e9func_`i'+ e9func_`j'),e9func_`i')
gen prob_10_`i'=.
replace prob_10_`i' = prob_nu0_`i' *prob_10a_`p' if applicant==0
gen e10func_`i'=.
replace e10func_`i' = prob_10_`i' if applicant==0
replace e10func_`i' = cond(`i'>0,(e10func_`i'+ e10func_`j'),e10func_`i')
gen prob_11_`i'=.
replace prob_11_`i' = prob_nu0_`i' *prob_11a_`p' if applicant==0
gen e11func_`i'=.
replace e11func_`i' = prob_11_`i' if applicant==0
replace e11func_`i' = cond(`i'>0,(e11func_`i'+ e11func_`j'),e11func_`i')
gen prob_12_`i'=.
replace prob_12_`i' = prob_nu0_`i' *prob_12a_`p' if applicant==0
gen e12func_`i'=.
replace e12func_`i' = prob_12_`i' if applicant==0
...
gen prob_ehak = normal(-q*isignu) if applicant == 0
local p = 100
gen f1unc`p'_nonappl = e1func_`p'/prob_ehak
gen f2unc`p'_nonappl = e2func_`p'/prob_ehak
gen f3unc`p'_nonappl = e3func_`p'/prob_ehak
gen f4unc`p'_nonappl = e4func_`p'/prob_ehak
gen f5unc`p'_nonappl = e5func_`p'/prob_ehak
gen f6unc`p'_nonappl = e6func_`p'/prob_ehak
gen f7unc`p'_nonappl = e7func_`p'/prob_ehak
gen f8unc`p'_nonappl = e8func_`p'/prob_ehak
gen f9unc`p'_nonappl = e9func_`p'/prob_ehak
gen f10unc`p'_nonappl = e10func_`p'/prob_ehak
gen f11unc`p'_nonappl = e11func_`p'/prob_ehak
gen f12unc`p'_nonappl = e12func_`p'/prob_ehak

drop  e1func_`p' e2func_`p' e3func_`p' e4func_`p' e5func_`p' e6func_`p' e7func_`p' e8func_`p' ///
e9func_`p' e10func_`p' e11func_`p' e12func_`p' z* q xbs nu0 e prob_ehak
