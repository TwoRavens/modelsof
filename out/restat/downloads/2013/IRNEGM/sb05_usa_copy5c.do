...
local result_dir "F:\NETSData2007\Generated_files\SB05\Results5c"
local temp_dir "F:\NETSData2007\Generated_files\SB05\Temp5c"
...
local log_file "`log_dir'\\sb05_usa_copy5c.log"
...
*********************
*DROP EVERY OTHER YEAR OF DATA. ARTIFICIAL DATA SENSOR TO CONSIDER 2YR CHANGES
*********************

forvalues x = 1990(2)2004 {
	drop if year==`x'
}
...
***THIS CODE HAS ALSO CHANGED BECAUSE OF CONSIDERATION OF 2YR WINDOW
...
**CHANGED FOR 2YR WINDOW
forvalues x = 1989(2)2005 {
replace firstyear = firstyear +1 if firstyear==`x'
}
forvalues x = 1990(2)2004 {
replace lastyear = lastyear - 1 if lastyear==`x'
}
keep if year==firstyear+1 | year==lastyear
duplicates report dunsnumber
save "`temp_dir'\\multiyearestab.dta", replace
keep if year==firstyear+1 & year==lastyear
replace year=lastyear+2 if year==lastyear
append using `temp_dir'\\multiyearestab.dta
erase "`temp_dir'\\multiyearestab.dta"
replace year=firstyear-1 if year==firstyear+1
replace year=lastyear+2 if year==lastyear
replace emp=0
keep emp dunsnumber year firstyear lastyear hqduns naics fips_ca empc
...
count if emp==.
gen empdiff = emp - L2.emp
gen avgemp = (L2.emp + emp)/2
...
forvalues zerovalue = 1995(2)2005 {
replace _`zerovalue' = 0 if _`zerovalue' == .
}

mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(curremp)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(curr_gcreation)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(curr_gdestruct)
...
**gross creation rate
matrix define curr_gc_rate = J(9,6,0)
matrix define curr_gd_rate = J(9,6,0)
matrix define curr_nc_rate = J(9,6,0)
forvalues i = 1/9 {
forvalues j = 1/6 {
**gross creation rate
...
matrix define curr_empshare = J(9,6,0)
forvalues i = 1/9 {
forvalues j = 1/6 {
**gross creation rate
...
matrix colnames `x' = _1995 _1997 _1999 _2001 _2003 _2005
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(baseemp)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(base_gcreation)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(base_gdestruct)
...
**gross creation rate
matrix define base_gc_rate = J(9,6,0)
matrix define base_gd_rate = J(9,6,0)
matrix define base_nc_rate = J(9,6,0)
forvalues i = 1/9 {
forvalues j = 1/6 {
**gross creation rate
...
**Current Emp Size Category Share of Overall Employment
matrix define base_empshare = J(9,6,0)
forvalues i = 1/9 {
forvalues j = 1/6 {
**gross creation rate
...
gen avgfirmemp = (L2.firmemp + firmemp)/2
gen firmempdiff = firmemp - L2.firmemp
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(firmcurremp)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(firmcurr_gcreation)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(firmcurr_gdestruct)
...
**gross creation rate
matrix define firmcurr_gc_rate = J(12,6,0)
matrix define firmcurr_gd_rate = J(12,6,0)
matrix define firmcurr_nc_rate = J(12,6,0)
forvalues i = 1/12 {
forvalues j = 1/6 {
**gross creation rate
...
**Current Emp Size Category Share of Overall Employment
matrix define firmcurr_empshare = J(12,6,0)
forvalues i = 1/12 {
forvalues j = 1/6 {
**gross creation rate
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(firmbaseemp)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(firmbase_gcreation)
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(firmbase_gdestruct)
...
**gross creation rate
matrix define firmbase_gc_rate = J(12,6,0)
matrix define firmbase_gd_rate = J(12,6,0)
matrix define firmbase_nc_rate = J(12,6,0)
forvalues i = 1/12 {
forvalues j = 1/6 {
**gross creation rate
...
**Current Emp Size Category Share of Overall Employment
matrix define firmbase_empshare = J(12,6,0)
forvalues i = 1/12 {
forvalues j = 1/6 {
**gross creation rate
...
mkmat _1995 _1997 _1999 _2001 _2003 _2005, matrix(currentfirmemp)
