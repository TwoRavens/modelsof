...
* choose: 1.Northeast, 3.South, 4.West
...
mat2txt, matrix(${abv}_bMWxi) saving("${foldp1}/Results/DG/${asset}/US/Table_${abv}_bMWxi") title(Decomp of Bus dstrb within US) format(%9.4f) replace
