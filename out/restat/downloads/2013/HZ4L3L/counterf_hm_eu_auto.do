...
* EU country # (EU country base is DE: 3.Germany)
* 1. SE 2.DK,  4.NL, 5.BE, 6.FR, 7.CH, 8.AT, 9. IT, 10.ES, 11.GR, 12.EN

************************************

foreach cntr of numlist 1 2 4(1)12 {


*use "${foldp}Data/SHARE_final_DG.dta", clear
*append using "${foldp}Data/ELSA_final_DG.dta"
use "${foldp1}Data/SHARE/SHARE_DG.dta", clear
append using "${foldp1}Data/ELSA/Data_ELSA_DG.dta"


keep if head==1

keep if country==3 | country==`cntr'
...
sort p
 ...
 if `cntr' ==1 {
mat ${abv}_bDExi = `cntr', dif[10], ref[10], ref[10]/SE_ref[10], cvef[10], cvef[10]/SE_cvef[10], dif[25], ref[25] , ref[25]/SE_ref[25], cvef[25], cvef[25]/SE_cvef[25], dif[50], ref[50], ref[50]/SE_ref[50], cvef[50], cvef[50]/SE_cvef[50], dif[75], ref[75], ref[75]/SE_ref[75], cvef[75], cvef[75]/SE_cvef[75], dif[90], ref[90] , ref[90]/SE_ref[90], cvef[90], cvef[90]/SE_cvef[90] 
}

 if `cntr' !=1 {
mat ${abv}_bDExih= `cntr', dif[10], ref[10], ref[10]/SE_ref[10], cvef[10], cvef[10]/SE_cvef[10], dif[25], ref[25], ref[25]/SE_ref[25], cvef[25], cvef[25]/SE_cvef[25], dif[50], ref[50], ref[50]/SE_ref[50], cvef[50], cvef[50]/SE_cvef[50], dif[75], ref[75], ref[75]/SE_ref[75], cvef[75], cvef[75]/SE_cvef[75], dif[90], ref[90] , ref[90]/SE_ref[90], cvef[90], cvef[90]/SE_cvef[90]
mat  ${abv}_bDExi = ${abv}_bDExi\ ${abv}_bDExih
}

* Save dataset
 save "${foldp1}Results/DG/${asset}/EU/${abv}_DE_`cntr'.dta", replace

}

matrix coln ${abv}_bDExi = Country Diff_10 Coeff_10 tcf_10 Cov_10 tcv_10 Diff_25 Coeff_25 tcf_25 Cov_25 tcv_25 Diff_50 Coeff_50 tcf_50 Cov_50 tcv_50 Diff_75 Coeff_75 tcf_75 Cov_75 tcv_75 Diff_90 Coeff_90 tcf_90 Cov_90 tcv_90 
mat2txt, matrix(${abv}_bDExi) saving("${foldp1}/Results/DG/${asset}/EU/Table_${abv}_bDExi") title(Decomp of House dstrb within EU) format(%9.4f) replace
