...
// Remember to remove all trailing spaces in original data folders (eg 2005 ASCII --> 2005ASCII)
*log using `outputpath'/LOG_CEXmakedata`yearshort'_3_mergesampleexpnd.do, replace
*---------------------------end of user input------------------------------------
...
* -----------------------------------
* Merge fmlydsample and exp44comm data
* -----------------------------------
cd `inputpath'
...
drop `commlist' mean* `sharelist' totexp	// we only move on with deseasonalised data
