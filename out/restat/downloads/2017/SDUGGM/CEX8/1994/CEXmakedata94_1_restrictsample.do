...
set mem 50m
set maxvar 32767
local yearlong = "1994"		// USER INPUT!! Year must contain exactly 4 digits (eg "2005")
...
gen educlass=.
replace educlass=1 if educ==7
replace educlass=2 if (educ==1 | educ==2)
replace educlass=3 if educ==3
replace educlass=4 if educ==4
replace educlass=5 if educ==5
replace educlass=6 if educ==6
...
gen educlassm=.
replace educlassm=1 if educ_h==7
replace educlassm=2 if (educ_h==1 | educ_h==2)
replace educlassm=3 if educ_h==3
replace educlassm=4 if educ_h==4
replace educlassm=5 if educ_h==5
replace educlassm=6 if educ_h==6

gen educlassf=.
replace educlassf=1 if educ_w==7
replace educlassf=2 if (educ_w==1 | educ_w==2)
replace educlassf=3 if educ_w==3
replace educlassf=4 if educ_w==4
replace educlassf=5 if educ_w==5
replace educlassf=6 if educ_w==6
