...
Inputs: 
fmld`yearshort'.dta: CEX fmly file (contains family characteristics, sample selection and BLS-made commodity groups)
...
egen yearincomebeftx=rowtotal(unempxm wrkrsxm welfrxm intxm divxm pensionm chdothxm aliothxm othinxm jfs_amtm fwagexm fss_rrx fsuppxm)
gen yearincome=yearincomebeftx-perstaxm
