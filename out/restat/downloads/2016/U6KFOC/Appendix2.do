...
/*THIS FILE PRODUCES THE RESULTS OF DATA APPENDIX, TABLES A4 AND A5*/ 
...
ren mu_rbnd mu_rbndold;
ren sig_rbnd sig_rbndold;
sort nq anno;

/*TRY WITH EURIBOR AND ECB REFERENCE RATE FOR THE INTEREST RATE!*/
/*Use A4expbondECB.dta to replicate table A4*/
/* merge nq anno using A4expbondECB.dta; tab _me; drop _merge; */
/*Use A5expbondEUR.dta to replicate table A5*/
merge nq anno using A5expbondEUR.dta; tab _me; drop _merge;
...
capture program drop weeffect
    program define weeffect
			...
			*/ trib_inef high_grw va2 avgva) nolog twostep
			...
			/************************************************************************/
			/****                WEALTH REGRESSIONS (TABLE A4 OR A5)             ****/
			/************************************************************************/
			#delimit cr
