...
*                                                        
insheet using "../Raw Data/ef2004c_data_stata.csv", comma clear
label data "dct_ef2004c"
...
label define label_xefres01 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefres01 51 "Outlier value derived from imputed data", add 
...
label define label_xefres02 24 "Ratio adjustment based on enrollment  by race and gender (part A)", add 
...
label define label_xefres02 51 "Outlier value derived from imputed data", add 
