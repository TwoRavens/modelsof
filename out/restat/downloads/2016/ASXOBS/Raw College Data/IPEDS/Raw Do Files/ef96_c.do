...
*                                                        
insheet using "../Raw Data/ef96_c_data_stata.csv", comma clear
label data "dct_ef96_c"
label variable unitid "unitid"
label variable part "part"
label variable line "State of Residence"
label variable efres01 "Total 1st-time freshman"
label variable efres02 "1st-time freshman graduating"
...
label define label_line 57 "Unknown", add 
...
label define label_centers -1 "No Response/Missing" 
label define label_centers 1 "Out-of-state-center checked", add 
