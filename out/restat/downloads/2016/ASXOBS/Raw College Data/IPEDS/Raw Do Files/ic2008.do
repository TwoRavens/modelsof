...
*                                                        
insheet using "../Raw Data/ic2008_data_stata.csv", comma clear
...
label define label_appdate 1 "Fall 2007", add 
...
label define label_satactdt 1 "Fall 2007", add 
...
label define label_xactwr25 10 "Reported" 
label define label_xactwr25 11 "Analyst corrected reported value", add 
label define label_xactwr25 12 "Data generated from other data values", add 
label define label_xactwr25 13 "Implied zero", add 
label define label_xactwr25 20 "Imputed using Carry Forward procedure", add 
label define label_xactwr25 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xactwr25 22 "Imputed using the Group Median procedure", add 
label define label_xactwr25 23 "Logical imputation", add 
label define label_xactwr25 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xactwr25 30 "Not applicable", add 
label define label_xactwr25 31 "Institution left item blank", add 
label define label_xactwr25 32 "Do not know", add 
label define label_xactwr25 33 "Particular 1st prof field not applicable", add 
label define label_xactwr25 50 "Outlier value derived from reported data", add 
label define label_xactwr25 51 "Outlier value derived from imported data", add 
label define label_xactwr25 52 "Value not derived - parent/child differs across components", add 
label define label_xactwr25 53 "Value not derived - data not usable", add 
label values xactwr25 label_xactwr25
label define label_xactwr75 10 "Reported" 
label define label_xactwr75 11 "Analyst corrected reported value", add 
label define label_xactwr75 12 "Data generated from other data values", add 
label define label_xactwr75 13 "Implied zero", add 
label define label_xactwr75 20 "Imputed using Carry Forward procedure", add 
label define label_xactwr75 21 "Imputed using Nearest Neighbor procedure", add 
label define label_xactwr75 22 "Imputed using the Group Median procedure", add 
label define label_xactwr75 23 "Logical imputation", add 
label define label_xactwr75 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
label define label_xactwr75 30 "Not applicable", add 
label define label_xactwr75 31 "Institution left item blank", add 
label define label_xactwr75 32 "Do not know", add 
label define label_xactwr75 33 "Particular 1st prof field not applicable", add 
label define label_xactwr75 50 "Outlier value derived from reported data", add 
label define label_xactwr75 51 "Outlier value derived from imported data", add 
label define label_xactwr75 52 "Value not derived - parent/child differs across components", add 
label define label_xactwr75 53 "Value not derived - data not usable", add 
label values xactwr75 label_xactwr75
...
label define label_pt_fp -1 "Not reported" 
