...
*                                                        
insheet using "../Raw Data/ef2005c_data_stata.csv", comma clear
label data "dct_ef2005c"
...
label define label_xefres01 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
...
label define label_xefres02 24 "Ratio adjustment based on enrollment by race/gender in part A", add 
