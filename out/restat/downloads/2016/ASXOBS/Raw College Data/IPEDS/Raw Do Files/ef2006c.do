...
*                                                        
insheet using "../Raw Data/ef2006c_data_stata.csv", comma clear
label data "dct_ef2006c"
...
label define label_xefres01 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
...
label define label_xefres02 24 "Ratio adjustment base on enrollment by race/gender in part A", add 
