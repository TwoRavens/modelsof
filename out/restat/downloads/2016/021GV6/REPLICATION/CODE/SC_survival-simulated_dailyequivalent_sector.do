...
graph export ${dir_graphs}\survival_hazard_a4_DAILY_${sales}_${database}_${sector}.png , replace 

sts graph , hazard noboundary kernel(gaussian) legend(off) ci level(99) tmax(180) width(1) 
graph export ${dir_graphs}\survival_hazard_a4_DAILY_180_${sales}_${database}_${sector}.png , replace 

sts graph , hazard noboundary kernel(gaussian) legend(off) ci level(99) tmax(360) width(1) 
graph export ${dir_graphs}\survival_hazard_a4_DAILY_360_${sales}_${database}_${sector}.png , replace 

save ${dir_results}\smhazard_${sales}_${database}_${sector}.dta, replace
