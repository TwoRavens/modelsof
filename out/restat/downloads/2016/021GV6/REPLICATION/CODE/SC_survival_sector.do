...
keep if pscode==${sector}



display "Starting ${sales}_${database}_${sector}"
...
graph export ${dir_graphs}\survival_histogramspells_${sales}_${database}_${sector}.png, replace
...
* Make each spell like a different id. Note short spells influence the results a lot.
...
graph export ${dir_graphs}\survival_hazard_a4_${sales}_${database}_${sector}.png, replace

sts graph , hazard noboundary kernel(gaussian) legend(off) ci level(99) tmax(180)  xlabel(0(10)180) xscale(range(0 180)) 
graph export ${dir_graphs}\survival_hazard_a4_180_${sales}_${database}_${sector}.png, replace
...
graph export ${dir_graphs}\survival_hazard_a4_180_scale_${sales}_${database}_${sector}.png, replace

sts graph , hazard noboundary kernel(gaussian) legend(off) tmax(180) ci level(99) width(1)  xlabel(0(10)180) xscale(range(0 180)) 
graph export ${dir_graphs}\survival_hazard_a4_s1_180_${sales}_${database}_${sector}.png, replace

sts graph , hazard noboundary kernel(gaussian) legend(off) tmax(180) ci level(99) width(15)  xlabel(0(10)180) xscale(range(0 180)) 
graph export ${dir_graphs}\survival_hazard_a4_s15_180_${sales}_${database}_${sector}.png, replace
	
sts graph, hazard noboundary kernel(gaussian) legend(off) ci level(99) by(avdur)
graph export ${dir_graphs}\survival_hazard_a4_admany_${sales}_${database}_${sector}.png, replace
...
graph export ${dir_graphs}\survival_hazard_a4_180_admany_${sales}_${database}_${sector}.png, replace

sts graph, hazard noboundary kernel(gaussian) tmax(360)legend(off) ci  level(99)  xscale(range(0 360))  by(avdur) 
graph export ${dir_graphs}\survival_hazard_a4_360_admany_${sales}_${database}_${sector}.png, replace
...
sort _t
save ${dir_results}\hazard_${sales}_${database}_${sector}.dta, replace
