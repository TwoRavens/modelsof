...
***SURVIVAL 
clear
global meanpeak_sh 0
global medianpeak_sh 0
*Survival here to get `peak_sh' and `peak_h'
if regexm("${database}","weekly.*")==1 {
display "this is simulated data"
do "${dir_code}\SC_survival-simulated_dailyequivalent_alt.do", nostop
}
else {
display "this is daily data"
do "${dir_code}\SC_survival_alt.do", nostop
}
