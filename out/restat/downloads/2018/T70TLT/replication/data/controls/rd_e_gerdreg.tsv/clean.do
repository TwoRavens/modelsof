...
import delimited  rd_e_gerdreg.tsv,  varnames(1) clear
split sectperfunitgeotime, generate(_) parse(,)
rename _1 sect
rename _2 unit
rename _3 geotime
...
keep yr* code_ccaa
drop yr_1996 yr_1998 yr_2002
reshape long yr_ , j(year) i(code_ccaa)
rename yr_ RDspend
save RDspend.dta, replace
