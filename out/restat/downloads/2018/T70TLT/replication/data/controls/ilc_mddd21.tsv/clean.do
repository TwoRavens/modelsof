...
import delimited  ilc_mddd21.tsv,  varnames(1) clear
split unitgeotime, generate(_) parse(,)
rename _1 unit
rename _2 geotime
...
foreach var of numlist 2/16 {

destring v`var', i(u b : bu ub : u:) replace
local year=2017-`var'+2
...
rename yr_ materialdep
save materialdep.dta, replace
