...
import delimited  nama_10r_2hhsec.tsv,  varnames(1) clear
split unitdirectna_itemgeotime, generate(_) parse(,)
rename _1 unit
rename _2 direct
rename _3 item
rename _4 geotime
...
rename yr_ socialcont
save socialcont.dta, replace
