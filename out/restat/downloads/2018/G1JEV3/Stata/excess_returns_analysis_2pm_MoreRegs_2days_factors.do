...
tab _merge
drop _merge
replace ffs_factor1 = 0 if ffs_factor1==. 
replace ffs_factor2 = 0 if ffs_factor2==. 
tsset date_BS
save "$path1\data_temp_2pm.dta", replace
...
log using "$path0T\exc_returns_regs_2daysF.log", replace 
...
forv vv=2/3 { 
putexcel A1=("Dissent != 0") B1=("Dissent != Unanimity") C1=("Dissent2 != 0") D1=("Dissent2 != Unanimity2") using "${path0T`Vxn'}\\reg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") replace
putexcel A1=("Dissent != 0") B1=("Dissent != Unanimity") C1=("Dissent2 != 0") D1=("Dissent2 != Unanimity2") E1=("Pseudo R2") using "${path0T`Vxn'}\\qreg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") replace
forv XV=1/5  {
local es=min(`XV',2)
local XV2 = `XV'+1

reg `var' i.(window3) ffs_factor1 ffs_factor2 `XVd`XV'_vs`vv'' `xvars', `varR' // vce(bootstrap, reps(5000)) //hc2 hc3 robust
outreg2 using "${path0T`Vxn'}\\reg_exr_x_MoreR`vv'F.xls", `esave`es''
test 3.window3+4.window3=0 // Wald test for Dissent different than 0
putexcel A`XV2'=(r(p)) using "${path0T`Vxn'}\\reg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
test 3.window3+4.window3=1.window3+2.window3 // Wald test for Dissent different than Unanimity
putexcel B`XV2'=(r(p)) using "${path0T`Vxn'}\\reg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
test 4.window3=0 // Wald test for Dissent different than 0
putexcel C`XV2'=(r(p)) using "${path0T`Vxn'}\\reg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
test 4.window3=2.window3 // Wald test for Dissent different than Unanimity
putexcel D`XV2'=(r(p)) using "${path0T`Vxn'}\\reg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify

qreg `var' i.(window3) ffs_factor1 ffs_factor2 `XVd`XV'_vs`vv'' `xvars', `varR' // vce(robust)
outreg2 using "${path0T`Vxn'}\\qreg_exr_x_MoreR`vv'F.xls", `esave`es''
test 3.window3+4.window3=0 // Wald test for Dissent different than 0
putexcel A`XV2'=(r(p)) using "${path0T`Vxn'}\\qreg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
test 3.window3+4.window3=1.window3+2.window3 // Wald test for Dissent different than Unanimity
putexcel B`XV2'=(r(p)) using "${path0T`Vxn'}\\qreg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
test 4.window3=0 // Wald test for Dissent different than 0
putexcel C`XV2'=(r(p)) using "${path0T`Vxn'}\\qreg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
test 4.window3=2.window3 // Wald test for Dissent different than Unanimity
putexcel D`XV2'=(r(p)) using "${path0T`Vxn'}\\qreg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
local psr2=1-e(sum_adev)/e(sum_rdev)
putexcel E`XV2'=(`psr2') using "${path0T`Vxn'}\\qreg_exr_x_MoreR`vv'_FpF.xls", sheet("Sheet1") modify
}
}
}
log close
