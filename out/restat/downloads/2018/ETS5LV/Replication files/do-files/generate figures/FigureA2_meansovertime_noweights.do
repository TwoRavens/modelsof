...
collapse (mean)  nsuicidespc (sd) sd=nsuicidespc (count) n= nsuicidespc, by(year treatment)
...
graph export "$figures/FigureA2_meansovertime_noweights.pdf",  replace as(pdf)
