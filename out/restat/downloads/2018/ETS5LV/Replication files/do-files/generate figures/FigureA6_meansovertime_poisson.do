...
collapse (mean)  n_suicides_possionpc (sd) sd=n_suicides_possionpc (count) n= n_suicides_possionpc [aw=pop_sizebaseline], by(year treatment)

rename n_suicides_possionpc suicide
...
2 "One standard error intervall") pos(6) rows(2)) xlab(2000 2003 2005 2011 2014) ytitle("Suicide Rate (Poisson Extrapolation)")

graph export "$figures/FigureA6_meansovertime_poisson.pdf",  replace as(pdf)
