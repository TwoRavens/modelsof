...
gen post_rain=z_rain*post
	...
	** Partial out weighted fixed effects
	hdfe  wnsuicidespc wz_rain wpost wpost_rain wlag1_z_rain wlag2_z_rain wlag3_z_rain  , absorb( i.year#c.weight i.kecid2000#c.weight ) gen(h_)
...
***Panel A
	...
	xtreg nsuicidespc z_rain  i.year [aw=pop_sizebaseline] , fe cluster(kabuid)
...
********************************************************************************
	...
	hdfe wnsuicidespc wz_rain wpost wpost_rain, absorb(c.weight#i.year i.year#c.weight c.year#i.kabuid#c.weight ) gen(ht_)
...
esttab col1 col2 col3 col4 col5 col6 using "$tables/TableA22_rain_detrend.tex", replace cells(none) ///
