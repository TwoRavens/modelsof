...
********************************************************************************	
	...
	reg n_suicides_possionpc treat_pkhrct_post  n_suicides_possionpc_baseline  $year if year==2011  [aw=pop_sizebaseline], cluster(kecid)
 sigstar treat_pkhrct_post, prec(3)
    ...
    estadd loc thisstat14 = `e(N)': col1 
		sum n_suicides_possionpc if treat_pkhrct==0 & year==2011  [aw=pop_sizebaseline]
...
********************************************************************************
	...
	reg n_suicides_possionpc treat_pkhrct_post  if  year==2011  [aw=pop_sizebaseline], cluster(kecid)
    sigstar treat_pkhrct_post, prec(3)
...
xtreg n_suicides_possionpc treat_pkhrct_post  treat_pkhrct  i.year $year if year==2005 | year==2011  [aw=pop_sizebaseline], fe cluster(kecid)
 sigstar treat_pkhrct_post, prec(3)
...
********************************************************************************
	...
	xtreg n_suicides_possionpc treat_pkhrct_post treat_pkhrct i.year if year<=2011  [aw=pop_sizebaseline], fe cluster(kecid)
    sigstar treat_pkhrct_post, prec(3)
...
**************************************************************
	...
	reg n_suicides_possionpc treat_pkhrct_post  n_suicides_possionpc_baseline  $year if year==2011  , cluster(kecid)
	sigstar treat_pkhrct_post, prec(3)
    estadd loc thisstat3 = "`r(bstar)'": col5
    estadd loc thisstat4 = "`r(sestar)'": col5
    estadd loc thisstat14 = `e(N)': col5
	sum n_suicides_possionpc  if treat_pkhrct==0 & year==2011
...
********************************************************************************	
	...
	reg nsuicidespc2 treat_pkhrct_post nsuicidespc2_baseline  $year if year==2011  [aw=pop_sizebaseline], cluster(kecid)
	sigstar treat_pkhrct_post, prec(3)
    estadd loc thisstat3 = "`r(bstar)'": col6
    estadd loc thisstat4 = "`r(sestar)'": col6
    estadd loc thisstat14 = `e(N)': col6
		sum nsuicidespc2 if treat_pkhrct==0 & year==2011  [aw=pop_sizebaseline]
...
reg n_numberofsuicides treat_pkhrct_post  if year==2011  [aw=pop_sizebaseline], cluster(kecid)
 sigstar treat_pkhrct_post, prec(3)
...
********************************************************************************
	...
	xtreg nsuicidespc2 treat_pkhrct_post treat_pkhrct year2011 year2005 if year==2005 | year==2011  [aw=pop_sizebaseline], fe cluster(kecid)
    sigstar treat_pkhrct_post, prec(3)
...
********************************************************************************
	...
	xtreg nsuicidespc2 treat_pkhrct_post treat_pkhrct i.year if year<=2011  [aw=pop_sizebaseline], fe cluster(kecid)
    sigstar treat_pkhrct_post, prec(3)
...
reg suicide treat_pkhrct_post  if year==2011  [aw=pop_sizebaseline],  cluster(kecid)
 sigstar treat_pkhrct_post, prec(3)
...
********************************************************************************
	...
	xtreg suicide treat_pkhrct_post treat_pkhrct year2011 year2005 if year==2005 | year==2011  [aw=pop_sizebaseline], fe cluster(kecid)
    sigstar treat_pkhrct_post, prec(3)
...
********************************************************************************
	...
	xtreg suicide treat_pkhrct_post treat_pkhrct i.year if year<=2011  [aw=pop_sizebaseline], fe cluster(kecid)
    sigstar treat_pkhrct_post, prec(3)
...
esttab * using "$tables/TableA10_RCTaltoutcomes1.tex", replace cells(none) nomtitle booktabs nonotes  compress /// 
