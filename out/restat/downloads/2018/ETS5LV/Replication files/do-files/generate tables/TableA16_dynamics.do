...
********************************************************************************
	...
	xtreg nsuicidespc treat_pkhrct_post treat_pkhrct year2011 year2005 if year==2005 | year==2014 [aw=pop_sizebaseline], fe cluster(kecid)
    sigstar treat_pkhrct_post, prec(3)	
...
********************************************************************************
	...
	sum nsuicidespc if (treat0708>0) & year==2005  [aw=pop_sizebaseline]
	estadd loc thisstat9 = "`r(N)'": col2
	sum nsuicidespc if (any_treat==0)		& year==2005  [aw=pop_sizebaseline]
...
********************************************************************************
	...
	sum nsuicidespc if (treat1011>0) & year==2005  [aw=pop_sizebaseline]
...
********************************************************************************
	...
	sum nsuicidespc if (treat2012>0 | treat2013>0) & year==2005   [aw=pop_sizebaseline]
...
esttab * using "$tables/TableA16_dynamics.tex", replace cells(none) booktabs nonotes compress alignment(c) ///
