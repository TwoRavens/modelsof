...
clear 
*----------------------------------------------------------------
*1. Real GDP/capita and nominal GDP/capita from the ICP tables.
*----------------------------------------------------------------
...
*----------------------------------------------------------------
*2. Industry-level price and expenditure data
*----------------------------------------------------------------
...
* average coefficients for countries not available from ICIO
