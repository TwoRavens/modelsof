...
*This program generates panel A of Table 3 in the main paper
******************************************************************************
clear *
...
forvalues s=1(1)7152  {

clear


use Final_datasets/PUMA_`Y', clear
...
saveold Results/ACS_Bootstrap_PUMA_`Y'_`B'.dta, replace
