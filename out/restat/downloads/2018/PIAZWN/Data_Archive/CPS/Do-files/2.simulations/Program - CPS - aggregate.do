...
**produces the results in columns (3)-(6) of Table 4.
********************************************************************************
clear *
set mem 2000m
*******************************************************************************
...
saveold "Results/CPS_Bootstrap_`Y'_`Range'_`B'.dta", replace
...
foreach Range in 7 5 3 1  {

foreach Y in "employed" "l_wage" {

Simulation `Y' `Range' 5000
