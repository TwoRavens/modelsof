...
/* Import CEX mtbi files BLS.do
---------------------------------
This program is part of the Environmental Engel Curves project.

The point of this file is to import and clean the CEX microdata mtbi files from BLS.  The files are organized
...
collapse (sum) total* /*consumption*/, by(cuid quarter year interi)
...
/* Create the file of households that started the survey in Q1 */
	...
	collapse (sum) total* /*consumption*/, by(cuid)
	gen quarter=1
	gen year= `yyyy'
...
save "Compiled Data Files\BLS_compiledmtbi_all.dta", replace	
