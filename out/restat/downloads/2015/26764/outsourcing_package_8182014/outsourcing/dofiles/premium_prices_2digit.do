...
sort man7090 year;
merge man7090 year using ${d}man7090_sic2;
tab _merge;
...
save ${x}temp_premium_prices2dig.dta, replace;

***********************************************************************;
* Create two datasets, at occupation x year and industry x year level *;
***********************************************************************;
* occupation x year level dataset *;
***********************************;
use ${x}temp_premium_prices2dig.dta, clear;
...
save ${x}premium_prices2dig_occ8090.dta, replace;

*********************************;
* industry x year level dataset *;
*********************************;
use ${x}temp_premium_prices2dig.dta, clear;
...
save ${x}premium_prices2dig_man7090.dta, replace;

erase ${x}temp_premium_prices2dig.dta;
