...
global mylist " p_llowincemp p_lhigh  p_penmod79 p_expmod79 age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 p_use_ind"; 
reg leftmfg p_llowincemp p_lhigh  p_penmod79 p_expmod79 age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind  if manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, replace;
reg leftmfg p_llowincemp p_lhigh  p_penmod79 p_expmod79 age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind if $routinecat1 & manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;
reg leftmfg p_llowincemp p_lhigh  p_penmod79 p_expmod79 age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind if $routinecat2 & manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;

***;
  
reg lwagediff p_llowincemp p_lhigh  p_penmod79 p_expmod79 age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind  if manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;
reg lwagediff p_llowincemp p_lhigh  p_penmod79 p_expmod79 age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind if $routinecat1 & manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;
reg lwagediff p_llowincemp p_lhigh  p_penmod79 p_expmod79 age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind if $routinecat2 & manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;
...
reg leftmfg p_llowincemp_effective_occ p_lhigh_effective_occ  p_penmod_effective_occ p_expmod_effective_occ age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind  if manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;
reg leftmfg p_llowincemp_effective_occ p_lhigh_effective_occ  p_penmod_effective_occ p_expmod_effective_occ age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind if $routinecat1 & manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;
reg leftmfg p_llowincemp_effective_occ p_lhigh_effective_occ  p_penmod_effective_occ p_expmod_effective_occ age1 female1 nonwhite1 exper1 union1 p_lpiinv79 p_tfp579 p_lrpiship79 _Iyear* _Iman7090* _Istate* p_use_ind if $routinecat2 & manuf1==1,cluster(man7090_orig1);
outreg2 $mylist using $masterpath/outfiles/apptable9.txt, append;
