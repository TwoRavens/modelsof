*******************************************************************
* IPUMS Occupation Remapping 
*******************************************************************

* David Dorn, version August 9, 2008 (modified by MF)

* This file transforms original Census occupation codes to create
* a balanced panel of occupations for 1990-2005.
...
*******************************************************************
* Occupation recoding for 2000 and 2005
*******************************************************************

if year==2000| year==2005{
replace occ1990dd=22 if (occ==31 | occ==33 | occ==34 | occ==36 | occ==42 | occ==72) /* 22 - managers and administrators, nec. */
replace occ1990dd=235 if occ==196                                                /* 235 - technicians, nec. */
replace occ1990dd=275 if (occ==474 | occ==475 | occ==484)                        /* 275 - retail salespersons */
replace occ1990dd=387 if occ==254                                                /* 387 - teacher's aides */
replace occ1990dd=418 if occ==384                                                /* 384 - police and detectives, public service */
replace occ1990dd=426 if occ==391                                                /* 391 - guards and police, except public service */
replace occ1990dd=433 if occ==401                                                /* 401 - supervisors of food preparation and service */
replace occ1990dd=439 if occ==403                                                /* 439 - food preparation workers */
replace occ1990dd=444 if (occ==405 | occ==406 | occ==412 | occ==413 | occ==415)  /* 444 - misc. food preparation and service workers */
replace occ1990dd=447 if (occ==361 | occ==362 | occ==363 | occ==365)             /* 447 - health and nursing aides */
replace occ1990dd=459 if occ==430                                                /* 459 - recreation facility workers */
replace occ1990dd=472 if occ==434                                                /* 487 - animal caretakers, except farm */
replace occ1990dd=549 if occ==751                                                /* 549 - mechanics and repairers, nec */
replace occ1990dd=859 if occ==975                                                /* 859 - misc. material moving occs */
replace occ1990dd=653 if occ==652                                                /* 653 - sheet metal workers, tinsmiths, coppersmiths */
replace occ1990dd=684 if occ==822                                                /* 684 - other precision and craft workers */
replace occ1990dd=789 if occ==881                                                /* 881 - painting and decoration occs. */
replace occ1990dd=834 if occ==942                                                /* 942 - misc. transportaion occs. */
*** occupations with changed codes ***
replace occ1990dd=177 if occ1990==465                                            /* 177 - Welfare service workers */
replace occ1990dd=408 if occ1990==748                                            /* 408 - Laundry and dry cleaning workers */
replace occ1990dd=450 if occ1990==485                                            /* 450 - Supervisors of landscaping, lawn service and groundskeeping */
...
replace occ1990dd=472 if occ1990==487                                            /* 472 - Animal caretakers, except farm */
*** adjustments for ACS compatibility ***
replace occ1990dd=47 if occ==150                                                 /* 47 - petroleum, mining, and geological engineers */
replace occ1990dd=235 if occ==196                                                /* 235 - technicians, nec */
replace occ1990dd=389 if occ==583                                                /* 389 - administrative support, nec */
replace occ1990dd=599 if occ==675                                                /* 599 - misc. construction and related occs */
replace occ1990dd=743 if occ==836                                                /* 743 - textile cutting and dyeing machine operators */
replace occ1990dd=4 if occ1990dd==3                                              /* 4 - chief executives, public administrators, and legislators */
replace occ1990dd=22 if occ1990dd==16                                            /* 22 - managers and administrators, nec */
replace occ1990dd=178 if occ1990dd==179                                          /* 178 - lawyers and judges */
replace occ1990dd=653 if occ1990dd==646                                          /* 653 - other precision and craft workers */
*** fix code 873>874 change in newer IPUMS extracts ***
replace occ1990dd=873 if occ1990==874
}
