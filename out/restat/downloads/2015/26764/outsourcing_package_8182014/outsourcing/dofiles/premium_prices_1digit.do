...
sort man7090 year;
merge man7090 year using ${d}man7090_sic1;
tab _merge;
...
save ${x}temp_premium_prices1dig.dta, replace;
...
***********************************;
use ${x}temp_premium_prices1dig.dta, clear;
...
save ${x}premium_prices1dig_occ8090_mfg.dta, replace;
...
save ${x}premium_prices1dig_man7090.dta, replace;

erase ${x}temp_premium_prices1dig.dta;
