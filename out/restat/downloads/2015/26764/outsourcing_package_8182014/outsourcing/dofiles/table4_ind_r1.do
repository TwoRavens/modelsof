...
log using ${z}table4_ind,text replace;
*All;
...
outreg2 p_llowincemp p_lhigh p_lpiinv100 p_tfp579 p_expmod79 p_penmod79 /* p_lrpiship */ p_caplabor79  p_use using ${z}table4_ind_r1, nolabel ctitle(All) title(Table 2: Wage Effects of Offshoring, Industry-Specific Exposure, State FE, by Routine Tertile, 1983-2002, Comp Use) replace;
...
outreg2 p_llowincemp p_lhigh p_lpiinv100 p_tfp579 p_expmod79 p_penmod79 /* p_lrpiship */ p_caplabor79  p_use using ${z}table4_ind_r1, nolabel ctitle(Most Routine) append;
...
outreg2 p_llowincemp p_lhigh p_lpiinv100 p_tfp579 p_expmod79 p_penmod79 /* p_lrpiship */ p_caplabor79  p_use using ${z}table4_ind_r1, nolabel ctitle(Intermediate Routine) append;
...
outreg2 p_llowincemp p_lhigh p_lpiinv100 p_tfp579 p_expmod79 p_penmod79 /* p_lrpiship */ p_caplabor79  p_use using ${z}table4_ind_r1, nolabel ctitle(Least Routine) append;
log close;
