...
use $masterpath/datafiles/premium_man7090;
...
save $masterpath/datafiles/merge_man7090, replace;

*******************************************************************;
* Merge the individual workers with the CEW/Trade/Outsourcing data ;
*******************************************************************;

use $masterpath/datafiles/micro_man7090;
...
save $masterpath/datafiles/merge_micro_man7090, replace;

  
use $masterpath/datafiles/merge_micro_man7090, replace;
do $masterpath/dofiles/keepvars;
save $masterpath/datafiles/merge_micro_man7090_small, replace;
