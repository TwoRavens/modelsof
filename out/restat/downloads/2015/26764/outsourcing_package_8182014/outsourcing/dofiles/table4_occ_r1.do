...
log using ${z}table4_occ_r1,text replace;
*All;
reg lwage p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use age female union exper nonwhite _Iyear* _Ieduc* _Iind7090* _Iocc8090* _Istate* [weight=ihwt], robust cluster(occyear);
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table4_occ_r1, nolabel ctitle(All) title(Table 2: Wage Effects of Offshoring Measured by Occupation-Specific Exposure, Using Ind & 2-Occ FE, State FE, by Routine Tertile, Comp Use) replace;

*Most Routine (routine>.66);
reg lwage p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use age female union exper nonwhite _Iyear* _Ieduc* _Iind7090* _Iocc8090* _Istate* if routine>.66 [weight=ihwt], robust cluster(occyear);
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table4_occ_r1, nolabel ctitle(Most Routine) append;

*Moderate Routine (routine>.33 & routine<=.66); 
reg lwage p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use age female union exper nonwhite _Iyear* _Ieduc* _Iind7090* _Iocc8090* _Istate* if routine>.33 & routine<=.66 [weight=ihwt], robust cluster(occyear);
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table4_occ_r1, nolabel ctitle(Intermediate Routine) append;

*Least Routine (routine<=.33);
reg lwage p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use age female union exper nonwhite _Iyear* _Ieduc* _Iind7090* _Iocc8090* _Istate* if routine<=.33 [weight=ihwt], robust cluster(occyear);
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table4_occ_r1, nolabel ctitle(Least Routine) append;
