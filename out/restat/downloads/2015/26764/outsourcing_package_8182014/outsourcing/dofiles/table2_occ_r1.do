...
log using ${z}table2_occ_r1,text replace;
*All;
...
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table2_occ_r1, nolabel ctitle(All) title(Table 2: Wage Effects of Offshoring Measured by Occupation-Specific Exposure, Using Ind & 2-Occ FE, State FE, by Routine Tertile, Comp Use) replace;
...
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table2_occ_r1, nolabel ctitle(Most Routine) append;
...
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table2_occ_r1, nolabel ctitle(Intermediate Routine) append;
...
outreg2 p_llowincemp_effective_occ p_lhigh_effective_occ p_lpiinv100 p_caplabor79 p_tfp579 p_expmod_effective_occ p_penmod_effective_occ  p_use using ${z}table2_occ_r1, nolabel ctitle(Least Routine) append;
