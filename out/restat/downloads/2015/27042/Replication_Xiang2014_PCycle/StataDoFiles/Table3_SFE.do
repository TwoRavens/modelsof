...
set logtype text; 
log using "C:\Main\p-cycle\Writing\ReStatRevision\CountryFE\SFE", replace; 


*****************************************************************
***************Individual S. Countries and country FE************
*****************************************************************; 
...
*****aggregate across N. countries;
use c1; keep if N==1; 
gen fobNng=fob*N*ng; gen fobNog=fob*N*og; gen cifNng=cif*N*ng; gen cifNog=cif*N*og; sort year msic87;
collapse (sum) fobNng fobNog cifNng cifNog, by(year msic87); sort year msic87; save c10, replace; 

*****merge aggregate N. data with individual country S. data; 
use c1; drop if N==1; 
gen fobSng=fob*S*ng; gen fobSog=fob*S*og; gen cifSng=cif*S*ng; gen cifSog=cif*S*og; sort wtdbcode year msic87;
collapse (sum) fobSng fobSog cifSng cifSog, by(wtdbcode year msic87); sort year msic87; 
...
save C:\Main\p-cycle\Writing\ReStatRevision\CountryFE\SFE, replace; d; log off; 
