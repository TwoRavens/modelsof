...
* This version uses binary weights
...
*
/* BINARY WEIGHTS */
replace share_prod = 1 if share_prod>0 
drop production* uv*
sort country_code area_code area_name admin_level hs 
save temp, replace
*
...
*
collapse (sum) shock_fao_wbin=shock_fao, by(gid year region_fao)
*
label var shock_fao "World demand weighted by hs spec."
*
drop region_fao
...
*
cd "$Output_data"
save FAO_PRIO_GRID_wbin, replace
*
cd "$fao"
