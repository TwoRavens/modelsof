...
dmerge year quarter origin dest opcarrier using Fare_1_0_0_0_1_ptile, nokeep;
tab _m;
drop _m;
...
gen log_Fare_10 = log(Fare10);
gen log_Fare_25 = log(Fare25);
gen log_Fare_50 = log(Fare50);
gen log_Fare_75 = log(Fare75);
gen log_Fare_90 = log(Fare90);
...
qui areg schelapsedtime InterCPS empl_perc log_incpc log_pop
                ...
                oc* cym* arcft*, r cluster(segment) absorb(segment);
estimates store m1, title(Model 1);

qui areg schelapsedtime InterCPS empl_perc log_incpc log_pop
                HHI inter_HHI  log_Fare_50
                nr_deps_hour_orig nr_deps_hour_dest nr_arrs_hour_dest nr_arrs_hour_orig
                HHI_dep_arpt HHI_arr_arpt nr_flt_arr_Origin_130_230 nr_flt_arr_Origin_230_330 nr_flt_dep_Dest_30_130 
                nr_flt_dep_Dest_130_230 nr_flt_arr_Origin_30_130 nr_flt_dep_Dest_230_330 nr_deps_day_orig nr_deps_day_dest 
                nr_arrs_day_dest nr_arrs_day_orig
...
qui areg schelapsedtime InterCPS empl_perc log_incpc log_pop
                HHI inter_HHI  log_Fare_50 log_Fare_75
                nr_deps_hour_orig nr_deps_hour_dest nr_arrs_hour_dest nr_arrs_hour_orig
                HHI_dep_arpt HHI_arr_arpt nr_flt_arr_Origin_130_230 nr_flt_arr_Origin_230_330 nr_flt_dep_Dest_30_130 
                nr_flt_dep_Dest_130_230 nr_flt_arr_Origin_30_130 nr_flt_dep_Dest_230_330 nr_deps_day_orig nr_deps_day_dest 
                nr_arrs_day_dest nr_arrs_day_orig
...
qui areg schelapsedtime InterCPS empl_perc log_incpc log_pop
                HHI inter_HHI  log_Fare_50 log_Fare_75 log_Fare_25
                nr_deps_hour_orig nr_deps_hour_dest nr_arrs_hour_dest nr_arrs_hour_orig
                HHI_dep_arpt HHI_arr_arpt nr_flt_arr_Origin_130_230 nr_flt_arr_Origin_230_330 nr_flt_dep_Dest_30_130 
                nr_flt_dep_Dest_130_230 nr_flt_arr_Origin_30_130 nr_flt_dep_Dest_230_330 nr_deps_day_orig nr_deps_day_dest 
                nr_arrs_day_dest nr_arrs_day_orig
...
qui areg schelapsedtime InterCPS empl_perc log_incpc log_pop
                HHI inter_HHI  log_Fare log_Fare_50 log_Fare_75 log_Fare_90 log_Fare_25 log_Fare_10
		nr_deps_hour_orig nr_deps_hour_dest nr_arrs_hour_dest nr_arrs_hour_orig
                HHI_dep_arpt HHI_arr_arpt nr_flt_arr_Origin_130_230 nr_flt_arr_Origin_230_330 nr_flt_dep_Dest_30_130 
                nr_flt_dep_Dest_130_230 nr_flt_arr_Origin_30_130 nr_flt_dep_Dest_230_330 nr_deps_day_orig nr_deps_day_dest 
                nr_arrs_day_dest nr_arrs_day_orig
...
qui areg schelapsedtime InterCPS empl_perc log_incpc log_pop
                HHI inter_HHI log_Fare_50 log_Fare_75 log_Fare_90 log_Fare_25 log_Fare_10
                nr_deps_hour_orig nr_deps_hour_dest nr_arrs_hour_dest nr_arrs_hour_orig
                HHI_dep_arpt HHI_arr_arpt nr_flt_arr_Origin_130_230 nr_flt_arr_Origin_230_330 nr_flt_dep_Dest_30_130 
                nr_flt_dep_Dest_130_230 nr_flt_arr_Origin_30_130 nr_flt_dep_Dest_230_330 nr_deps_day_orig nr_deps_day_dest 
                nr_arrs_day_dest nr_arrs_day_orig
...
estout m1 m2 m3 m4 m5  m6 m7 m8 m9 m10
        using "Reg11/Ptile/schelapsedtime_segment_large100_fnl_segment_nrf.xls",
        ...
        keep (InterCPSadj log_Fare log_Fare_50 log_Fare_75 log_Fare_90 log_Fare_10 log_Fare_25
        ...
        order (InterCPSadj HHI inter_HHI
               nr_deps_hour_orig nr_deps_hour_dest nr_arrs_hour_dest nr_arrs_hour_orig
               log_Fare log_Fare_50 log_Fare_25 log_Fare_75 log_Fare_10 log_Fare_90);
