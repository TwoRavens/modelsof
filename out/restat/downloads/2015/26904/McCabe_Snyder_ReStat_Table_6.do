log using McCabe_Snyder_ReStat_Table_6, replace

**********************************************************************
*
* Program McCabe_Snyder_ReStat_Table_6.DO
* 
* Runs regressions for regional results for single-authored citing
* papers in Table 6. 
*
...
save region_temp_1, replace;

* USA;
replace jss2 = jss2_usa;
replace es2 = es2_usa;
...
* Run regression;
xtpqml cusa_sing_auth ip* ia1j* ia2j* 
...
* Run regression;
xtpqml ceng_sing_auth ip* ia1j* ia2j*
           op95 op00 os95 os00 oh95 oh00 om95 om00 
           jp95 jp00  
           ep95 ep00 ecf95 ecf00
           jsfs jsfp jsfd esf, 
...
* Run regression;
xtpqml ceur_sing_auth ip* ia1j* ia2j*
           op95 op00 os95 os00 oh95 oh00 om95 om00 
           jp95 jp00  
           ep95 ep00 ecf95 ecf00
           jsfs jsfp jsfd esf, 
...
* Run regression;
xtpqml coth_sing_auth ip* ia1j*  ia2j*
           op95 op00 os95 os00 oh95 oh00 om95 om00 
           jp95 jp00  
           ep95 ep00 ecf95 ecf00
           jsfs jsfp jsfd esf, 
...
erase region_temp.dta;
erase region_temp_1.dta;
