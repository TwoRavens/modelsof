...
clear 
set more off
use Databases\2001-2005PackLev_NonLinearRegressions
keep ProdChainID
...
drop WeeksAvail MinConcWeeks ConcWeeks HMed* PercDiscount units Ltotsales pperblade iri_short 
...
log using Log_Files_and_Graphs\Blades_Alpha_3, replace
