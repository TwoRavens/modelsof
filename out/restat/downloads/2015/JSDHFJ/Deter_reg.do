...
merge 1:m ProdChainID using Data\2001-2005PackLev_NonLinear-Regressions
drop _merge

compress
drop sizeratio ppoz*l ppoz*f
capture drop order maxorder
...
reg totsales I_S S_QS I_L L_QS if ProdChainID==2001710132, robust noconstant
display 1+_b[L_QS]/_b[I_L]
nlcom (alpha:1+_b[L_QS]/_b[I_L]), post
display _b[alpha]
display _se[alpha]

gen est_alpha=_b[alpha] if ProdChainID==2001710132
gen est_SE_alpha=_se[alpha] if ProdChainID==2001710132

compress

drop WeeksAvail MinConcWeeks ConcWeeks HMed* PercDiscount units Ltotsales pperoz iri_short SmallerMultipQSurc 


**************************************************************************************************************
save Data\2001-2005PackLev_NonLinear-Regressions-Compressed, replace
**************************************************************************************************************
...
**************************************   3 QS   **************************************************************
use Data\2001-2005PackLev_NonLinear-Regressions-Compressed, clear
**************************************************************************************************************
...
**************************************************************************************************************
save Data\2001-2005PackLev_NonLinear-Regressions-Compressed-2-3, replace
**************************************************************************************************************
...
********************************************   3 QSs	 *********************************************************************
use Data\2001-2005PackLev_NonLinear-Regressions-Compressed-2-3, clear
******************************************************************************************************************************
...
merge 1:m ProdChainID using Data\2001-2005PackLev_NonLinear-Regressions-Compressed-2-3
...
log using Log_Files_and_Graphs\Deter_Alpha_3, replace

sum est_alpha if ProdChainID_Seq==1, d
histogram est_alpha if ProdChainID_Seq==1, bin(50) kdensity
graph save Graph Log_Files_and_Graphs\est_alpha_3, replace
...
******************************************************************************************************************************
save Data\2001-2005PackLev_NonLinear-Regressions-estimated_alpha-3, replace
