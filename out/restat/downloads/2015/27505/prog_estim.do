...
// benchmark results - to get results for Figures 1a, 1b, 2 and 3a
est_boot, nb(500) dz(183) dy(366) mgeo(regionU) mnp(mgeo) mp(occ_* y_*) name(bench)

// some robustness checks

// to get results for Figure 3b, just add MXh* in the list of regressors in step2 on line 205 and then run the following:
est_boot, nb(500) dz(183) dy(366) mgeo(regionU) mnp(mgeo) mp(occ_* y_*) name(MXh)

// to get results for Figures 3d, write local thresh = .01 in step 2 on line 221 (instead of .001) and then run the following:
est_boot, nb(500) dz(183) dy(366) mgeo(regionU) mnp(mgeo) mp(occ_* y_*) name(a10)

// to get results for Figures 3e, write local thresh = .025 in step 2 on line 221 (instead of .001) and then run the following:
est_boot, nb(500) dz(183) dy(366) mgeo(regionU) mnp(mgeo) mp(occ_* y_*) name(a25)

// to get results for Figure 3g
est_boot, nb(500) dz(183) dy(366) mgeo(regionU) mnp(occup) mp(reg_* y_*) name(occ)

// to get results for Figure 3h
est_boot, nb(500) dz(273) dy(457) mgeo(regionU) mnp(mgeo) mp(occ_* y_*) name(zy915)
