...
local outfilename = "MakeTableMisc"
...
local params1 =" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,0,0" /*  BASIC SPECIFICATION */

/* Alternate discount rate */
local params2 =" 1,15,1999,2008.167,1950,2008,1, 9,1000000003025024100110, 20,0,0" /* r=3% */
local params3 =" 1,15,1999,2008.167,1950,2008,1, 9,1000000010025024100110, 20,0,0" /* r=10% */
local params4 =" 1,15,1999,2008.167,1950,2008,1, 9,1000000015025024100110, 20,0,0" /* r=15% */
/* Alternate time periods */
local params5 =" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100110, 20,0,0" /* 2004-Mar 2008 */
local params6 =" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100110, 20,0,0" /* 1999-Dec 2008 */
/* Alternate discount rate and time periods */
local params7 =" 1,15,2004,2008.167,1950,2008,1, 9,1000000010025024100110, 20,0,0" /* 2004-Mar 2008, r=10% */
local params8 =" 1,15,1999,2008.999,1950,2008,1, 9,1000000010025024100110, 20,0,0" /* 1999-Dec 2008, r=10% */

/* Intensive margin */
local params9 =" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100112, 20, 0  ,0" /* Intensive margin - const elast=0.2, add to p */
local params10=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100113, 20, 0  ,0" /* Intensive margin - linear, elast=0.2, add to p */
local params11=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100116, 20, 0  ,0" /* Intensive margin - const elast=0.5, add to p */
local params12=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100117, 20, 0  ,0" /* Intensive margin - linear, elast=0.5, add to p */
local params13=" 1,15,1999,2008.167,1950,2008,1, 9,100000000602502410011C, 20, 0  ,0" /* Intensive margin - const elast=0.9, add to p */
local params14=" 1,15,1999,2008.167,1950,2008,1, 9,100000000602502410011D, 20, 0  ,0" /* Intensive margin - linear, elast=0.9, add to p */
/* Intensive margin - alternate time periods */
local params15=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100112, 20, 0  ,0" /* Intensive margin - const elast=0.2, add to p */
local params16=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100113, 20, 0  ,0" /* Intensive margin - linear, elast=0.2, add to p */
local params17=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100116, 20, 0  ,0" /* Intensive margin - const elast=0.5, add to p */
local params18=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100117, 20, 0  ,0" /* Intensive margin - linear, elast=0.5, add to p */
local params19=" 1,15,2004,2008.167,1950,2008,1, 9,100000000602502410011C, 20, 0  ,0" /* Intensive margin - const elast=0.9, add to p */
local params20=" 1,15,2004,2008.167,1950,2008,1, 9,100000000602502410011D, 20, 0  ,0" /* Intensive margin - linear, elast=0.9, add to p */
local params21=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100112, 20, 0  ,0" /* Intensive margin - const elast=0.2, add to p */
local params22=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100113, 20, 0  ,0" /* Intensive margin - linear, elast=0.2, add to p */
local params23=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100116, 20, 0  ,0" /* Intensive margin - const elast=0.5, add to p */
local params24=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100117, 20, 0  ,0" /* Intensive margin - linear, elast=0.5, add to p */
local params25=" 1,15,1999,2008.999,1950,2008,1, 9,100000000602502410011C, 20, 0  ,0" /* Intensive margin - const elast=0.9, add to p */
local params26=" 1,15,1999,2008.999,1950,2008,1, 9,100000000602502410011D, 20, 0  ,0" /* Intensive margin - linear, elast=0.9, add to p */
/* Characteristics */
local params27=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,16.1,0" /* Sample with characteristics (Wards) */
local params28=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,11.1,0" /* Control for HP (Wards) */
local params29=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,11.2,0" /* Control for HP, weight (Wards) */
local params30=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,11.3,0" /* Control for HP, weight, wheelbase (Wards) */
local params31=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,11.4,0" /* Control for all characteristics (Wards) */
/* Preferences */
local params32=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,8,0" /* Exclude hybrids */
local params33=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,9,0" /* Exclude green cars */
local params34=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,6,0" /* Drop SUVs */
local params35=" 1,15,1999,2008.167,1950,2008,7, 9,1000000006025024100110, 20,0,0" /* Drop cars */
local params36=" 1,15,1999,2008.167,1950,2008,1, 8,1000000006025024100110, 20,0,0" /* Drop minivans */
/* JDPA Prices */
local params37=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,12,0" /* JDP/Manheim sample, Manheim prices */
local params38=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,13,0" /* JDP/Manheim sample, JDP prices */
local params39=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,14,0" /* JDP sample, JDP prices */
local params40=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100110, 20,12,0" /* JDP/Manheim sample, Manheim prices - late period */
local params41=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100110, 20,12,0" /* JDP/Manheim sample, Manheim prices - full period */
local params42=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100110, 20,13,0" /* JDP/Manheim sample, JDP prices - late period */
local params43=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100110, 20,13,0" /* JDP/Manheim sample, JDP prices - full period */
/* Fixed effects */
local params44=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 24,51,0" /* j*MY FE, time and age dummies */
local params45=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 24,52,0" /* j*MY FE, time, ageXMPG dummies */

/* TABLE 6 */
/* Alternative Gas Prices */
local params46=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100000, 20, 0,0" /* Martingale */
local params47=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100200, 20, 0,0"  /* Martingale, unadjusted */
local params48=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100300, 20, 0,0"  /* MSC data */
local params49=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,5.11,0" /* 1 month lag avg */
local params50=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,5.21,0" /* 2 month lag avg */
local params51=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,5.31,0" /* 3 month lag avg */
local params52=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,5.41,0" /* 4 month lag avg */

/* Equal weight */
local params53=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,61,0" /* Equal weights */
local params54=" 1, 3,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,61,0" /* Age 1-3, equal weights */
local params55=" 4, 6,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,61,0" /* Age 4-6, equal weights */
local params56=" 7,10,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,61,0" /* Age 7-10, equal weights */
local params57="11,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,61,0" /* Age 11-15, equal weights */
local params58=" 1, 3,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20, 0,0" /* Age 1-3 */
local params59=" 4, 6,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20, 0,0" /* Age 4-6 */
local params60=" 7,10,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20, 0,0" /* Age 7-10 */
local params61="11,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20, 0,0" /* Age 11-15 */

/* Alternate auxiliary estimation */
local params62=" 1,15,1999,2008.167,1950,2008,1, 9,1000200006025024100110, 20, 0,0" /* Alt VMT estimation */
local params63=" 1,15,1999,2008.167,1950,2008,1, 9,1000300006025024100110, 20, 0,0" /* Alt SurvProb estimation */

/* Is JDP/Manheim difference only due to weights? */
local params64=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,13.1,0" /* JDP/Manheim sample, JDP prices, Manheim weights */
local params65=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,13.2,0" /* JDP/Manheim sample, Manheim prices, JDP weights */
local params66=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100110, 20,13.1,0" /* JDP/Manheim sample, JDP prices, Manheim weights - late period */
local params67=" 1,15,2004,2008.167,1950,2008,1, 9,1000000006025024100110, 20,13.2,0" /* JDP/Manheim sample, Manheim prices, JDP weights - late period */
local params68=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100110, 20,13.1,0" /* JDP/Manheim sample, JDP prices, Manheim weights - full period */
local params69=" 1,15,1999,2008.999,1950,2008,1, 9,1000000006025024100110, 20,13.2,0" /* JDP/Manheim sample, Manheim prices, JDP weights - full period */

/* Control for sets of dummies */
local params70=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,2,0" /*  Control for MY dummies */
local params71=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 21,0,0" /* 2 MPG bins, separate age bins */
local params72=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 21,52,0" /*  add MPG X age X time controls */
local params73=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,63,0" /*  Control for Nest X time */
*local paramsXX=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 20,64,0" /* INFEASIBLE: Control for Nameplate X time */

/* Less aggregated - MPG */
local params74=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,20,41,0" /* Not collapsed */
local params75=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,500,0,0" /* 50 MPG bins, combined ages */
local params76=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,200,0,0" /* 20 MPG bins, combined ages */
local params77=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,100,0,0" /* 10 MPG bins, combined ages */
local params78=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,50,0,0" /* 5 MPG bins, combined ages */

/* Less aggregated - age */
local params79=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 21,0,0" /*  2 MPG bins, separate age bins */
local params80=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 22,0,0" /*  2 MPG bins, 2 ages / bins */
local params81=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 24,0,0" /*  2 MPG bins, 4 ages / bins */
local params82=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 28,0,0" /*  2 MPG bins, 8 ages / bins */

/* Less aggregated - age and MPG */

local params83=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 51,0,0" /*  5 MPG bins, separate age bins */
local params84=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 52,0,0" /*  5 MPG bins, 2 ages / bins */
local params85=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 54,0,0" /*  5 MPG bins, 4 ages / bins */
local params86=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110, 58,0,0" /*  5 MPG bins, 8 ages / bins */

local params87=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,102,0,0" /* 10 MPG bins, 2 ages / bins */
local params88=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,104,0,0" /* 10 MPG bins, 4 ages / bins */
local params89=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,108,0,0" /* 10 MPG bins, 8 ages / bins */

/* More aggregated - time */
local params90=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,2020,0,0" /* Group by 2 months */
local params91=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,3020,0,0" /* Group by 3 months */
local params92=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,4020,0,0" /* Group by 4 months */
local params93=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,6020,0,0" /* Group by 6 months */
local params94=" 1,15,1999,2008.167,1950,2008,1, 9,1000000006025024100110,12020,0,0" /* Group by 12 months */
