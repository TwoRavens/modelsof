...
capture log close
log using ETR_Florists.smcl,replace;
...
/* read in data --> first save filename.xls as filename.txt */
	insheet using X:\Indicators\ETR\Results\raw_data\ETR_FLORISTS_2007.txt, delimiter(";") case;};
	compress;
...
/* 2. merge with market demographics and put zeros in zips with NO observation of firms */
	...
	saveold MMS_Florists.dta, replace;				/* dataset to be used for Gauss analysis */
	outsheet using MMS_Florists.xls, replace;	
