...
log using table3-2lim.log, replace;
...
intreg rat1 rat2 eage eagesq eagecu  
       cr2 altplan, robust cluster (schl_id);
intreg rat1 rat2 eage eagesq eagecu  
...
intreg rat1 rat2 eage eagesq eagecu   
      cravg2 altplan, robust cluster (schl_id);
intreg rat1 rat2 eage eagesq eagecu   
...
intreg rat1 rat2 eage eagesq eagecu  
       cr altplan if variable_cru==0, robust cluster (schl_id);
intreg rat1 rat2 eage eagesq eagecu  
