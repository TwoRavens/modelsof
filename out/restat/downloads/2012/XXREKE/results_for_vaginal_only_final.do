...
* this program generates the results for vaginal births for tables 3 and 5;
...
* there is a virtually identical program for c-section births.  the only;
* difference is a line midway through that selects the sample;

set mem 1000m;
set matsize 800;

log using results_in_paper_final_vaginal.log, replace;
use stata_all_2;
...
keep readmission28i hospidm bw1-bw3 gest1 gest2 fedlaw statelaw meduc
...
********************************************************************;
********************************************************************;
*run the propensity score but only include vaginal deliveries;
********************************************************************;
********************************************************************;
...
* these results are in row 3 of table 3;
********************************************************************;
********************************************************************;
