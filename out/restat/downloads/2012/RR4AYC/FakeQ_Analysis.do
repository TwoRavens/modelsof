// This program runs the Fake Quarter Analysis.
// Input data: FakeQ.dta
// Log file : logs\FakeQ_Analysis.txt
...
foreach type in a1 a2 b {
	...
	sort county section_id q qq
	merge county section_id q qq using "`data'"
...
capture log close
log using logs\FakeQ_Analysis.txt, text replace
