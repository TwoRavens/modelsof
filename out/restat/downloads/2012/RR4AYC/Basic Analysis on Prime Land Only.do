// Runs the basic analysis only on prime farm lands.
// Input data: BaseP.dta
// Subsidiary code: Basic_Analysis_Init_Search.do
// Output log file: Basic_Analysis_Prime.txt
// August 10 2010.
...
foreach type in a1 a2 b {
	...
	merge county section_id q qq using Data\BaseP.dta
...
capture log close
log using logs\Basic_Analysis_Prime.txt, text replace
