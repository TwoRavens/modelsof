...
local outname = "setupd2";
capture log close;
log using `outname'.log, replace;
use "procecls2", clear;
count;
use "procecls2" if rptkinder ~= 1, clear;
count;
...
drop t1 t2;
gen str4 t1 = substr(t4_id,1,4);
gen str2 t2 = substr(t4_id,6,2);
gen tch4id = real(t1)*100 + real(t2);
drop t1 t2;
gen str4 t1 = substr(t5_id,1,4);
gen str2 t2 = substr(t5_id,6,2);
gen tch5id = real(t1)*100 + real(t2);
drop t1 t2;
...
drop t1 t2;
***percent prek or HS - 1st grade***;
egen t1 = sum(prekhs), by(tch4id);
egen t2 = count(prekhs), by(tch4id);
gen prekhs4bar = (t1-prekhs)/(t2-1);
label var prekhs4bar "percent of other kids in 1st grade class in prek or HS";
drop t1 t2;
***percent prek or HS - 3rd grade***;
egen t1 = sum(prekhs), by(tch5id);
egen t2 = count(prekhs), by(tch5id);
gen prekhs5bar = (t1-prekhs)/(t2-1);
label var prekhs5bar "percent of other kids in 3rd grade class in prek or HS";
drop t1 t2;
...
summ magefb classsize class4size class5size tyrsch tyrsch4 tyrsch5 tyrskin tyrsfst4 totyrstchkp totyrstchkp4 chbookp1, detail; *match since non-normal*;
tab1 totyrstchkp tyrskin tyrsch magefb classsize chbookp1;
recode b1hghstd (3 4 5 = 3);
recode b4hghstd (1 2 = 1) (3 = 2) (4 5 = 3);
recode b5hghstd (3 4 = 3);
qui tab tcert, gen(tcdum);
qui tab tcert4, gen(tc4dum);
qui tab tcert5, gen(tc5dum);
ice momftp1 momptp1 dadftp1 dadptp1 magefb grndpclose cencity suburb male white black hisp momhsdok momhsgradk dadhsdok 
	...
	agec2 aget1 lovteach tmale twhite b1hghstd tba tgs tma tyrsch tyrskin totyrstchkp tcert tcdum* classsize 
	aget4 lovteach4 twhite4 b4hghstd tba4 tgs4 tma4 tyrsch4 tyrsfst4 totyrstchkp4 tcert4 tc4dum* class4size 
	lovteach5 twhite5 b5hghstd tba5 tgs5 tma5 tyrsch5 tcert5 tc5dum* class5size using setupd2, 
	...
	passive(tba:b1hghstd==1 \ tgs:b1hghstd==2 \ tma:b1hghstd==3 \ tba4:b4hghstd==1 \ tgs4:b4hghstd==2 \ tma4:b4hghstd==3 \ 
	tba5:b5hghstd==1 \ tgs5:b5hghstd==2 \ tma5:b5hghstd==3 \ tcdum1:tcert==1 \ tcdum2:tcert==2 \ tcdum3:tcert==3 \ 
	tcdum4:tcert==4 \ tcdum5:tcert==5 \ tc4dum1:tcert4==1 \ tc4dum2:tcert4==2 \ tc4dum3:tcert4==3 \ tc4dum4:tcert4==4 \ 
	tc4dum5:tcert4==5 \ tc5dum1:tcert5==1 \ tc5dum2:tcert5==2 \ tc5dum3:tcert5==3 \ tc5dum4:tcert5==4 \ tc5dum5:tcert5==5) 
	substitute(b1hghstd: tba tgs tma, b4hghstd: tba4 tgs4 tma4, b5hghstd: tba5 tgs5 tma5, tcert: tcdum1 tcdum2 tcdum3 tcdum4 tcdum5, 
	tcert4: tc4dum1 tc4dum2 tc4dum3 tc4dum4 tc4dum5, tcert5: tc5dum1 tc5dum2 tc5dum3 tc5dum4 tc5dum5) 
	match(magefb classsize class4size class5size tyrsch tyrsch4 tyrsch5 tyrskin tyrsfst4 totyrstchkp totyrstchkp4 chbookp1) 
	cmd(b1hghstd b4hghstd b5hghstd grndpclose: ologit);
...
***create average cov for class (using imputed values) - 1st grade***;
for var momftp1 momptp1 dadftp1 dadptp1 magefb grndpclose cencity suburb male white black hisp momhsdok momhsgradk 
	dadhsdok dadhsgradk numsibp1 income immig fatpresp1 earlyemp lowbwt enghome wic fstampp1 readp1 
	chbookp1 chaudp1 agec4 \ new n1-n29: egen Y = sum(X), by(tch4id);
for var momftp1 momptp1 dadftp1 dadptp1 magefb grndpclose cencity suburb male white black hisp momhsdok momhsgradk 
	dadhsdok dadhsgradk numsibp1 income immig fatpresp1 earlyemp lowbwt enghome wic fstampp1 readp1 
	chbookp1 chaudp1 agec4 \ var n1-n29: replace Y = Y-X;
for var momftp1 momptp1 dadftp1 dadptp1 magefb grndpclose cencity suburb male white black hisp momhsdok momhsgradk 
	dadhsdok dadhsgradk numsibp1 income immig fatpresp1 earlyemp lowbwt enghome wic fstampp1 readp1 
	chbookp1 chaudp1 agec4 \ new d1-d29: egen Y = count(X), by(tch4id);
for var n1-n29 \ var d1-d29 \ new x4bar1-x4bar29: gen Z = X/(Y-1);
drop n1-n29 d1-d29;

***create average cov for class (using imputed values) - 3rd grade***;
for var momftp1 momptp1 dadftp1 dadptp1 magefb grndpclose cencity suburb male white black hisp momhsdok momhsgradk 
	dadhsdok dadhsgradk numsibp1 income immig fatpresp1 earlyemp lowbwt enghome wic fstampp1 readp1 
	chbookp1 chaudp1 agec5 \ new n1-n29: egen Y = sum(X), by(tch5id);
for var momftp1 momptp1 dadftp1 dadptp1 magefb grndpclose cencity suburb male white black hisp momhsdok momhsgradk 
	dadhsdok dadhsgradk numsibp1 income immig fatpresp1 earlyemp lowbwt enghome wic fstampp1 readp1 
	chbookp1 chaudp1 agec5 \ var n1-n29: replace Y = Y-X;
for var momftp1 momptp1 dadftp1 dadptp1 magefb grndpclose cencity suburb male white black hisp momhsdok momhsgradk 
	dadhsdok dadhsgradk numsibp1 income immig fatpresp1 earlyemp lowbwt enghome wic fstampp1 readp1 
	chbookp1 chaudp1 agec5 \ new d1-d29: egen Y = count(X), by(tch5id);
for var n1-n29 \ var d1-d29 \ new x5bar1-x5bar29: gen Z = X/(Y-1);
drop n1-n29 d1-d29;
