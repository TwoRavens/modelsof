clear
set mem 300m
infile using "classmeasures2.dct"
#delimit ;
keep if  (r3sample == 1 | 
       r3sample == 0); 
   keep if (r4r2schg == 1 | 
...
compress;
sort childid;
save "classmeasures2.dta", replace;
use "classmeasures2.dta";
tabulate f1class;
tabulate f2class;
tabulate f2specs;
tabulate dobmm;
