...
log using "KVWZ_94(1)_table6_col1.txt",replace
...
global ixx="lage lage2 lneast lncent lwest lunion lmarry locc1 locc2 locc3 locc4 locc5 locc6 locc7 locc8 locc9 lsic2-lsic66 lstate2-lstate50"
...
global i2xx="l2wage l2age l2age2 l2neast l2ncent l2west l2union l2marry l2occ1 l2occ2 l2occ3 l2occ4 l2occ5 l2occ6 l2occ7 l2occ8 l2occ9 l2sic2-l2sic66 l2state2-l2state50"


/* LAG WAGE INSTRUMENTED*/

/* annual fatality models */


ivreg dwage (d2wage=$ixx $i2xx) dfatal dage dage2 dcendiv2-dcendiv9 dunion ///
...
g ivl1_dyn=(_b[dfatal]/(1-_b[d2wage]))*mnwage*mnhrs*100000
g var_ivl1_dyn=(100000^2)*(((mnwage*mnhrs)/(1-_b[d2wage]))^2*var_fatal + ((mnhrs*mnwage*_b[dfatal]/(1-_b[d2wage])^2)^2)*var_lagwage + 2*((_b[dfatal]/(1-_b[d2wage]))^2)*(1/(1-_b[d2wage]))*(mnwage*mnhrs)^2*cov_betagamma)
g sd_ivl1_dyn=sqrt(var_ivl1_dyn)
g ci95lower_dyn=ivl1_dyn-1.96*(sd_ivl1_dyn)
g ci95upper_dyn=ivl1_dyn+1.96*(sd_ivl1_dyn)

sum ivl1 var_ivl1 sd_ivl1 ci95lower ci95upper  ivl1_alt var_ivl1_alt sd_ivl1_alt ci95lower_alt ci95upper_alt ///
ivl1_dyn var_ivl1_dyn sd_ivl1_dyn ci95lower_dyn ci95upper_dyn if e(sample)

drop mnwage varwage mnhrs varhrs cov_wghrs var_fatal ivl1 var_ivl1 sd_ivl1 ci95lower ci95upper ivl1_alt ///
var_ivl1_alt sd_ivl1_alt ci95lower_alt ci95upper_alt n  ivl1_dyn var_ivl1_dyn sd_ivl1_dyn ci95lower_dyn ///
ci95upper_dyn  var_lagwage cov_betagamma
matrix drop v varf varl covfl


/* 3-year fatality models (B) */

ivreg dwage (d2wage=$ixx $i2xx) dfatal3 dage dage2 dcendiv2-dcendiv9 dunion ///
dmarry docc1 docc2 docc3 docc4 docc5 docc6 docc7 docc8 docc9 dsic2-dsic66 ///
dstate2-dstate50 yr_2-yr_5 if pct_chng3b>-75 & pct_chng3b<300, noconstant robust cluster(indocc)first
...
g ivl1_dyn=(_b[dfatal3]/(1-_b[d2wage]))*mnwage*mnhrs*100000
g var_ivl1_dyn=(100000^2)*(((mnwage*mnhrs)/(1-_b[d2wage]))^2*var_fatal + ((mnhrs*mnwage*_b[dfatal3]/(1-_b[d2wage])^2)^2)*var_lagwage + 2*((_b[dfatal3]/(1-_b[d2wage]))^2)*(1/(1-_b[d2wage]))*(mnwage*mnhrs)^2*cov_betagamma)
g sd_ivl1_dyn=sqrt(var_ivl1_dyn)
g ci95lower_dyn=ivl1_dyn-1.96*(sd_ivl1_dyn)
g ci95upper_dyn=ivl1_dyn+1.96*(sd_ivl1_dyn)

sum ivl1 var_ivl1 sd_ivl1 ci95lower ci95upper  ivl1_alt var_ivl1_alt sd_ivl1_alt ci95lower_alt ///
ci95upper_alt ivl1_dyn var_ivl1_dyn sd_ivl1_dyn ci95lower_dyn ci95upper_dyn if e(sample)
