...
log using "KVWZ_94(1)_table5_cols1-2.txt",replace
...
/* @@@ use 1 & 3 yr lag as instrument for 2 yr difference @@@ */
/* i.e. use 94 & 92 rates to IV for 95-93 rate */

gen l_fatal=lagfatal_  /* use lagfatal for current fatality models */

gen l2_fatal=l2.lagfatal_
...
* @@@ use 1 & 3 yr lag differences as instrument for 2 yr difference @@@ */
/* i.e. use (94 - 92) rates to IV for (95 - 93) rate */

gen ld_fatal=l_fatal - l2_fatal


global dxx="dage dage2 dneast dncent dwest dunion dmarry docc1 docc2 docc3 docc4 docc5 docc6 docc7 docc8 docc9 dsic2-dsic66 dstate2-dstate50"

ivreg dwage (dfatal=ld_fatal) dage dage2 dcendiv2-dcendiv9 dunion dmarry docc1 ///
docc2 docc3 docc4 docc5 docc6 docc7 docc8 docc9 dsic2-dsic66 dstate2-dstate50 ///
yr_2-yr_5 if pct_chng>-75 & pct_chng<300, noconstant robust cluster(indocc) first
