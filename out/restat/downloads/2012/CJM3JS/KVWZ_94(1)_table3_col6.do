...
/*                                      */
/*                                      */
/* USING INDUSTRY ONLY FATALITY MEASURE */
/* */
/*                                      */
/*                                      */
...
log using "KVWZ_94(1)_table3_col6.txt",replace
...
sort year sic2
merge year sic2 using "C:\Data\PSID\Injury\Feb10\fatal_sic2_allyrs.dta"

drop if id==.

/* Re-normalize Industry Fatality Rates to 1 in 100,000 */

replace sic2_fatal=100*sic2_fatal
replace sic2_fatal3b=100*sic2_fatal3b
replace sic2_lagfatal=100*sic2_lagfatal
replace sic2_lagfatal3b=100*sic2_lagfatal3b
...
g sic2_pct_chng=100*(sic2_fatal - sic2_lagfatal)/sic2_lagfatal
g sic2_pct_chng3b=100*(sic2_fatal3b - sic2_lagfatal3b)/sic2_lagfatal3b

g fatal=sic2_fatal


/* @@@@@@@@@@@                        @@@@@@@@@@@ */
/* @@@@@@@@@@@ INDUSTRY ONLY FATALITY @@@@@@@@@@@ */
/* @@@@@@@@@@@                        @@@@@@@@@@@ */
...
global dxx="dfatal dage dage2 dneast dncent dwest dunion dmarry docc1 docc2 docc3 docc4 docc5 docc6 docc7 docc8 docc9"

reg dwage $dxx yr_2-yr_5 dstate2-dstate50 if sic2_pct_chng>-75 & sic2_pct_chng<300, noconstant robust cluster(indocc)
...
replace fatal=sic2_fatal3b
replace dfatal=fatal-l2.fatal
global dxx="dfatal dage dage2 dneast dncent dwest dunion dmarry docc1 docc2 docc3 docc4 docc5 docc6 docc7 docc8 docc9"

reg dwage $dxx yr_2-yr_5 dstate2-dstate50 if sic2_pct_chng3b>-75 & sic2_pct_chng3b<300, noconstant robust cluster(indocc)
