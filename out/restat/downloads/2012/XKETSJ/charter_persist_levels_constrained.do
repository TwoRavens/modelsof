...
*CONDUCTS PERSISTENCE REGRESSIONS CONSTRAINING 1-3 YEARS AFTER CHARTER EXIT TO BE THE SAME COEFFICIENT
...
set more off
  ...
  # delimit ;
  postfile persist_levels_constr int(regid stage depvarid indepvarid) str40 (regtype depvar indepvar statname) float (stat tstat obs) 
	using /work/s/simberman/lusd/postfiles/persist_levels_constr.dta, replace;
  # delimit cr
...
*WILL ESTIMATE REGRESSIONS FOLLOWING TIME IN A CHARTER SPELL AND PERSISTENCE
	...
	*LET THE VARIABLE = 0 IF STUDENT NEVER ATTENDED A CHARTER
	...
	foreach chartvar of varlist lastchart laststart lastconv {
	  ...
	  *PRED GRADE BY GRADE IN FIRST CHART YEAR
	  gen inelig_1_first_chart_`chartvar' = pred_grade_first_chart >= maxgrade_`chartvar' + 1 & pred_grade_first_chart <= maxgrade_`chartvar' + 3
	...
	*INDICATORS FOR POST-CHARTER SPELLS
	foreach chartvar in "charter" "startup" "convert" {
	  gen post_`chartvar'_1_3 = post_`chartvar'_length >= 1 & post_`chartvar'_length <= 3
	  gen post_`chartvar'_4 = post_`chartvar'_length >= 4
	}

     *SAVE IN A TEMPORARY FILE
     drop if year == 0
     save /work/s/simberman/lusd/charter1/temp_persist.dta, replace
...
*TEST SAMPLE
     ...
     *OPEN TEMPORARY DATASET
     use /work/s/simberman/lusd/charter1/temp_persist.dta, clear
 ...
 *OLS;
 local stage 0;
 local j = `j' + 1;
 reg `var' startup_unzoned convert_zoned  post_startup_1_3 post_startup_4 post_convert_1_3 post_convert_4 `febase', robust cluster(schoolid) ;
 test post_convert_1_3 post_convert_4;
 test post_startup_1_3 post_startup_4;

 foreach indepvar of varlist  startup_unzoned convert_zoned  post_startup_1_3 post_startup_4  post_convert_1_3 post_convert_4 {;
   post persist_levels_constr (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("coef") (_b[`indepvar']) (_b[`indepvar']/_se[`indepvar']) (e(N));
   post persist_levels_constr (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("se") (_se[`indepvar']) (.) (e(N));
   local k = `k' + 1;
 };
 ...
 *IV;
 local k 1;
 local stage 2;
 ivreg `var' startup_unzoned convert_zoned `febase' (post_startup_1_3 post_startup_4  
	post_convert_1_3 post_convert_4 = inelig_*_first_chart_laststart inelig_*_first_chart_lastconv), robust cluster(schoolid) ;
 test post_convert_1_3 post_convert_4;
 test post_startup_1_3 post_startup_4;

 foreach indepvar of varlist  startup_unzoned convert_zoned  post_startup_1_3 post_startup_4 post_convert_1_3 post_convert_4 {;
 	post persist_levels_constr (`i') (`stage') (`j') (`k') ("iv-ss") ("`var'") ("`indepvar'") ("coef") (_b[`indepvar']) (_b[`indepvar']/_se[`indepvar']) (e(N));
 	post persist_levels_constr (`i') (`stage') (`j') (`k') ("iv-ss") ("`var'") ("`indepvar'") ("se") (_se[`indepvar']) (.) (e(N));
	local k = `k' + 1;
 };
};
 ...
 *OLS;
 local stage 0;
 local j = `j' + 1;
 reg `var' startup_unzoned convert_zoned  post_startup_1_3  
	post_startup_4  post_convert_1_3 post_convert_4 `febase', robust cluster(schoolid) ;

   test post_convert_1_3 post_convert_4;
   test post_startup_1_3 post_startup_4;

 foreach indepvar of varlist  startup_unzoned convert_zoned  post_startup_1_3
	post_startup_4  post_convert_1_3 post_convert_4 {;
   post persist_levels_constr (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("coef") (_b[`indepvar']) (_b[`indepvar']/_se[`indepvar']) (e(N));
   post persist_levels_constr (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("se") (_se[`indepvar']) (.) (e(N));
 local k = `k' + 1;
 };
 ...
 *SECOND STAGE;
 local stage 2;
 local k 1;
 ivreg `var' startup_unzoned convert_zoned `febase' (post_startup_1_3 
	post_startup_4  post_convert_1_3 post_convert_4 = inelig_*_first_chart_laststart inelig_*_first_chart_lastconv), robust cluster(schoolid) ;
 test post_convert_1_3 post_convert_4;
 test post_startup_1_3 post_startup_4;
...
postclose persist_levels_constr
use /work/s/simberman/lusd/postfiles/persist_levels_constr.dta, clear
sort regid depvarid stage indepvarid statname
outsheet using /work/s/simberman/lusd/postfiles/persist_levels_constr.dat, replace
