...
set more off
  ...
  # delimit ;
  postfile charter_interpanel_va_2drop int(regid stage depvarid indepvarid) str12 (regtype depvar indepvar statname) float (stat tstat obs) 
	using /work/s/simberman/lusd/postfiles/charter_interpanel_va_2drop.dta, replace;
  # delimit cr
...
foreach var of varlist `depvarlist' {
  ...
  local k 1
  post charter_interpanel_va_2drop (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("startup_unzoned") ("coef") (_b[startup_unzoned]) (_b[startup_unzoned]/_se[startup_unzoned]) (e(N))
  post charter_interpanel_va_2drop (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("startup_unzoned") ("se") (_se[startup_unzoned]) (.) (e(N))
...
postclose charter_interpanel_va_2drop
use /work/s/simberman/lusd/postfiles/charter_interpanel_va_2drop.dta, clear
sort stage indepvarid regid depvarid statname
outsheet using /work/s/simberman/lusd/postfiles/charter_interpanel_va_2drop.dat, replace
