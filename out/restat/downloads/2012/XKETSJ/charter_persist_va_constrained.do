...
set more off
  ...
  # delimit ;
  postfile persist_va_constr int(regid stage depvarid indepvarid) str40 (regtype depvar indepvar statname) float (stat tstat obs) 
	using /work/s/simberman/lusd/postfiles/persist_va_constr.dta, replace;
  # delimit cr
...
*WILL ESTIMATE REGRESSIONS FOLLOWING TIME IN A CHARTER SPELL AND PERSISTENCE
	...
	*INDICATORS FOR POST-CHARTER SPELLS
     ...
     *SAVE IN A TEMPORARY FILE
     drop if year == 0
     save /work/s/simberman/lusd/charter1/temp_persist_va.dta, replace
...
*TEST SAMPLE
     ...
     *OPEN TEMPORARY DATASET
     use /work/s/simberman/lusd/charter1/temp_persist_va.dta, clear
 ...
 *OLS;
 ...
 foreach indepvar of varlist  startup_unzoned convert_zoned  post_startup_1_3 post_startup_4  post_convert_1_3 post_convert_4 {;
   post persist_va_constr (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("coef") (_b[`indepvar']) (_b[`indepvar']/_se[`indepvar']) (e(N));
   post persist_va_constr (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("se") (_se[`indepvar']) (.) (e(N));
   local k = `k' + 1;
 };
 ...
 *IV;
 local k 1;
 local stage 2;
 ivreg `var' startup_unzoned convert_zoned `febase' (post_startup_1_3 post_startup_4  post_convert_1_3 post_convert_4 = 
		inelig_*_first_chart_laststart inelig_*_first_chart_lastconv), robust cluster(schoolid) ;
 test post_convert_1_3 post_convert_4;
 test post_startup_1_3 post_startup_4;

 foreach indepvar of varlist  startup_unzoned convert_zoned  post_startup_1_3 post_startup_4 post_convert_1_3 post_convert_4 {;
 	post persist_va_constr (`i') (`stage') (`j') (`k') ("iv-ss") ("`var'") ("`indepvar'") ("coef") (_b[`indepvar']) (_b[`indepvar']/_se[`indepvar']) (e(N));
 	post persist_va_constr (`i') (`stage') (`j') (`k') ("iv-ss") ("`var'") ("`indepvar'") ("se") (_se[`indepvar']) (.) (e(N));
	local k = `k' + 1;
 };
};
...
postclose persist_va_constr
use /work/s/simberman/lusd/postfiles/persist_va_constr.dta, clear
sort regid depvarid stage indepvarid statname
outsheet using /work/s/simberman/lusd/postfiles/persist_va_constr.dat, replace
