...
set more off
  ...
  # delimit ;
  postfile charter_persist_va int(regid stage depvarid indepvarid) str40 (regtype depvar indepvar statname) float (stat tstat obs) 
	using /home/s/simberman/lusd/postfiles/charter_persist_va.dta, replace;
  # delimit cr
...
sort id year
merge id year using /home/s/simberman/lusd/charter1/lusd_data_va_test.dta
 ...
 *OLS;
 ...
 foreach indepvar of varlist  startup_unzoned convert_zoned  post_startup_1  post_startup_2  post_startup_3  
   ...
   post charter_persist_va (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("coef") (_b[`indepvar']) (_b[`indepvar']/_se[`indepvar']) (e(N));
   post charter_persist_va (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("`indepvar'") ("se") (_se[`indepvar']) (.) (e(N));
   local k = `k' + 1;
 };
 ...
 *SECOND STAGE;
 ...
 foreach indepvar of varlist  startup_unzoned convert_zoned  post_startup_1  post_startup_2  
	post_startup_3  post_startup_4  post_convert_1 post_convert_2 post_convert_3 post_convert_4 {;
 	post charter_persist_va (`i') (`stage') (`j') (`k') ("iv-ss") ("`var'") ("`indepvar'") ("coef") (_b[`indepvar']) (_b[`indepvar']/_se[`indepvar']) (e(N));
 	post charter_persist_va (`i') (`stage') (`j') (`k') ("iv-ss") ("`var'") ("`indepvar'") ("se") (_se[`indepvar']) (.) (e(N));
	local k = `k' + 1;
 };
};
...
sort id year
merge id year using /home/s/simberman/lusd/charter1/lusd_data_va_base.dta
...
postclose charter_persist_va
use /home/s/simberman/lusd/postfiles/charter_persist_va.dta, clear
sort regid depvarid stage indepvarid statname
outsheet using /home/s/simberman/lusd/postfiles/charter_persist_va.dat, replace
