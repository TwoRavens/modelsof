...
set more off
  ...
  # delimit ;
  postfile charter_anysusp_va int(regid stage depvarid indepvarid) str12 (regtype depvar indepvar statname) float (stat tstat obs) 
	using /home/s/simberman/lusd/postfiles/charter_anysusp_va.dta, replace;
  # delimit cr
...
foreach var of varlist `depvarlist' {
 xtreg `var' convert_zoned startup_unzoned `febase'  structural* nonstructural* outofdist* if anyinfrac == 1, robust cluster(schoolid) nonest fe
  local k 4
  post charter_anysusp_va (`i') (`stage') (`j') (`k')  ("fe")  ("`var'") ("convert_zoned") ("coef") (_b[convert_zoned]) (_b[convert_zoned]/_se[convert_zoned]) (e(N))
  post charter_anysusp_va (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("convert_zoned") ("se") (_se[convert_zoned]) (.) (e(N))
  local k 5
  post charter_anysusp_va (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("startup_unzoned") ("coef") (_b[startup_unzoned]) (_b[startup_unzoned]/_se[startup_unzoned]) (e(N))
  post charter_anysusp_va (`i') (`stage') (`j') (`k') ("fe") ("`var'") ("startup_unzoned") ("se") (_se[startup_unzoned]) (.) (e(N))
 local j = `j' + 1
}
...
local i 2
local j 4
foreach var of varlist dperc_attn{
...
postclose charter_anysusp_va
use /home/s/simberman/lusd/postfiles/charter_anysusp_va.dta, clear
sort stage indepvarid regid depvarid statname
outsheet using /home/s/simberman/lusd/postfiles/charter_anysusp_va.dat, replace
