...
use "Cycle_region_CRFs_4cents.dta", clear
gen cycle=1
sort region
...
region			REGION NAME
populationperstation 	POPULATION OF MSA / # OF GASOLINE STATOINS FROM 2002 ECONOMIC CENSUS ESTABLISHMENTS DATA
indephhi		HERFINDAHL INDEX WITHIN INDEPENDENT RETAIL CHAINS AND STATIONS
indepshr		TOTAL MARKET SHARE OF ALL INDEPENDENT RETAIL CHANIS AND STATIONS
*/
