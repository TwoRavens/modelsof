...
*keep only period with post-period before the Paris Accords
...
keep if _merge==3 /*_merge==2s don't have any bombing data for period before first close election*/
drop _merge

*label vars
label var fr_strikes_mean "Bombing"
label var above "Above"
