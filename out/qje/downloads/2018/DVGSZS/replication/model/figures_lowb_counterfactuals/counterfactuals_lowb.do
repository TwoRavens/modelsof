...
cd "..\figures_lowb_counterfactuals";
save counterfactuals_persistence_lowb.dta, replace;



cd "..\figures_lowb_noEB";
import excel dataset_counterfactuals_persistence.xlsx, sheet("Sheet1") clear;
...
cd "..\figures_lowb_counterfactuals";
merge m:m year time using counterfactuals_persistence_lowb.dta, nogenerate keep(master matched);
save counterfactuals_persistence_lowb.dta, replace;
