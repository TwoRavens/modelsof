...
log using output/log_figureA9.txt, replace text
...
local dep_var = "turnout"
local ad_var = "cmag_prez_ptya_base"
local sempar_model = "lag_turnout_pres $extra_controls_ptya $demo_controls, nonpar(`ad_var') spline degree(3) knots1(0(10)50) gen(f parametric_res) nograph"
local par_model = "lag_turnout_pres $extra_controls_ptya $demo_controls `ad_var'"
...
graph play code/figureA9.grec
graph save output/figureA9.gph, replace
graph export output/figureA9.eps, replace
