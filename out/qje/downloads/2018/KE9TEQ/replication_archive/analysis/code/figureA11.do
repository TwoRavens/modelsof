...
global SAMPLE "r_registered==1 & r_matched_none==0 & r_MD_ptyd_base==0 & abs(r_distance)<=175000";
global VARs "r_D_ptyd_base";
global SampleVars "r_registered r_matched_none r_MD_ptyd_base r_distance";


log using $PATHlogs/log_figureA11.txt, replace;
...
twoway (scatter Yj Xj if abs(Xj)<170000, xline(0)) (line fhat r0 if abs(r0)<170000 & r0>0) (line fhat r0 if abs(r0)<170000 & r0<0);
graph play "$PATHcode/figureA11.grec";
graph save Graph "$PATHlogs/figureA11.gph", replace;
graph export "$PATHlogs/figureA11.eps", replace;
