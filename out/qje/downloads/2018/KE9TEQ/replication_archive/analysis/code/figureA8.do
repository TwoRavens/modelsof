...
log using output/log_figureA8.txt, replace text
...
local ad_var = "cmag_prez_othpty_base"
local sempar_model = "cmag_prez_ownpty_base lag_vote_share2pty_ownpty cand_visits_othpty cand_visits_ownpty cmag_oth_ownpty_base cmag_oth_othpty_base newspaper_slant document_count $demo_controls, nonpar(`ad_var') spline degree(3) knots1(0(7)28) gen(f parametric_res) nograph"
local par_model = "cmag_prez_ownpty_base lag_vote_share2pty_ownpty cand_visits_othpty cand_visits_ownpty cmag_oth_ownpty_base cmag_oth_othpty_base newspaper_slant document_count $demo_controls `ad_var'"
...
graph play code/figureA8.grec
graph save output/figureA8.gph, replace
graph export output/figureA8.eps, replace
