...
drop if missing(loghm_11)
drop if missing(loghm_13)

drop if missing(loghf_09)
drop if missing(loghf_11)
drop if missing(loghf_13)
...
generate dRHSproxy_07=RHS_09-RHS_05
generate dRHSproxy_09=RHS_11-RHS_07
generate dRHSproxy_11=RHS_13-RHS_09

rename dRHSproxy_07 dRHSproxy07
rename dRHSproxy_09 dRHSproxy09
rename dRHSproxy_11 dRHSproxy11

*dummy for man's retirement
generate husbtrans_05=0
generate husbtrans_07=0
replace husbtrans_07=1 if GENDER==1 & work_05>=35 & work_07<=5 & work_09<=5
generate husbtrans_09=0
replace husbtrans_09=1 if GENDER==1 & work_07>=35 & work_09<=5 & work_11<=5
generate husbtrans_11=0
replace husbtrans_11=1 if GENDER==1 & work_09>=35 & work_11<=5 & work_13<=5
...
replace wifetrans_07=1 if GENDER==2 & work_05>=35 & work_07<=5 & work_09<=5
generate wifetrans_09=0
replace wifetrans_09=1 if GENDER==2 & work_07>=35 & work_09<=5 & work_11<=5
generate wifetrans_11=0
replace wifetrans_11=1 if GENDER==2 & work_09>=35 & work_11<=5 & work_13<=5
...
keep if hhwifetrans_11==1 | hhhusbtrans_11==1

*select 2011 variables
keep HHID PN GENDER dLHS11 dRHS11 dRHSproxy11 LWGTHH
...
rename dLHS11 dLHS
rename dRHS11 dRHS
rename dRHSproxy11 dRHSproxy
rename LWGTHH waveweight

generate time=2011

save "../../CAMS/CAMS11_3waves_directestim.dta"

use "../../CAMS/CAMS07_3waves_directestim.dta"

append using "../../CAMS/CAMS09_3waves_directestim.dta"

append using "../../CAMS/CAMS11_3waves_directestim.dta"

save "../../CAMS/CAMS_3waves_directestim.dta"
