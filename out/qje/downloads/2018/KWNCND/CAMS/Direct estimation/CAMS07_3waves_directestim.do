...
drop if missing(loghm_05)
drop if missing(loghm_07)
drop if missing(loghm_09)

drop if missing(loghf_05)
...
keep if hhwifetrans_07==1 | hhhusbtrans_07==1

*select 2007 variables
keep HHID PN GENDER dLHS07 dRHS07 dRHSproxy07 JWGTHH
...
rename dLHS07 dLHS
rename dRHS07 dRHS
rename dRHSproxy07 dRHSproxy
rename JWGTHH waveweight

generate time=2007

save "../../CAMS/CAMS07_3waves_directestim.dta"
