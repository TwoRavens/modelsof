...
*This file selects variables for households matched across waves 2011 and 2013. Modify work, age, health and resident kids restrictions depending on desired sub-sample.  

*weights
svyset [pweight=MWGTHH]
...
*age
*keep if GENDER==2 | (GENDER==1 & MAGE>=60 & MAGE<=66)
...
*dummy for man working in both periods
...
*dummy for woman working in both periods
...
keep if hhhusbtrans_13==1 & hhwiferetired_13==1
...
generate hhratioz_11=hhhomework_11/(hhhomework_11+hhleisure_11)
generate hhratioz_13=hhhomework_13/(hhhomework_13+hhleisure_13)

generate ratioz_11=homework_11/(homework_11+leisure_11)
generate ratioz_13=homework_13/(homework_13+leisure_13)

svy: mean hhratioz_11 if GENDER==1
estat sd 
svy: mean hhratioz_13 if GENDER==1
estat sd
corr_svy hhratioz_11 hhratioz_13 if GENDER==1 [pweight=MWGTHH]

svy: mean ratioz_11 if GENDER==1
estat sd 
svy: mean ratioz_13 if GENDER==1
estat sd
corr_svy ratioz_11 ratioz_13 if GENDER==1 [pweight=MWGTHH]

svy: mean ratioz_11 if GENDER==2
estat sd 
svy: mean ratioz_13 if GENDER==2
estat sd
corr_svy ratioz_11 ratioz_13 if GENDER==2 [pweight=MWGTHH]
