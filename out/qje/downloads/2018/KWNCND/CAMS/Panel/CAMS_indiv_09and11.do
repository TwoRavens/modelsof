...
*This file selects variables for individuals matched across waves 2009 and 2011. Modify work, age, health and resident kids restrictions depending on desired sub-sample.  
...
keep if work_09>=35 & work_11<=5  

*health
*keep if LC001>=1 & LC001<=3 & MC001>=1 & MC001<=3 & NC001>=1 & NC001<=3

*no change in # of resident kids
*drop if LA099!=MA099
*drop if MA099!=NA099
*drop if missing(LA099) & missing(MA099) & missing(NA099)

*age
*keep if LAGE>=60 & LAGE<=66
...
svy: mean z_11
estat sd
corr_svy z_09 z_11 [pweight=LWGTR]

svy: mean z_09 if GENDER==1
estat sd
svy: mean z_11 if GENDER==1
estat sd
corr_svy z_09 z_11 if GENDER==1 [pweight=LWGTR]

svy: mean z_09 if GENDER==2
estat sd
svy: mean z_11 if GENDER==2
estat sd
corr_svy z_09 z_11 if GENDER==2 [pweight=LWGTR]

*summary statistics
svy: mean totaltime_09
estat sd
svy: mean totaltime_11
estat sd

svy: mean totaltime_09 if GENDER==1
estat sd
svy: mean totaltime_11 if GENDER==1
estat sd

svy: mean totaltime_09 if GENDER==2
estat sd
...
svy: mean work_09 if GENDER==1
estat sd
svy: mean work_11 if GENDER==1
estat sd

svy: mean work_09 if GENDER==2 
estat sd
svy: mean work_11 if GENDER==2
estat sd

svy: mean homework_09
estat sd
svy: mean homework_11
estat sd

svy: mean homework_09 if GENDER==1
estat sd
svy: mean homework_11 if GENDER==1
estat sd

svy: mean homework_09 if GENDER==2
estat sd
...
svy: mean leisure_09 if GENDER==1
estat sd
svy: mean leisure_11 if GENDER==1
estat sd

svy: mean leisure_09 if GENDER==2
estat sd
svy: mean leisure_11 if GENDER==2
estat sd

svy: mean personalcare_09
estat sd
svy: mean personalcare_11
estat sd

svy: mean personalcare_09 if GENDER==1
estat sd
svy: mean personalcare_11 if GENDER==1
estat sd

svy: mean personalcare_09 if GENDER==2
estat sd
svy: mean personalcare_11 if GENDER==2
estat sd

svy: mean residual_09
estat sd
svy: mean residual_11
estat sd

svy: mean residual_09 if GENDER==1
estat sd
svy: mean residual_11 if GENDER==1
estat sd

svy: mean residual_09 if GENDER==2
estat sd
...
*housework
svy: mean housework_09
estat sd
svy: mean housework_11
estat sd

svy: mean housework_09 if GENDER==1
estat sd
svy: mean housework_11 if GENDER==1
estat sd

svy: mean housework_09 if GENDER==2
estat sd
...
svy: mean A16_09 if GENDER==1
estat sd
svy: mean A16_11 if GENDER==1
estat sd

svy: mean A16_09 if GENDER==2
estat sd
...
svy: mean A17_09 if GENDER==1
estat sd
svy: mean A17_11 if GENDER==1
estat sd

svy: mean A17_09 if GENDER==2
estat sd
...
svy: mean A15_09 if GENDER==1
estat sd
svy: mean A15_11 if GENDER==1
estat sd

svy: mean A15_09 if GENDER==2
estat sd
svy: mean A15_11 if GENDER==2
estat sd

*maintenance
svy: mean maintenance_09
estat sd
svy: mean maintenance_11
estat sd

svy: mean maintenance_09 if GENDER==1
estat sd
svy: mean maintenance_11 if GENDER==1
estat sd

svy: mean maintenance_09 if GENDER==2
estat sd
...
svy: mean A1_09 if GENDER==1
estat sd
svy: mean A1_11 if GENDER==1
estat sd

svy: mean A1_09 if GENDER==2
estat sd
svy: mean A1_11 if GENDER==2
estat sd

*exercise
svy: mean exercise_09
estat sd
svy: mean exercise_11
estat sd

svy: mean exercise_09 if GENDER==1
estat sd
svy: mean exercise_11 if GENDER==1
estat sd

svy: mean exercise_09 if GENDER==2
estat sd
...
svy: mean A8_09 if GENDER==1
estat sd
svy: mean A8_11 if GENDER==1
estat sd

svy: mean A8_09 if GENDER==2
estat sd
svy: mean A8_11 if GENDER==2
estat sd

*relaxing (residual leisure)
svy: mean relaxing_09
estat sd
svy: mean relaxing_11
estat sd

svy: mean relaxing_09 if GENDER==1
estat sd
svy: mean relaxing_11 if GENDER==1
estat sd

svy: mean relaxing_09 if GENDER==2
estat sd
