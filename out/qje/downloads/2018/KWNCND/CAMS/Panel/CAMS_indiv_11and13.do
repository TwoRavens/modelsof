use "/Users/jo.2386/Dropbox/Documents/RW3/CAMS/CAMSmerged.dta"

*This file selects variables for individuals matched across waves 2011 and 2013. Modify work, age, health and resident kids restrictions depending on desired sub-sample.  
...
keep if work_11>=35 & work_13<=5

*health
*keep if MC001>=1 & MC001<=3 & NC001>=1 & NC001<=3 & OC001>=1 & OC001<=3

*no change in # of resident kids
*drop if MA099!=NA099
*drop if NA099!=OA099
*drop if missing(MA099) & missing(NA099) & missing(OA099)

*age
*keep if MAGE>=60 & MAGE<=66
...
svy: mean z_13
estat sd
corr_svy z_11 z_13 [pweight=MWGTR]

svy: mean z_11 if GENDER==1
estat sd
svy: mean z_13 if GENDER==1
estat sd
corr_svy z_11 z_13 [pweight=MWGTR]

svy: mean z_11 if GENDER==2
estat sd
svy: mean z_13 if GENDER==2
estat sd
corr_svy z_11 z_13 [pweight=MWGTR]

*summary statistics
svy: mean totaltime_11
estat sd
svy: mean totaltime_13
estat sd

svy: mean totaltime_11 if GENDER==1
estat sd
svy: mean totaltime_13 if GENDER==1
estat sd

svy: mean totaltime_11 if GENDER==2
estat sd
svy: mean totaltime_13 if GENDER==2
estat sd
...
svy: mean work_11 if GENDER==1
estat sd
svy: mean work_13 if GENDER==1
estat sd

svy: mean work_11 if GENDER==2 
estat sd
svy: mean work_13 if GENDER==2
estat sd

svy: mean homework_11
estat sd
svy: mean homework_13
estat sd

svy: mean homework_11 if GENDER==1
estat sd
svy: mean homework_13 if GENDER==1
estat sd

svy: mean homework_11 if GENDER==2
estat sd
svy: mean homework_13 if GENDER==2
estat sd
...
svy: mean leisure_11 if GENDER==1
estat sd
svy: mean leisure_13 if GENDER==1
estat sd

svy: mean leisure_11 if GENDER==2
estat sd
svy: mean leisure_13 if GENDER==2
estat sd

svy: mean personalcare_11
estat sd
svy: mean personalcare_13
estat sd

svy: mean personalcare_11 if GENDER==1
estat sd
svy: mean personalcare_13 if GENDER==1
estat sd

svy: mean personalcare_11 if GENDER==2
estat sd
svy: mean personalcare_13 if GENDER==2
estat sd

svy: mean residual_11
estat sd
svy: mean residual_13
estat sd

svy: mean residual_11 if GENDER==1
estat sd
svy: mean residual_13 if GENDER==1
estat sd

svy: mean residual_11 if GENDER==2
estat sd
svy: mean residual_13 if GENDER==2
estat sd
...
*housework
svy: mean housework_11
estat sd
svy: mean housework_13
estat sd

svy: mean housework_11 if GENDER==1
estat sd
svy: mean housework_13 if GENDER==1
estat sd

svy: mean housework_11 if GENDER==2
estat sd
svy: mean housework_13 if GENDER==2
estat sd
...
svy: mean A16_11 if GENDER==1
estat sd
svy: mean A16_13 if GENDER==1
estat sd

svy: mean A16_11 if GENDER==2
estat sd
svy: mean A16_13 if GENDER==2
estat sd
...
svy: mean A17_11 if GENDER==1
estat sd
svy: mean A17_13 if GENDER==1
estat sd

svy: mean A17_11 if GENDER==2
estat sd
svy: mean A17_13 if GENDER==2
estat sd
...
svy: mean A15_11 if GENDER==1
estat sd
svy: mean A15_13 if GENDER==1
estat sd

svy: mean A15_11 if GENDER==2
estat sd
svy: mean A15_13 if GENDER==2
estat sd

*maintenance
svy: mean maintenance_11
estat sd
svy: mean maintenance_13
estat sd

svy: mean maintenance_11 if GENDER==1
estat sd
svy: mean maintenance_13 if GENDER==1
estat sd

svy: mean maintenance_11 if GENDER==2
estat sd
svy: mean maintenance_13 if GENDER==2
estat sd
...
svy: mean A1_11 if GENDER==1
estat sd
svy: mean A1_13 if GENDER==1
estat sd

svy: mean A1_11 if GENDER==2
estat sd
svy: mean A1_13 if GENDER==2
estat sd

*exercise
svy: mean exercise_11
estat sd
svy: mean exercise_13
estat sd

svy: mean exercise_11 if GENDER==1
estat sd
svy: mean exercise_13 if GENDER==1
estat sd

svy: mean exercise_11 if GENDER==2
estat sd
svy: mean exercise_13 if GENDER==2
estat sd
...
svy: mean A8_11 if GENDER==1
estat sd
svy: mean A8_13 if GENDER==1
estat sd

svy: mean A8_11 if GENDER==2
estat sd
svy: mean A8_13 if GENDER==2
estat sd

*relaxing (residual leisure)
svy: mean relaxing_11
estat sd
svy: mean relaxing_13
estat sd

svy: mean relaxing_11 if GENDER==1
estat sd
svy: mean relaxing_13 if GENDER==1
estat sd

svy: mean relaxing_11 if GENDER==2
estat sd
svy: mean relaxing_13 if GENDER==2
estat sd
