...
*This file selects variables for households matched across waves 2009 and 2011. Modify work, age, health and resident kids restrictions depending on desired sub-sample.  

*weights
svyset [pweight=LWGTHH]
...
*age
*keep if GENDER==2 | (GENDER==1 & LAGE>=60 & LAGE<=66)
...
keep if hhhusbtrans_11==1 & hhwiferetired_11==1
...
generate hhratioz_09=hhhomework_09/(hhhomework_09+hhleisure_09)
generate hhratioz_11=hhhomework_11/(hhhomework_11+hhleisure_11)

generate ratioz_09=homework_09/(homework_09+leisure_09)
generate ratioz_11=homework_11/(homework_11+leisure_11)

svy: mean hhratioz_09 if GENDER==1
estat sd 
svy: mean hhratioz_11 if GENDER==1
estat sd
corr_svy hhratioz_09 hhratioz_11 if GENDER==1 [pweight=LWGTHH]

svy: mean ratioz_09 if GENDER==1
estat sd 
svy: mean ratioz_11 if GENDER==1
estat sd
corr_svy ratioz_09 ratioz_11 if GENDER==1 [pweight=LWGTHH]

svy: mean ratioz_09 if GENDER==2
estat sd 
svy: mean ratioz_11 if GENDER==2
estat sd
corr_svy ratioz_09 ratioz_11 if GENDER==2 [pweight=LWGTHH]
