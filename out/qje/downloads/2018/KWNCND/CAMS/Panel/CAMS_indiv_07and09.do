...
*This file selects variables for individuals matched across waves 2007 and 2009. Modify work, age, health and resident kids restrictions depending on desired sub-sample.  
...
svy: mean z_09
estat sd
corr_svy z_07 z_09 [pweight=KWGTR]

svy: mean z_07 if GENDER==1
estat sd
svy: mean z_09 if GENDER==1
estat sd
corr_svy z_07 z_09 if GENDER==1 [pweight=KWGTR]

svy: mean z_07 if GENDER==2
estat sd
svy: mean z_09 if GENDER==2
estat sd
corr_svy z_07 z_09 if GENDER==2 [pweight=KWGTR] 
