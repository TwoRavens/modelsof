...
*This file selects variables for households matched across waves 2005 and 2007. Modify work, age, health and resident kids restrictions depending on desired sub-sample.  

*weights
svyset [pweight=JWGTHH]
...
*age
*keep if GENDER==2 | (GENDER==1 & JAGE>=60 & JAGE<=66)
...
keep if hhhusbtrans_07==1 & hhwiferetired_07==1
...
generate hhratioz_05=hhhomework_05/(hhhomework_05+hhleisure_05)
generate hhratioz_07=hhhomework_07/(hhhomework_07+hhleisure_07)

generate ratioz_05=homework_05/(homework_05+leisure_05)
generate ratioz_07=homework_07/(homework_07+leisure_07)

svy: mean hhratioz_05 if GENDER==1
estat sd 
svy: mean hhratioz_07 if GENDER==1
estat sd
corr_svy hhratioz_05 hhratioz_07 if GENDER==1 [pweight=JWGTHH]

svy: mean ratioz_05 if GENDER==1
estat sd 
svy: mean ratioz_07 if GENDER==1
estat sd
corr_svy ratioz_05 ratioz_07 if GENDER==1 [pweight=JWGTHH]

svy: mean ratioz_05 if GENDER==2
estat sd 
svy: mean ratioz_07 if GENDER==2
estat sd
corr_svy ratioz_05 ratioz_07 if GENDER==2 [pweight=JWGTHH]
