...
estat sd
corr_svy hhratioz_07 hhratioz_09 if GENDER==1 [pweight=KWGTHH]

svy: mean ratioz_07 if GENDER==1
estat sd 
svy: mean ratioz_09 if GENDER==1
estat sd
corr_svy ratioz_07 ratioz_09 if GENDER==1 [pweight=KWGTHH]

svy: mean ratioz_07 if GENDER==2
estat sd 
svy: mean ratioz_09 if GENDER==2
estat sd
corr_svy ratioz_07 ratioz_09 if GENDER==2 [pweight=KWGTHH]
