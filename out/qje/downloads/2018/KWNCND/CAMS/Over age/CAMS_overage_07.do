...
*This file selects variables for 2007.
...
*age restriction
keep if KAGE>=54 & KAGE<=69

*ratio
generate z_07=homework_07/(homework_07+leisure_07)

svy: mean z_07, over(KAGE)
estat sd

svy: mean z_07 if GENDER==1, over(KAGE)
estat sd

svy: mean z_07 if GENDER==2, over(KAGE)
estat sd

*summary statistics
svy: mean totaltime_07, over(KAGE)
estat sd
svy: mean work_07, over(KAGE)
estat sd
svy: mean homework_07, over(KAGE)
estat sd
svy: mean leisure_07, over(KAGE)
estat sd
svy: mean personalcare_07, over(KAGE)
estat sd
svy: mean residual_07, over(KAGE)
estat sd
svy: mean computer_07, over(KAGE)
estat sd

tab KAGE

svy: mean totaltime_07 if GENDER==1, over(KAGE)
estat sd
svy: mean work_07 if GENDER==1, over(KAGE)
estat sd
svy: mean homework_07 if GENDER==1, over(KAGE)
estat sd
svy: mean leisure_07 if GENDER==1, over(KAGE)
estat sd
svy: mean personalcare_07 if GENDER==1, over(KAGE)
estat sd
svy: mean residual_07 if GENDER==1, over(KAGE)
estat sd
svy: mean computer_07 if GENDER==1, over(KAGE)
estat sd

tab KAGE if GENDER==1

svy: mean totaltime_07 if GENDER==2, over(KAGE)
estat sd
svy: mean work_07 if GENDER==2, over(KAGE)
estat sd
svy: mean homework_07 if GENDER==2, over(KAGE)
estat sd
svy: mean leisure_07 if GENDER==2, over(KAGE)
estat sd
svy: mean personalcare_07 if GENDER==2, over(KAGE)
estat sd
svy: mean residual_07 if GENDER==2, over(KAGE)
estat sd
svy: mean computer_07 if GENDER==2, over(KAGE)
estat sd

tab KAGE if GENDER==2
...
*housework
svy: mean housework_07, over(KAGE)
estat sd
svy: mean housework_07 if GENDER==1, over(KAGE)
estat sd
svy: mean housework_07 if GENDER==2, over(KAGE)
estat sd

*shopping/errands
svy: mean A16_07, over(KAGE)
estat sd
svy: mean A16_07 if GENDER==1, over(KAGE)
estat sd
svy: mean A16_07 if GENDER==2, over(KAGE)
estat sd

*cooking
svy: mean A17_07, over(KAGE)
estat sd
svy: mean A17_07 if GENDER==1, over(KAGE)
estat sd
svy: mean A17_07 if GENDER==2, over(KAGE)
estat sd

*yard work/gardening
svy: mean A15_07, over(KAGE)
estat sd
svy: mean A15_07 if GENDER==1, over(KAGE)
estat sd
svy: mean A15_07 if GENDER==2, over(KAGE)
estat sd

*maintenance
svy: mean maintenance_07, over(KAGE)
estat sd
svy: mean maintenance_07 if GENDER==1, over(KAGE)
estat sd
svy: mean maintenance_07 if GENDER==2, over(KAGE)
estat sd
...
*watch TV
svy: mean A1_07, over(KAGE)
estat sd
svy: mean A1_07 if GENDER==1, over(KAGE)
estat sd
svy: mean A1_07 if GENDER==2, over(KAGE)
estat sd

*exercise
svy: mean exercise_07, over(KAGE)
estat sd
svy: mean exercise_07 if GENDER==1, over(KAGE)
estat sd
svy: mean exercise_07 if GENDER==2, over(KAGE)
estat sd

*socializing
svy: mean A8_07, over(KAGE)
estat sd
svy: mean A8_07 if GENDER==1, over(KAGE)
estat sd
svy: mean A8_07 if GENDER==2, over(KAGE)
estat sd

*relaxing (residual leisure)
svy: mean relaxing_07, over(KAGE)
estat sd
svy: mean relaxing_07 if GENDER==1, over(KAGE)
estat sd
svy: mean relaxing_07 if GENDER==2, over(KAGE)
estat sd

*median - work
table KAGE [pweight=KWGTR], c(med work_07) 
table KAGE if GENDER==1 [pweight=KWGTR], c(med work_07) 
table KAGE if GENDER==2 [pweight=KWGTR], c(med work_07)

*median - homework
table KAGE [pweight=KWGTR], c(med homework_07) 
table KAGE if GENDER==1 [pweight=KWGTR], c(med homework_07) 
table KAGE if GENDER==2 [pweight=KWGTR], c(med homework_07) 

*median - leisure
table KAGE [pweight=KWGTR], c(med leisure_07) 
table KAGE if GENDER==1 [pweight=KWGTR], c(med leisure_07) 
table KAGE if GENDER==2 [pweight=KWGTR], c(med leisure_07)

*correlation between market and home work
corr_svy work_07 homework_07 if KAGE>=49 & KAGE<=53 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=54 & KAGE<=58 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=59 & KAGE<=63 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=64 & KAGE<=68 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=64 [pweight=KWGTR]

corr_svy work_07 homework_07 if KAGE>=49 & KAGE<=53 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=54 & KAGE<=58 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=59 & KAGE<=63 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=64 & KAGE<=68 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=64 & GENDER==1 [pweight=KWGTR]

corr_svy work_07 homework_07 if KAGE>=49 & KAGE<=53 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=54 & KAGE<=58 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=59 & KAGE<=63 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=64 & KAGE<=68 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 homework_07 if KAGE>=64 & GENDER==2 [pweight=KWGTR]

*correlation between market work and leisure
corr_svy work_07 leisure_07 if KAGE>=49 & KAGE<=53 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=54 & KAGE<=58 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=59 & KAGE<=63 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=64 & KAGE<=68 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=64 [pweight=KWGTR]

corr_svy work_07 leisure_07 if KAGE>=49 & KAGE<=53 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=54 & KAGE<=58 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=59 & KAGE<=63 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=64 & KAGE<=68 & GENDER==1 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=64 & GENDER==1 [pweight=KWGTR]

corr_svy work_07 leisure_07 if KAGE>=49 & KAGE<=53 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=54 & KAGE<=58 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=59 & KAGE<=63 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=64 & KAGE<=68 & GENDER==2 [pweight=KWGTR]
corr_svy work_07 leisure_07 if KAGE>=64 & GENDER==2 [pweight=KWGTR]

*correlation between home work and leisure
corr_svy homework_07 leisure_07 if KAGE>=49 & KAGE<=53 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=54 & KAGE<=58 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=59 & KAGE<=63 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=64 & KAGE<=68 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=64 [pweight=KWGTR]

corr_svy homework_07 leisure_07 if KAGE>=49 & KAGE<=53 & GENDER==1 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=54 & KAGE<=58 & GENDER==1 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=59 & KAGE<=63 & GENDER==1 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=64 & KAGE<=68 & GENDER==1 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=64 & GENDER==1 [pweight=KWGTR]

corr_svy homework_07 leisure_07 if KAGE>=49 & KAGE<=53 & GENDER==2 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=54 & KAGE<=58 & GENDER==2 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=59 & KAGE<=63 & GENDER==2 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=64 & KAGE<=68 & GENDER==2 [pweight=KWGTR]
corr_svy homework_07 leisure_07 if KAGE>=64 & GENDER==2 [pweight=KWGTR]
