...
*This file selects variables for 2011.

*weights
svyset [pweight=MWGTR]

*drop if all homework subcategories for relevant years missing 
drop if missing(A13_11) & missing(A14_11) & missing(A15_11) & missing(A16_11) & missing(A17_11) & missing(A19_11) & missing(A21_11) & missing(A25_11) & missing(A31_11) & missing(A32_11)
...
replace A21_05=0 if missing(A25_05)
replace A21_07=0 if missing(A25_07)
replace A21_09=0 if missing(A25_09)
replace A21_11=0 if missing(A25_11)
replace A21_13=0 if missing(A25_13)
...
drop if missing(work_11)
drop if missing(leisure_11)

drop if leisure_11==0
drop if work_11>100
drop if homework_11>100

*age restriction
keep if MAGE>=54 & MAGE<=69

*ratio
generate z_11=homework_11/(homework_11+leisure_11)

svy: mean z_11, over(MAGE)
estat sd

svy: mean z_11 if GENDER==1, over(MAGE)
estat sd

svy: mean z_11 if GENDER==2, over(MAGE)
estat sd

*summary statistics
svy: mean totaltime_11, over(MAGE)
estat sd
svy: mean work_11, over(MAGE)
estat sd
svy: mean homework_11, over(MAGE)
estat sd
svy: mean leisure_11, over(MAGE)
estat sd
svy: mean personalcare_11, over(MAGE)
estat sd
svy: mean residual_11, over(MAGE)
estat sd
svy: mean computer_11, over(MAGE)
estat sd

tab MAGE

svy: mean totaltime_11 if GENDER==1, over(MAGE)
estat sd
svy: mean work_11 if GENDER==1, over(MAGE)
estat sd
svy: mean homework_11 if GENDER==1, over(MAGE)
estat sd
svy: mean leisure_11 if GENDER==1, over(MAGE)
estat sd
svy: mean personalcare_11 if GENDER==1, over(MAGE)
estat sd
svy: mean residual_11 if GENDER==1, over(MAGE)
estat sd
svy: mean computer_11 if GENDER==1, over(MAGE)
estat sd

tab MAGE if GENDER==1

svy: mean totaltime_11 if GENDER==2, over(MAGE)
estat sd
svy: mean work_11 if GENDER==2, over(MAGE)
estat sd
svy: mean homework_11 if GENDER==2, over(MAGE)
estat sd
svy: mean leisure_11 if GENDER==2, over(MAGE)
estat sd
svy: mean personalcare_11 if GENDER==2, over(MAGE)
estat sd
svy: mean residual_11 if GENDER==2, over(MAGE)
estat sd
svy: mean computer_11 if GENDER==2, over(MAGE)
estat sd

tab MAGE if GENDER==2

*homework sub-categories
generate housework_11=A13_11+A14_11
generate vehiclemaint_11=(A33_11/30.4)*7
generate homeimp_11=(A31_11/30.4)*7
generate maintenance_11=homeimp_11+vehiclemaint_11

*housework
svy: mean housework_11, over(MAGE)
estat sd
svy: mean housework_11 if GENDER==1, over(MAGE)
estat sd
svy: mean housework_11 if GENDER==2, over(MAGE)
estat sd

*shopping/errands
svy: mean A16_11, over(MAGE)
estat sd
svy: mean A16_11 if GENDER==1, over(MAGE)
estat sd
svy: mean A16_11 if GENDER==2, over(MAGE)
estat sd

*cooking
svy: mean A17_11, over(MAGE)
estat sd
svy: mean A17_11 if GENDER==1, over(MAGE)
estat sd
svy: mean A17_11 if GENDER==2, over(MAGE)
estat sd

*yard work/gardening
svy: mean A15_11, over(MAGE)
estat sd
svy: mean A15_11 if GENDER==1, over(MAGE)
estat sd
svy: mean A15_11 if GENDER==2, over(MAGE)
estat sd

*maintenance
svy: mean maintenance_11, over(MAGE)
estat sd
svy: mean maintenance_11 if GENDER==1, over(MAGE)
estat sd
svy: mean maintenance_11 if GENDER==2, over(MAGE)
estat sd

*leisure sub-categories
generate exercise_11=A6_11+A7_11
generate relaxing_11=leisure_11-A1_11-exercise_11-A8_11

*watch TV
svy: mean A1_11, over(MAGE)
estat sd
svy: mean A1_11 if GENDER==1, over(MAGE)
estat sd
svy: mean A1_11 if GENDER==2, over(MAGE)
estat sd

*exercise
svy: mean exercise_11, over(MAGE)
estat sd
svy: mean exercise_11 if GENDER==1, over(MAGE)
estat sd
svy: mean exercise_11 if GENDER==2, over(MAGE)
estat sd

*socializing
svy: mean A8_11, over(MAGE)
estat sd
svy: mean A8_11 if GENDER==1, over(MAGE)
estat sd
svy: mean A8_11 if GENDER==2, over(MAGE)
estat sd

*relaxing (residual leisure)
svy: mean relaxing_11, over(MAGE)
estat sd
svy: mean relaxing_11 if GENDER==1, over(MAGE)
estat sd
svy: mean relaxing_11 if GENDER==2, over(MAGE)
estat sd

*median - work
tabMe MAGE [pweight=MWGTR], c(med work_11) 
tabMe MAGE if GENDER==1 [pweight=MWGTR], c(med work_11) 
tabMe MAGE if GENDER==2 [pweight=MWGTR], c(med work_11)

*median - homework
tabMe MAGE [pweight=MWGTR], c(med homework_11) 
tabMe MAGE if GENDER==1 [pweight=MWGTR], c(med homework_11) 
tabMe MAGE if GENDER==2 [pweight=MWGTR], c(med homework_11) 

*median - leisure
tabMe MAGE [pweight=MWGTR], c(med leisure_11) 
tabMe MAGE if GENDER==1 [pweight=MWGTR], c(med leisure_11) 
tabMe MAGE if GENDER==2 [pweight=MWGTR], c(med leisure_11)

*correlation between market and home work
corr_svy work_11 homework_11 if MAGE>=49 & MAGE<=53 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=54 & MAGE<=58 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=59 & MAGE<=63 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=64 & MAGE<=68 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=64 [pweight=MWGTR]

corr_svy work_11 homework_11 if MAGE>=49 & MAGE<=53 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=54 & MAGE<=58 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=59 & MAGE<=63 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=64 & MAGE<=68 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=64 & GENDER==1 [pweight=MWGTR]

corr_svy work_11 homework_11 if MAGE>=49 & MAGE<=53 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=54 & MAGE<=58 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=59 & MAGE<=63 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=64 & MAGE<=68 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 homework_11 if MAGE>=64 & GENDER==2 [pweight=MWGTR]

*correlation between market work and leisure
corr_svy work_11 leisure_11 if MAGE>=49 & MAGE<=53 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=54 & MAGE<=58 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=59 & MAGE<=63 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=64 & MAGE<=68 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=64 [pweight=MWGTR]

corr_svy work_11 leisure_11 if MAGE>=49 & MAGE<=53 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=54 & MAGE<=58 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=59 & MAGE<=63 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=64 & MAGE<=68 & GENDER==1 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=64 & GENDER==1 [pweight=MWGTR]

corr_svy work_11 leisure_11 if MAGE>=49 & MAGE<=53 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=54 & MAGE<=58 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=59 & MAGE<=63 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=64 & MAGE<=68 & GENDER==2 [pweight=MWGTR]
corr_svy work_11 leisure_11 if MAGE>=64 & GENDER==2 [pweight=MWGTR]

*correlation between home work and leisure
corr_svy homework_11 leisure_11 if MAGE>=49 & MAGE<=53 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=54 & MAGE<=58 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=59 & MAGE<=63 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=64 & MAGE<=68 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=64 [pweight=MWGTR]

corr_svy homework_11 leisure_11 if MAGE>=49 & MAGE<=53 & GENDER==1 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=54 & MAGE<=58 & GENDER==1 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=59 & MAGE<=63 & GENDER==1 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=64 & MAGE<=68 & GENDER==1 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=64 & GENDER==1 [pweight=MWGTR]

corr_svy homework_11 leisure_11 if MAGE>=49 & MAGE<=53 & GENDER==2 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=54 & MAGE<=58 & GENDER==2 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=59 & MAGE<=63 & GENDER==2 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=64 & MAGE<=68 & GENDER==2 [pweight=MWGTR]
corr_svy homework_11 leisure_11 if MAGE>=64 & GENDER==2 [pweight=MWGTR]
