...
*This file selects variables for 2013.

*weights
svyset [pweight=NWGTR]

*drop if all homework subcategories for relevant years missing 
drop if missing(A13_13) & missing(A14_13) & missing(A15_13) & missing(A16_13) & missing(A17_13) & missing(A19_13) & missing(A21_13) & missing(A25_13) & missing(A31_13) & missing(A32_13)
...
drop if missing(work_13)
drop if missing(leisure_13)

drop if leisure_13==0
drop if work_13>100
drop if homework_13>100

*age restriction
keep if NAGE>=54 & NAGE<=69

*ratio
generate z_13=homework_13/(homework_13+leisure_13)

svy: mean z_13, over(NAGE)
estat sd

svy: mean z_13 if GENDER==1, over(NAGE)
estat sd

svy: mean z_13 if GENDER==2, over(NAGE)
estat sd

*summary statistics
svy: mean totaltime_13, over(NAGE)
estat sd
svy: mean work_13, over(NAGE)
estat sd
svy: mean homework_13, over(NAGE)
estat sd
svy: mean leisure_13, over(NAGE)
estat sd
svy: mean personalcare_13, over(NAGE)
estat sd
svy: mean residual_13, over(NAGE)
estat sd
svy: mean computer_13, over(NAGE)
estat sd

tab NAGE

svy: mean totaltime_13 if GENDER==1, over(NAGE)
estat sd
svy: mean work_13 if GENDER==1, over(NAGE)
estat sd
svy: mean homework_13 if GENDER==1, over(NAGE)
estat sd
svy: mean leisure_13 if GENDER==1, over(NAGE)
estat sd
svy: mean personalcare_13 if GENDER==1, over(NAGE)
estat sd
svy: mean residual_13 if GENDER==1, over(NAGE)
estat sd
svy: mean computer_13 if GENDER==1, over(NAGE)
estat sd

tab NAGE if GENDER==1

svy: mean totaltime_13 if GENDER==2, over(NAGE)
estat sd
svy: mean work_13 if GENDER==2, over(NAGE)
estat sd
svy: mean homework_13 if GENDER==2, over(NAGE)
estat sd
svy: mean leisure_13 if GENDER==2, over(NAGE)
estat sd
svy: mean personalcare_13 if GENDER==2, over(NAGE)
estat sd
svy: mean residual_13 if GENDER==2, over(NAGE)
estat sd
svy: mean computer_13 if GENDER==2, over(NAGE)
estat sd

tab NAGE if GENDER==2

*homework sub-categories
generate housework_13=A13_13+A14_13
generate vehiclemaint_13=(A33_13/30.4)*7
generate homeimp_13=(A31_13/30.4)*7
generate maintenance_13=homeimp_13+vehiclemaint_13

*housework
svy: mean housework_13, over(NAGE)
estat sd
svy: mean housework_13 if GENDER==1, over(NAGE)
estat sd
svy: mean housework_13 if GENDER==2, over(NAGE)
estat sd

*shopping/errands
svy: mean A16_13, over(NAGE)
estat sd
svy: mean A16_13 if GENDER==1, over(NAGE)
estat sd
svy: mean A16_13 if GENDER==2, over(NAGE)
estat sd

*cooking
svy: mean A17_13, over(NAGE)
estat sd
svy: mean A17_13 if GENDER==1, over(NAGE)
estat sd
svy: mean A17_13 if GENDER==2, over(NAGE)
estat sd

*yard work/gardening
svy: mean A15_13, over(NAGE)
estat sd
svy: mean A15_13 if GENDER==1, over(NAGE)
estat sd
svy: mean A15_13 if GENDER==2, over(NAGE)
estat sd

*maintenance
svy: mean maintenance_13, over(NAGE)
estat sd
svy: mean maintenance_13 if GENDER==1, over(NAGE)
estat sd
svy: mean maintenance_13 if GENDER==2, over(NAGE)
estat sd

*leisure sub-categories
generate exercise_13=A6_13+A7_13
generate relaxing_13=leisure_13-A1_13-exercise_13-A8_13

*watch TV
svy: mean A1_13, over(NAGE)
estat sd
svy: mean A1_13 if GENDER==1, over(NAGE)
estat sd
svy: mean A1_13 if GENDER==2, over(NAGE)
estat sd

*exercise
svy: mean exercise_13, over(NAGE)
estat sd
svy: mean exercise_13 if GENDER==1, over(NAGE)
estat sd
svy: mean exercise_13 if GENDER==2, over(NAGE)
estat sd

*socializing
svy: mean A8_13, over(NAGE)
estat sd
svy: mean A8_13 if GENDER==1, over(NAGE)
estat sd
svy: mean A8_13 if GENDER==2, over(NAGE)
estat sd

*relaxing (residual leisure)
svy: mean relaxing_13, over(NAGE)
estat sd
svy: mean relaxing_13 if GENDER==1, over(NAGE)
estat sd
svy: mean relaxing_13 if GENDER==2, over(NAGE)
estat sd

*median - work
table NAGE [pweight=NWGTR], c(med work_13) 
table NAGE if GENDER==1 [pweight=NWGTR], c(med work_13) 
table NAGE if GENDER==2 [pweight=NWGTR], c(med work_13)

*median - homework
table NAGE [pweight=NWGTR], c(med homework_13) 
table NAGE if GENDER==1 [pweight=NWGTR], c(med homework_13) 
table NAGE if GENDER==2 [pweight=NWGTR], c(med homework_13) 

*median - leisure
table NAGE [pweight=NWGTR], c(med leisure_13) 
table NAGE if GENDER==1 [pweight=NWGTR], c(med leisure_13) 
table NAGE if GENDER==2 [pweight=NWGTR], c(med leisure_13)

*correlation between market and home work
corr_svy work_13 homework_13 if NAGE>=49 & NAGE<=53 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=54 & NAGE<=58 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=59 & NAGE<=63 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=64 & NAGE<=68 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=64 [pweight=NWGTR]

corr_svy work_13 homework_13 if NAGE>=49 & NAGE<=53 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=54 & NAGE<=58 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=59 & NAGE<=63 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=64 & NAGE<=68 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=64 & GENDER==1 [pweight=NWGTR]

corr_svy work_13 homework_13 if NAGE>=49 & NAGE<=53 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=54 & NAGE<=58 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=59 & NAGE<=63 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=64 & NAGE<=68 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 homework_13 if NAGE>=64 & GENDER==2 [pweight=NWGTR]

*correlation between market work and leisure
corr_svy work_13 leisure_13 if NAGE>=49 & NAGE<=53 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=54 & NAGE<=58 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=59 & NAGE<=63 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=64 & NAGE<=68 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=64 [pweight=NWGTR]

corr_svy work_13 leisure_13 if NAGE>=49 & NAGE<=53 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=54 & NAGE<=58 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=59 & NAGE<=63 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=64 & NAGE<=68 & GENDER==1 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=64 & GENDER==1 [pweight=NWGTR]

corr_svy work_13 leisure_13 if NAGE>=49 & NAGE<=53 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=54 & NAGE<=58 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=59 & NAGE<=63 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=64 & NAGE<=68 & GENDER==2 [pweight=NWGTR]
corr_svy work_13 leisure_13 if NAGE>=64 & GENDER==2 [pweight=NWGTR]

*correlation between home work and leisure
corr_svy homework_13 leisure_13 if NAGE>=49 & NAGE<=53 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=54 & NAGE<=58 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=59 & NAGE<=63 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=64 & NAGE<=68 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=64 [pweight=NWGTR]

corr_svy homework_13 leisure_13 if NAGE>=49 & NAGE<=53 & GENDER==1 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=54 & NAGE<=58 & GENDER==1 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=59 & NAGE<=63 & GENDER==1 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=64 & NAGE<=68 & GENDER==1 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=64 & GENDER==1 [pweight=NWGTR]

corr_svy homework_13 leisure_13 if NAGE>=49 & NAGE<=53 & GENDER==2 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=54 & NAGE<=58 & GENDER==2 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=59 & NAGE<=63 & GENDER==2 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=64 & NAGE<=68 & GENDER==2 [pweight=NWGTR]
corr_svy homework_13 leisure_13 if NAGE>=64 & GENDER==2 [pweight=NWGTR]
