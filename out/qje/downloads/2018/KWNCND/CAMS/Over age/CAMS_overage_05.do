...
*This file selects variables for 2005.
...
*age restriction
keep if JAGE>=54 & JAGE<=69

*ratio
generate z_05=homework_05/(homework_05+leisure_05)

svy: mean z_05, over(JAGE)
estat sd

svy: mean z_05 if GENDER==1, over(JAGE)
estat sd

svy: mean z_05 if GENDER==2, over(JAGE)
estat sd

*summary statistics
svy: mean totaltime_05, over(JAGE)
estat sd
svy: mean work_05, over(JAGE)
estat sd
svy: mean homework_05, over(JAGE)
estat sd
svy: mean leisure_05, over(JAGE)
estat sd
svy: mean personalcare_05, over(JAGE)
estat sd
svy: mean residual_05, over(JAGE)
estat sd
svy: mean computer_05, over(JAGE)
estat sd

tab JAGE

svy: mean totaltime_05 if GENDER==1, over(JAGE)
estat sd
svy: mean work_05 if GENDER==1, over(JAGE)
estat sd
svy: mean homework_05 if GENDER==1, over(JAGE)
estat sd
svy: mean leisure_05 if GENDER==1, over(JAGE)
estat sd
svy: mean personalcare_05 if GENDER==1, over(JAGE)
estat sd
svy: mean residual_05 if GENDER==1, over(JAGE)
estat sd
svy: mean computer_05 if GENDER==1, over(JAGE)
estat sd

tab JAGE if GENDER==1

svy: mean totaltime_05 if GENDER==2, over(JAGE)
estat sd
svy: mean work_05 if GENDER==2, over(JAGE)
estat sd
svy: mean homework_05 if GENDER==2, over(JAGE)
estat sd
svy: mean leisure_05 if GENDER==2, over(JAGE)
estat sd
svy: mean personalcare_05 if GENDER==2, over(JAGE)
estat sd
svy: mean residual_05 if GENDER==2, over(JAGE)
estat sd
svy: mean computer_05 if GENDER==2, over(JAGE)
estat sd

tab JAGE if GENDER==2
...
*housework
svy: mean housework_05, over(JAGE)
estat sd
svy: mean housework_05 if GENDER==1, over(JAGE)
estat sd
svy: mean housework_05 if GENDER==2, over(JAGE)
estat sd

*shopping/errands
svy: mean A16_05, over(JAGE)
estat sd
svy: mean A16_05 if GENDER==1, over(JAGE)
estat sd
svy: mean A16_05 if GENDER==2, over(JAGE)
estat sd

*cooking
svy: mean A17_05, over(JAGE)
estat sd
svy: mean A17_05 if GENDER==1, over(JAGE)
estat sd
svy: mean A17_05 if GENDER==2, over(JAGE)
estat sd

*yard work/gardening
svy: mean A15_05, over(JAGE)
estat sd
svy: mean A15_05 if GENDER==1, over(JAGE)
estat sd
svy: mean A15_05 if GENDER==2, over(JAGE)
estat sd

*maintenance
svy: mean maintenance_05, over(JAGE)
estat sd
svy: mean maintenance_05 if GENDER==1, over(JAGE)
estat sd
svy: mean maintenance_05 if GENDER==2, over(JAGE)
estat sd
...
*watch TV
svy: mean A1_05, over(JAGE)
estat sd
svy: mean A1_05 if GENDER==1, over(JAGE)
estat sd
svy: mean A1_05 if GENDER==2, over(JAGE)
estat sd

*exercise
svy: mean exercise_05, over(JAGE)
estat sd
svy: mean exercise_05 if GENDER==1, over(JAGE)
estat sd
svy: mean exercise_05 if GENDER==2, over(JAGE)
estat sd

*socializing
svy: mean A8_05, over(JAGE)
estat sd
svy: mean A8_05 if GENDER==1, over(JAGE)
estat sd
svy: mean A8_05 if GENDER==2, over(JAGE)
estat sd

*relaxing (residual leisure)
svy: mean relaxing_05, over(JAGE)
estat sd
svy: mean relaxing_05 if GENDER==1, over(JAGE)
estat sd
svy: mean relaxing_05 if GENDER==2, over(JAGE)
estat sd

*median - work
table JAGE [pweight=JWGTR], c(med work_05) 
table JAGE if GENDER==1 [pweight=JWGTR], c(med work_05) 
table JAGE if GENDER==2 [pweight=JWGTR], c(med work_05)

*median - homework
table JAGE [pweight=JWGTR], c(med homework_05) 
table JAGE if GENDER==1 [pweight=JWGTR], c(med homework_05) 
table JAGE if GENDER==2 [pweight=JWGTR], c(med homework_05) 

*median - leisure
table JAGE [pweight=JWGTR], c(med leisure_05) 
table JAGE if GENDER==1 [pweight=JWGTR], c(med leisure_05) 
table JAGE if GENDER==2 [pweight=JWGTR], c(med leisure_05)

*correlation between market and home work
corr_svy work_05 homework_05 if JAGE>=49 & JAGE<=53 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=54 & JAGE<=58 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=59 & JAGE<=63 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=64 & JAGE<=68 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=64 [pweight=JWGTR]

corr_svy work_05 homework_05 if JAGE>=49 & JAGE<=53 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=54 & JAGE<=58 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=59 & JAGE<=63 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=64 & JAGE<=68 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=64 & GENDER==1 [pweight=JWGTR]

corr_svy work_05 homework_05 if JAGE>=49 & JAGE<=53 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=54 & JAGE<=58 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=59 & JAGE<=63 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=64 & JAGE<=68 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 homework_05 if JAGE>=64 & GENDER==2 [pweight=JWGTR]

*correlation between market work and leisure
corr_svy work_05 leisure_05 if JAGE>=49 & JAGE<=53 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=54 & JAGE<=58 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=59 & JAGE<=63 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=64 & JAGE<=68 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=64 [pweight=JWGTR]

corr_svy work_05 leisure_05 if JAGE>=49 & JAGE<=53 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=54 & JAGE<=58 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=59 & JAGE<=63 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=64 & JAGE<=68 & GENDER==1 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=64 & GENDER==1 [pweight=JWGTR]

corr_svy work_05 leisure_05 if JAGE>=49 & JAGE<=53 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=54 & JAGE<=58 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=59 & JAGE<=63 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=64 & JAGE<=68 & GENDER==2 [pweight=JWGTR]
corr_svy work_05 leisure_05 if JAGE>=64 & GENDER==2 [pweight=JWGTR]

*correlation between home work and leisure
corr_svy homework_05 leisure_05 if JAGE>=49 & JAGE<=53 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=54 & JAGE<=58 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=59 & JAGE<=63 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=64 & JAGE<=68 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=64 [pweight=JWGTR]

corr_svy homework_05 leisure_05 if JAGE>=49 & JAGE<=53 & GENDER==1 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=54 & JAGE<=58 & GENDER==1 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=59 & JAGE<=63 & GENDER==1 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=64 & JAGE<=68 & GENDER==1 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=64 & GENDER==1 [pweight=JWGTR]

corr_svy homework_05 leisure_05 if JAGE>=49 & JAGE<=53 & GENDER==2 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=54 & JAGE<=58 & GENDER==2 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=59 & JAGE<=63 & GENDER==2 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=64 & JAGE<=68 & GENDER==2 [pweight=JWGTR]
corr_svy homework_05 leisure_05 if JAGE>=64 & GENDER==2 [pweight=JWGTR]
