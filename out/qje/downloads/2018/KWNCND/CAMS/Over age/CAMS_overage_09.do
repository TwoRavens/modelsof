...
*This file selects variables for 2009.

*weights
svyset [pweight=LWGTR]
...
*age restriction
keep if LAGE>=54 & LAGE<=69

*ratio
generate z_09=homework_09/(homework_09+leisure_09)

svy: mean z_09, over(LAGE)
estat sd

svy: mean z_09 if GENDER==1, over(LAGE)
estat sd

svy: mean z_09 if GENDER==2, over(LAGE)
estat sd

*summary statistics
svy: mean totaltime_09, over(LAGE)
estat sd
svy: mean work_09, over(LAGE)
estat sd
svy: mean homework_09, over(LAGE)
estat sd
svy: mean leisure_09, over(LAGE)
estat sd
svy: mean personalcare_09, over(LAGE)
estat sd
svy: mean residual_09, over(LAGE)
estat sd
svy: mean computer_09, over(LAGE)
estat sd

tab LAGE

svy: mean totaltime_09 if GENDER==1, over(LAGE)
estat sd
svy: mean work_09 if GENDER==1, over(LAGE)
estat sd
svy: mean homework_09 if GENDER==1, over(LAGE)
estat sd
svy: mean leisure_09 if GENDER==1, over(LAGE)
estat sd
svy: mean personalcare_09 if GENDER==1, over(LAGE)
estat sd
svy: mean residual_09 if GENDER==1, over(LAGE)
estat sd
svy: mean computer_09 if GENDER==1, over(LAGE)
estat sd

tab LAGE if GENDER==1

svy: mean totaltime_09 if GENDER==2, over(LAGE)
estat sd
svy: mean work_09 if GENDER==2, over(LAGE)
estat sd
svy: mean homework_09 if GENDER==2, over(LAGE)
estat sd
svy: mean leisure_09 if GENDER==2, over(LAGE)
estat sd
svy: mean personalcare_09 if GENDER==2, over(LAGE)
estat sd
svy: mean residual_09 if GENDER==2, over(LAGE)
estat sd
svy: mean computer_09 if GENDER==2, over(LAGE)
estat sd

tab LAGE if GENDER==2

*homework sub-categories
generate housework_09=A13_09+A14_09
generate vehiclemaint_09=(A33_09/30.4)*7
generate homeimp_09=(A31_09/30.4)*7
generate maintenance_09=homeimp_09+vehiclemaint_09

*housework
svy: mean housework_09, over(LAGE)
estat sd
svy: mean housework_09 if GENDER==1, over(LAGE)
estat sd
svy: mean housework_09 if GENDER==2, over(LAGE)
estat sd

*shopping/errands
svy: mean A16_09, over(LAGE)
estat sd
svy: mean A16_09 if GENDER==1, over(LAGE)
estat sd
svy: mean A16_09 if GENDER==2, over(LAGE)
estat sd

*cooking
svy: mean A17_09, over(LAGE)
estat sd
svy: mean A17_09 if GENDER==1, over(LAGE)
estat sd
svy: mean A17_09 if GENDER==2, over(LAGE)
estat sd

*yard work/gardening
svy: mean A15_09, over(LAGE)
estat sd
svy: mean A15_09 if GENDER==1, over(LAGE)
estat sd
svy: mean A15_09 if GENDER==2, over(LAGE)
estat sd

*maintenance
svy: mean maintenance_09, over(LAGE)
estat sd
svy: mean maintenance_09 if GENDER==1, over(LAGE)
estat sd
svy: mean maintenance_09 if GENDER==2, over(LAGE)
estat sd

*leisure sub-categories
generate exercise_09=A6_09+A7_09
generate relaxing_09=leisure_09-A1_09-exercise_09-A8_09

*watch TV
svy: mean A1_09, over(LAGE)
estat sd
svy: mean A1_09 if GENDER==1, over(LAGE)
estat sd
svy: mean A1_09 if GENDER==2, over(LAGE)
estat sd

*exercise
svy: mean exercise_09, over(LAGE)
estat sd
svy: mean exercise_09 if GENDER==1, over(LAGE)
estat sd
svy: mean exercise_09 if GENDER==2, over(LAGE)
estat sd

*socializing
svy: mean A8_09, over(LAGE)
estat sd
svy: mean A8_09 if GENDER==1, over(LAGE)
estat sd
svy: mean A8_09 if GENDER==2, over(LAGE)
estat sd

*relaxing (residual leisure)
svy: mean relaxing_09, over(LAGE)
estat sd
svy: mean relaxing_09 if GENDER==1, over(LAGE)
estat sd
svy: mean relaxing_09 if GENDER==2, over(LAGE)
estat sd

*median - work
table LAGE [pweight=LWGTR], c(med work_09) 
table LAGE if GENDER==1 [pweight=LWGTR], c(med work_09) 
table LAGE if GENDER==2 [pweight=LWGTR], c(med work_09)

*median - homework
table LAGE [pweight=LWGTR], c(med homework_09) 
table LAGE if GENDER==1 [pweight=LWGTR], c(med homework_09) 
table LAGE if GENDER==2 [pweight=LWGTR], c(med homework_09) 

*median - leisure
table LAGE [pweight=LWGTR], c(med leisure_09) 
table LAGE if GENDER==1 [pweight=LWGTR], c(med leisure_09) 
table LAGE if GENDER==2 [pweight=LWGTR], c(med leisure_09)

*correlation between market and home work
corr_svy work_09 homework_09 if LAGE>=49 & LAGE<=53 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=54 & LAGE<=58 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=59 & LAGE<=63 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=64 & LAGE<=68 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=64 [pweight=LWGTR]

corr_svy work_09 homework_09 if LAGE>=49 & LAGE<=53 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=54 & LAGE<=58 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=59 & LAGE<=63 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=64 & LAGE<=68 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=64 & GENDER==1 [pweight=LWGTR]

corr_svy work_09 homework_09 if LAGE>=49 & LAGE<=53 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=54 & LAGE<=58 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=59 & LAGE<=63 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=64 & LAGE<=68 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 homework_09 if LAGE>=64 & GENDER==2 [pweight=LWGTR]

*correlation between market work and leisure
corr_svy work_09 leisure_09 if LAGE>=49 & LAGE<=53 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=54 & LAGE<=58 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=59 & LAGE<=63 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=64 & LAGE<=68 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=64 [pweight=LWGTR]

corr_svy work_09 leisure_09 if LAGE>=49 & LAGE<=53 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=54 & LAGE<=58 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=59 & LAGE<=63 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=64 & LAGE<=68 & GENDER==1 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=64 & GENDER==1 [pweight=LWGTR]

corr_svy work_09 leisure_09 if LAGE>=49 & LAGE<=53 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=54 & LAGE<=58 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=59 & LAGE<=63 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=64 & LAGE<=68 & GENDER==2 [pweight=LWGTR]
corr_svy work_09 leisure_09 if LAGE>=64 & GENDER==2 [pweight=LWGTR]

*correlation between home work and leisure
corr_svy homework_09 leisure_09 if LAGE>=49 & LAGE<=53 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=54 & LAGE<=58 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=59 & LAGE<=63 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=64 & LAGE<=68 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=64 [pweight=LWGTR]

corr_svy homework_09 leisure_09 if LAGE>=49 & LAGE<=53 & GENDER==1 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=54 & LAGE<=58 & GENDER==1 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=59 & LAGE<=63 & GENDER==1 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=64 & LAGE<=68 & GENDER==1 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=64 & GENDER==1 [pweight=LWGTR]

corr_svy homework_09 leisure_09 if LAGE>=49 & LAGE<=53 & GENDER==2 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=54 & LAGE<=58 & GENDER==2 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=59 & LAGE<=63 & GENDER==2 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=64 & LAGE<=68 & GENDER==2 [pweight=LWGTR]
corr_svy homework_09 leisure_09 if LAGE>=64 & GENDER==2 [pweight=LWGTR]
