...
gen N = _n
sort N
save ip\FisherSuestredALO1, replace
...
gen N = _n
sort N
save ip\FisherSuestredALO2, replace
...
merge 1:1 N using ip\FisherSuestredALO2, nogenerate
merge 1:1 N using ip\FisherSuestALO3, nogenerate
drop ResF1-ResF5
merge 1:1 N using ip\FisherSuestredALO1, nogenerate
drop F*
svmat double F
aorder
save results\FisherSuestredALO, replace
