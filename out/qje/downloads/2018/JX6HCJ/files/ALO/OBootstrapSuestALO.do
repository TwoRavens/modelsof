...
svmat double F
gen N = _n
save ip\OBootstrapSuestALO1, replace
...
svmat double F
gen N = _n
save ip\OBootstrapSuestALO2, replace
...
svmat double F
gen N = _n
save ip\OBootstrapSuestALO3, replace

*****************************************
*****************************************

use ip\OBootstrapSuestALO1, clear
merge 1:1 N using ip\OBootstrapSuestALO2, nogenerate
merge 1:1 N using ip\OBootstrapSuestALO3, nogenerate
drop F*
svmat double F
aorder
save results\OBootstrapSuestALO, replace
