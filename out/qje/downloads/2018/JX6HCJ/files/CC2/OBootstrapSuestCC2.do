...
mata test = chi2tail(test[1,2],test[1,1]), cols(bb)-test[1,2], test[1,2], test[1,1], 2 ; st_matrix("test",test); st_matrix("dc",DC); bb1 = bb
matrix F = test
matrix DC = dc
...
svmat double DC
gen N = _n
save results\OBootstrapSuestCC2, replace
