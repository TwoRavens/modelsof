...
mata st_store(.,.,ResB)
gen N = _n
save ip\OJackknifeGMR1, replace
...
mata st_store(.,.,ResB)
gen N = _n
save ip\OJackknifeGMR2, replace
...
mata st_store(.,.,ResB)
gen N = _n
save ip\OJackknifeGMR3, replace
...
mata st_store(.,.,ResB)
gen N = _n
save ip\OJackknifeGMR4, replace
...
mata st_store(.,.,ResB)
gen N = _n
save ip\OJackknifeGMR5, replace

*******************************
*******************************

use ip\OJackknifeGMR1, clear
forvalues i = 2/5 {
	merge 1:1 N using ip\OJackknifeGMR`i', nogenerate
	}
aorder
svmat double B
save results\OJackknifeGMR, replace
