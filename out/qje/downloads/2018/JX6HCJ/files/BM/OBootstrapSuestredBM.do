...
mycmd (OPtestztreat1 OPtestztreat2 OPtestztreat4 OPtestztreat5 OPtreat1 OPtreat2 OPtreat4 OPtreat5) reg ref OPtestztreat1 OPtestztreat2 OPtestztreat4 OPtestztreat5 OPtreat1 OPtreat2 OPtreat4 OPtreat5 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtestz<6
...
mycmd (OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2) probit ref OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2 OPpuzzletypeA sumrefrain anyrain OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtreat<4 
...
mycmd (OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2) heckman OP_coworkers_REFrep OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtreat<4, select (sumrefrain anyrain OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend)
mycmd (OPtreat1 OPtreat2) heckman OP_relative_REFrep OPtreat1 OPtreat2 OPpuzzletypeA OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtreat<4, select (sumrefrain anyrain OPtreat1 OPtreat2 OPpuzzletypeA OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend)
mycmd (OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2) heckman OP_relative_REFrep OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtreat<4, select (sumrefrain anyrain OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend)
mycmd (OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2) heckman reftestz OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtreat<4, select (sumrefrain anyrain OPtestztreat1 OPtestztreat2 OPtreat1 OPtreat2 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend)
...
forvalues i = 1/$j {
	...
	if ( "`a'" ~= "[M5_OP_relative_REFrep]xxxOPtreat25" & "`a'" ~= "[M6_OP_relative_REFrep]xxxOPtreat16" & "`a'" ~= "[M6_OP_relative_REFrep]xxxOPtreat26" & "`a'" ~= "[M6_OP_relative_REFrep]xxxOPtestztreat16") { 
		global test = "$test" + " " + "`a'"
		matrix B3[1,`k'] = B[1,`i']
		local k = `k' + 1
		}
...
mycmd (OPtestztreat4 OPtestztreat5 OPtreat4 OPtreat5) probit ref OPtestztreat4 OPtestztreat5 OPtreat4 OPtreat5 OPpuzzletypeA sumrefrain anyrain OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtreat~=6 & OPtreat~=7 
...
mycmd (OPtestztreat4 OPtestztreat5 OPtreat4 OPtreat5) reg reftestz_e OPtestztreat4 OPtestztreat5 OPtreat4 OPtreat5 OPpuzzletypeA OPtestz OPAGEGRP2-OPAGEGRP9 OPed_cont ln_income OPravtest OPdigtest WKID2-WKID18 weekend if OPtreat~=6 & OPtreat~=7
...
svmat double F
gen N = _n
save results\OBootstrapSuestredBM, replace
