...
test OPtreat1 OPtreat2 OPtreat4 OPtreat5 OPpuzzletypeA FTreat4 OPtestzOPtreat1 OPtestzOPtreat2 OPtestzOPtreat4 OPtestzOPtreat5 
...
global list = ""
global list = "$list" + "[M1_ref]OPtreat1 [M1_ref]OPtreat2 [M1_ref]OPpuzzletypeA "
global list = "$list" + "[M2_ref]OPtreat1 [M2_ref]OPtreat2 [M2_ref]OPpuzzletypeA [M2_ref]OPtestzOPtreat1 [M2_ref]OPtestzOPtreat2 "
global list = "$list" + "[M3_OP_coworkers_REFrep]OPtreat1 [M3_OP_coworkers_REFrep]OPtreat2 [M3_OP_coworkers_REFrep]OPpuzzletypeA [M3_select]OPtreat1 [M3_select]OPtreat2 [M3_select]OPpuzzletypeA "
global list = "$list" + "[M4_OP_coworkers_REFrep]OPtreat1 [M4_OP_coworkers_REFrep]OPtreat2 [M4_OP_coworkers_REFrep]OPpuzzletypeA [M4_OP_coworkers_REFrep]OPtestzOPtreat1 [M4_OP_coworkers_REFrep]OPtestzOPtreat2 [M4_select]OPtreat1 [M4_select]OPtreat2 [M4_select]OPpuzzletypeA [M4_select]OPtestzOPtreat1 [M4_select]OPtestzOPtreat2 "
global list = "$list" + "[M5_OP_relative_REFrep]OPtreat1 [M5_OP_relative_REFrep]OPtreat2 [M5_OP_relative_REFrep]OPpuzzletypeA [M5_select]OPtreat1 [M5_select]OPtreat2 [M5_select]OPpuzzletypeA "
global list = "$list" + "[M6_OP_relative_REFrep]OPtreat1 [M6_OP_relative_REFrep]OPtreat2 [M6_OP_relative_REFrep]OPpuzzletypeA [M6_OP_relative_REFrep]OPtestzOPtreat1 [M6_OP_relative_REFrep]OPtestzOPtreat2 [M6_select]OPtreat1 [M6_select]OPtreat2 [M6_select]OPpuzzletypeA [M6_select]OPtestzOPtreat1 [M6_select]OPtestzOPtreat2 "
global list = "$list" + "[M7_reftestz]OPtreat1 [M7_reftestz]OPtreat2 [M7_reftestz]OPpuzzletypeA [M7_reftestz]OPtestzOPtreat1 [M7_reftestz]OPtestzOPtreat2 [M7_select]OPtreat1 [M7_select]OPtreat2 [M7_select]OPpuzzletypeA [M7_select]OPtestzOPtreat1 [M7_select]OPtestzOPtreat2"

foreach X in "[M6_OP_relative_REFrep]OPtreat1" "[M6_OP_relative_REFrep]OPtreat2" "[M6_OP_relative_REFrep]OPpuzzletypeA" "[M6_OP_relative_REFrep]OPtestzOPtreat1" "[M5_OP_relative_REFrep]OPtreat1" "[M5_OP_relative_REFrep]OPtreat2" {
...
test OPtreat4 OPtreat5 OPpuzzletypeA OPtestzOPtreat4 OPtestzOPtreat5
...
if (_rc == 0) {
	capture test OPtreat1 OPtreat2 OPtreat4 OPtreat5 OPpuzzletypeA FTreat4 OPtestzOPtreat1 OPtestzOPtreat2 OPtestzOPtreat4 OPtestzOPtreat5 
	if (_rc == 0) {
...
if (_rc == 0) {
	capture test OPtreat4 OPtreat5 OPpuzzletypeA OPtestzOPtreat4 OPtestzOPtreat5
	if (_rc == 0) {
...
gen N = _n
sort N
save results\FisherSuestBM, replace
