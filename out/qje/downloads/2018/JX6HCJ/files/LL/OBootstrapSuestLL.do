...
*bootstrapping at their clustering level
...
mata test = chi2tail(test[1,2],test[1,1]), cols(bb)-test[1,2], test[1,2], test[1,1], 1 ; st_matrix("test",test); st_matrix("dc",DC); bb1 = bb
matrix F = test
matrix DC = dc
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test =  bb*v*bb',sum(rowsum(abs(v)):>0)
mata test = chi2tail(test[1,2],test[1,1]), cols(bb)-test[1,2], test[1,2], test[1,1], 2 ; st_matrix("test",test); st_matrix("dc",DC); bb2 = bb
matrix F = F \ test
matrix DC = DC \ dc
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test =  bb*v*bb',sum(rowsum(abs(v)):>0)
mata test = chi2tail(test[1,2],test[1,1]), cols(bb)-test[1,2], test[1,2], test[1,1], 3 ; st_matrix("test",test); st_matrix("dc",DC); bb3 = bb
matrix F = F \ test
matrix DC = DC \ dc
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test =  bb*v*bb',sum(rowsum(abs(v)):>0)
mata test = chi2tail(test[1,2],test[1,1]), cols(bb)-test[1,2], test[1,2], test[1,1], 4 ; st_matrix("test",test); st_matrix("dc",DC); bb4 = bb
matrix F = F \ test
matrix DC = DC \ dc
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test =  bb*v*bb',sum(rowsum(abs(v)):>0)
mata test = chi2tail(test[1,2],test[1,1]), cols(bb)-test[1,2], test[1,2], test[1,1], 5 ; st_matrix("test",test); st_matrix("dc",DC); bb5 = bb
matrix F = F \ test
matrix DC = DC \ dc
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test =  bb*v*bb',sum(rowsum(abs(v)):>0)
mata test = chi2tail(test[1,2],test[1,1]), cols(bb)-test[1,2], test[1,2], test[1,1], 6 ; st_matrix("test",test); st_matrix("dc",DC); bb6 = bb
matrix F = F \ test
matrix DC = DC \ dc
...
sort uniqueid Order
gen N = 1
gen Dif = (uniqueid ~= uniqueid[_n-1])
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test = (bb-bb1)*v*(bb-bb1)',sum(rowsum(abs(v)):>0)
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test = (bb-bb2)*v*(bb-bb2)',sum(rowsum(abs(v)):>0)
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test = (bb-bb3)*v*(bb-bb3)',sum(rowsum(abs(v)):>0)
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test = (bb-bb4)*v*(bb-bb4)',sum(rowsum(abs(v)):>0)
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test = (bb-bb5)*v*(bb-bb5)',sum(rowsum(abs(v)):>0)
...
mata gg = select(G,Select'); bb = select(B,Select); v = ($ncluster/($ncluster-1))*gg*gg'; v = invsym(v); test = (bb-bb6)*v*(bb-bb6)',sum(rowsum(abs(v)):>0)
...
svmat double DC
gen N = _n
save results\OBootstrapSuestLL, replace
