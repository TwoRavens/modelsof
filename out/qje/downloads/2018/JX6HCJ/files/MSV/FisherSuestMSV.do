...
if (_rc == 0) {
	...
	mata b = st_matrix("b"); V = st_matrix("V"); b = b, sqrt(diagonal(V)); st_matrix("b",b)
	mata V = st_matrix("V"); v = invsym(V); test = sum(rowsum(abs(v)):>0), b[1...,1]'*v*b[1...,1]
...
gen N = _n
sort N
save ip\FisherSuestMSV1, replace
...
capture suest M1 M2 M3 M4 M5 M6 M7 M8 M9 M10 M11 M12 M13 M14 M15 M16 M17 M18 M19 M20 M21 M22 M23 M24 M25 M26 M27 M28 M29 M30 M31 M32 M33 M34 M35 M36 M37 M38 M39 M40 M41 M42, cluster(unique_05)
if (_rc == 0) {
	matrix V = e(V)
	matrix b = e(b)
	matrix b = SSS*b'
...
gen N = _n
sort N
save ip\FisherSuestMSV2, replace
...
capture suest M1 M2 M3 M4 M5 M6 M7 M8 M9 M10 M11 M12 M13 M14 M15 M16 M17 M18 M19 M20 M21 M22 M23 M24 M25 M26 M27 M28 M29 M30 M31 M32 M33 M34 M35 M36 M37 M38 M39 M40 M41 M42 M43 M44 M45 M46 M47 M48 M49 M50 M51 M52 M53 M54 M55 M56, cluster(unique_05)
if (_rc == 0) {
	matrix V = e(V)
	matrix b = e(b)
	matrix b = SSS*b'
...
gen N = _n
sort N
save ip\FisherSuestMSV3, replace

************************

use ip\FisherSuestMSV1, clear
merge 1:1 N using ip\FisherSuestMSV2, nogenerate
merge 1:1 N using ip\FisherSuestMSV3, nogenerate
drop F*
svmat double F
aorder
save results\FisherSuestMSV, replace
