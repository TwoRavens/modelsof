...
gen N = _n
sort N
save ip\FisherSuestDDK1, replace
...
gen N = _n
sort N
save ip\FisherSuestDDK2, replace
...
gen N = _n
sort N
save ip\FisherSuestDDK3, replace
...
use ip\FisherSuestDDK1, clear
merge 1:1 N using ip\FisherSuestDDK2, nogenerate
merge 1:1 N using ip\FisherSuestDDK3, nogenerate
drop F*
svmat double F
aorder
save results\FisherSuestDDK, replace
