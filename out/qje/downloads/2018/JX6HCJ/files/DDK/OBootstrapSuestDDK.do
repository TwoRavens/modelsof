...
svmat double F
gen N = _n
save ip\OBootstrapSuestDDK1, replace
...
svmat double F
gen N = _n
save ip\OBootstrapSuestDDK2, replace
...
svmat double F
gen N = _n
save ip\OBootstrapSuestDDK3, replace
...
merge 1:1 N using ip\OBootstrapSuestDDK2, nogenerate
merge 1:1 N using ip\OBootstrapSuestDDK3, nogenerate
drop F*
aorder
svmat double F
save results\OBootstrapSuestDDK, replace
