...
mata ResB[`c',1..166] = BB[.,1]'; ResSE[`c',1..166] = BB[.,2]'
...
mata FF = st_matrix("FF"); BB = st_matrix("BB")
mata ResF[`c',25..32] = FF[.,1]'; ResD[`c',25..32] = FF[.,2]'; ResDF[`c',25..32] = FF[.,3]'
mata ResB[`c',167..214] = BB[.,1]'; ResSE[`c',167..214] = BB[.,2]'
...
gen N = _n
sort N
save results\FisherGJKM, replace
