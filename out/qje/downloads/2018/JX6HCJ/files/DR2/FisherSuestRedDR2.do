...
test safe_box locked_box health_pot health_savings 
...
quietly suest M1 M2 M3 M4, cluster(id_harp_rosca)
test safe_box safe_box_prov safe_box_pb safe_box_fmarry  health_savings health_savings_prov health_savings_pb health_savings_fmarry 
...
if (_rc == 0) {
	capture test safe_box locked_box health_pot health_savings 
	if (_rc == 0) {
...
capture suest M1 M2 M3 M4, cluster(id_harp_rosca)
if (_rc == 0) {
	capture test safe_box safe_box_prov safe_box_pb safe_box_fmarry  health_savings health_savings_prov health_savings_pb health_savings_fmarry 
	if (_rc == 0) {
...
gen N = _n
sort N
save results\FisherSuestredDR2, replace
