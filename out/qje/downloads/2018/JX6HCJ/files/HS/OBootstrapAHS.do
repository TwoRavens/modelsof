...
svmat double B
gen N = _n
save ip\OBootstrapAHS1, replace
...
svmat double B
gen N = _n
save ip\OBootstrapAHS2, replace
...
svmat double B
gen N = _n
save ip\OBootstrapAHS3, replace

*********************************
*********************************

use ip\OBootstrapAHS2, clear
...
svmat double B
aorder
save results\OBootstrapAHS, replace
