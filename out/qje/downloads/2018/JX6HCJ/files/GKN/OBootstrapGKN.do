...
svmat double B
gen N = _n
save ip\OBootstrapGKN1, replace
...
svmat double B
gen N = _n
save ip\OBootstrapGKN2, replace
...
svmat double B
aorder
save results\OBootstrapGKN, replace
...
use results\OBootstrapGKN, clear
