*These programmes run in Stata 10
...
*id_number is individual observation in 1st file, multiple observations in 2nd 
*In order to sample consistently at level they specify (no clustering), sample at id_number
...
svmat double B
aorder
save results\JackKnifeCMS, replace
