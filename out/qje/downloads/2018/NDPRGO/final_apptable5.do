...
use C:\Users\ok9\Downloads\acs2014\completedata1964_acs_1940.dta 
...
cd C:\Users\ok9\Downloads\region
...
foreach q in 50 75 90  {
	...
	forvalues t = 1/10 {
		log using table4_byregall_bf_`q'_`t',text replace
		
		/*Conditional on Age*/	
 
		qreg pct black other age2-age6 regN == 1 [pw=perwt] if year==``t'', q(`q')
		qreg pct black other age2-age6 regM == 1 [pw=perwt] if year==``t'', q(`q')
		qreg pct black other age2-age6 regS == 1 [pw=perwt] if year==``t'', q(`q')
		qreg pct black other age2-age6 regW == 1 [pw=perwt] if year==``t'', q(`q')
...
foreach q in 50 75 90{
	...
	forvalues t = 1/10{
		log using table4_byregpos_bf_`q'_`t',text replace
