...
*******************************************************************************
use $dumpdir/outcomes_patent_eins_w2_cht_inventor.dta, clear
rename year applicationyear

drop wage_cht_inv_1996
drop wage_cht_inv_1997
drop wage_cht_inv_1998
...
g y=`y'
usd2014, var(wage_cht_inv_`y') yr(y) 
drop y
}
...
forv y=`firstyear'/`lastyear'{
replace wage_cht_inv_`y' = . if wage_cht_inv_`y'==0
}
...
save $dtadir/patent_eins_W2_cht_inv.dta, replace
