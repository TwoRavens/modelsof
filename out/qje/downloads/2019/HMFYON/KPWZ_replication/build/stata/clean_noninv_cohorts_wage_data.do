...
*******************************************************************************
use $dumpdir/outcomes_patent_eins_w2_cht_noninventor.dta, clear
rename year applicationyear

drop wage_cht_noninv_1996
drop wage_cht_noninv_1997
drop wage_cht_noninv_1998
...
g y=`y'
usd2014, var(wage_cht_noninv_`y') yr(y) 
drop y
}
...
save $dtadir/patent_eins_W2_cht_noninv.dta, replace
