...
*******************************************************************************
use $dumpdir/outcomes_patent_eins_w2_cht_male.dta, clear
rename year applicationyear

drop wage_cht_M_1996
drop wage_cht_M_1997
drop wage_cht_M_1998
...
g y=`y'
usd2014, var(wage_cht_M_`y') yr(y) 
drop y
}
...
forv y=`firstyear'/`lastyear'{
replace wage_cht_M_`y' = . if wage_cht_M_`y'==0
}
...
save $dtadir/patent_eins_W2_cht_M.dta, replace
