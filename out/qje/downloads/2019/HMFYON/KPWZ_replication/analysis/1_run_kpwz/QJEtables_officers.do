...
*******************************************************************************
*******************************************************************************
cd $outdir/QJEtables_officers
capture log close
log using "QJEtables_officers.log", text replace
...
wage_stay_p50*  wage_stay_p50_ind* wage_stay_p50_ind_appyr* wage_p50* wage_cht_p50*  ///
wage_cht_p50_ind* wage_cht_p50_ind_appyr*
...
sal* offcomp* wage_off* num_off* nonoffcomp* wb_nonoff* wageq4nonoff*  ///
wb_own* wb_nonown* ownerpay* nonowncomp* wage_own* wageq4nonown* pay_own* wage_nonown* num_own* num_ownw2*
...
pinv wage_pinv wage_p50 wage_cht_p50 wage_cht_p50_ind wage_cht_p50_ind_appyr, i(unmasked_tin) j(y)
...
gen wage_sal=sal/emp
gen wage_nonoff=wb_nonoff/emp
gen rat_nonoffcomp=nonoffcomp/emp
   
capture drop wage_off
gen wage_off=offcomp/emp


local i=1
foreach var of varlist wage_sal wage_off wage_nonoff rat_nonoffcomp wageq4nonoff wage_nonown wageq4nonown wage_ownw2 pay_own{
 ...
 *Baseline
 reghdfe `var' post_nQ5 post_Q5 postW_nQ5 postW_Q5, abs(FX2 unmasked_tin) cluster(group clus2)	
 ...
 nocons addtext($FX, YES, $FX3, YES, DQ, NO) addstat("Mean dep var",`mu',"Elasticity",`e')

 *Passthru
 reghdfe `var' post_nQ5 post_Q5 postW_nQ5 postW_Q5 if pass==1, abs(FX2 unmasked_tin) cluster(group clus2)	
