...
* This .do file plots event study results. The dependent variable is log(thousands of employees).
...
*--------- FIGURE 5 ---------*
	...
	import delimited using "$data/ES30/ES_firmFX_lnemp.csv", clear varn(1)
    ...
    * set values for figures
    ...
    loc c2 "ebblue"
    loc c3 "red"
    loc ytitle "log(thousands of employees)"
    loc coeff = 0.22
