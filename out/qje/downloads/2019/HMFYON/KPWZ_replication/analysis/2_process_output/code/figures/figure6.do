...
* This .do file plots event study results. The dependent variable is probability of patent grant.
...
*--------- FIGURE 6 ---------*
	...
	import delimited using "$data/ES30/ES_firmFX_granted.csv", clear varn(1)
    ...
    * set values for figures
    ...
    loc c2 "ebblue"
    loc c3 "red"
    loc ytitle "Probability of patent grant"
    loc coeff = 0.34
