...
/***************************************/
cd ..
import delimited "analysis/tables/tobler_weinburg/report_table_whitese_naive.csv", encoding(ISO-8859-1)
keep name varphi_est lambda_est 
rename name anccity
...
clear
import delimited "estimate/results/ancient/v20170924/twostep/noc/qa01Dropma02Known/main/report_table_twostepse.csv", encoding(ISO-8859-1) // coordinates for known cities
keep if lambda_se == 0
keep name varphi_est lambda_est 
rename name anccity
