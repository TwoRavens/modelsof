reg imschool ethnocentherm1 anger fear ang_ethno fear_ethno ideology authoritarian income3 education1 south age1 if baddata==0 [pw=weight] // model without weight
 ...
 */
 ...
 graph twoway hist ethnocentherm1, width(0.01) percent color(gs14) yaxis(2) ///
|| scatter where ethnocentherm1 if tag_ethnocentherm1, yaxis(2) ///
plotr(m(b 4)) ms(none) mlabcolor(gs5) mlabel(pipe) mlabpos(6) legend(off) ///
