...
*       Date:       September 2016                                       
*
*       Purpose:   	Do-file to replicate Figure 3 of the article
...
global cty_var b17.countryID 
	set more off
	logit tax_dummy   group_middle group_rich respect_polinst  gr_middleXrespect_polinst gr_richXrespect_polinst $x_var $cty_var, vce(cluster pais)
matrix list e(b)	
...
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat diff_lo diff_hi 
            using "sim_poormiddle_M5table1.dta", replace;
...
restore;
#delimit ;
merge using "sim_poormiddle_M5table1.dta";
...
graph twoway hist respect_polinst if wealth_group_3pais==2, percent color(gs14) yaxis(2)
        ...
        ||  ,   
            ...
            ylabel(-0.3(0.05)0.3 , axis(1) nogrid labsize(2))
            ...
            xtitle("Respect for public institutions", size(2.5))
			subtitle("Middle")
...
graph save Graph "sim_poormiddle_M5table1.gph", replace;
*/;
#delimit ;
...
postutil clear;
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat diff_lo diff_hi 
            using "sim_poorrich_M5table1.dta", replace;
...
merge using "sim_poorrich_M5table1.dta";
...
graph save Graph "sim_poorrich_M5table1.gph", replace;
*/;		


					
#delimit ;
graph combine 	"sim_poormiddle_M5table1.gph"
				"sim_poorrich_M5table1.gph" , 
scheme(s2mono) graphregion(fcolor(white) ilcolor(white) lcolor(white)) ;
