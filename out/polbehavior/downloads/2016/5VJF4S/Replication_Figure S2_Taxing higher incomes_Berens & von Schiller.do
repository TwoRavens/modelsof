...
*       Date:       September 2016                                       
*
*       Purpose:   	Do-file to replicate Figure S2 of the article
...
global cty_var b17.countryID 
	set more off
	logit tax_dummy   group_middle group_rich reliability_avs  gr_middleXreliability_avs gr_richXreliability_avs $xs_var $cty_var, vce(cluster pais)
matrix list e(b)	
...
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat diff_lo diff_hi 
            using "sim_poormiddle_M4table1_reliability.dta", replace;
...
*drop yline MV;
merge using "sim_poormiddle_M4table1_reliability.dta";
...
graph twoway hist reliability_avs if wealth_group_3pais==2, percent color(gs14) yaxis(2)
        ...
        ||  ,   
            ...
            ylabel(-0.4(0.05)0.4 , axis(1) nogrid labsize(2))
...
graph save Graph "sim_poormiddle_M4table1_reliability.gph", replace;
*/;
#delimit ;
...
postutil clear;
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat diff_lo diff_hi 
            using "sim_poorrich_M4table1_reliability.dta", replace;
...
*scalar h_wealth_group_3pais=1 ;
*scalar h_reliability_avs =.0168793;
scalar h_female =0 ;
scalar h_age=41;
scalar h_edu_years= 10 ;
scalar h_public_empl=0 ;
...
merge using "sim_poorrich_M4table1_reliability.dta";
...
graph save Graph "sim_poorrich_M4table1_reliability.gph", replace;
*/;		


					
#delimit ;
graph combine	"sim_poormiddle_M4table1_reliability.gph" 
				"sim_poorrich_M4table1_reliability.gph" 
				, scheme(s2mono) graphregion(fcolor(white) ilcolor(white) lcolor(white));
