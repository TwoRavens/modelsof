...
log using  "/Users/Jeff/Dropbox/BirthLegaciesConflict/D5/Analysis/Models/AgeInteraction/ISWar/ISWarProb.log", replace;
...
heckprob2 ISWarWin legacy agel legacy_agel Euro Africa  , sel(ISWarOnset = legacy agel legacy_agel Euro Africa  contig_any   time_iswar time2_iswar  time3_iswar);
...
save  "/Users/Jeff/Dropbox/BirthLegaciesConflict/D5/Analysis/Models/AgeInteraction/ISWar/SimISWar", replace ;
...
use  "/Users/Jeff/Dropbox/BirthLegaciesConflict/D5/Analysis/Models/AgeInteraction/ISWar/SimISWar", clear;
...
postfile mypost prob_hat0 lo0 hi0 prob_hat1 lo1 hi1 diff_hat diff_lo diff_hi probI_hat0 loI0 hiI0 probI_hat1 loI1 hiI1 diffI_hat diffI_lo diffI_hi
                probW_hat0 loW0 hiW0 probW_hat1 loW1 hiW1 diffW_hat diffW_lo diffW_hi using SimISWarProb, replace;
...
use SimISWarProb, clear;

gen ruler =_n;

saveold SimISWarProb, replace;
