	...
	**					Bourbon Mexico
	** 	
	**		DETAILS: 	This code produces Table 1: The Effect of 
	**					the Mining Tribunal on Civil Administration 
	**					(1759-1786)
	**					
	**
	** 
...
*-------------------------------------------------------------------------------
* Table 1: The Effect of the Mining Tribunal on Civil Administration (1759-1786)
*-------------------------------------------------------------------------------
...
esttab using "`tablesdir'Table1.tex",
