	...
	**					Bourbon Mexico
	** 	
	**		DETAILS: 	This code produces Table B.2.2: The Effect 
	**					of the Mining Tribunal on Tax Revenue from 
	**					Trade and Agriculture, Bourbon Period 
	**					(1714-1810)
	**
	** 
	**
...
*-------------------------------------------------------------------------------
* Table B.2.2: 	The Effect of the Mining Tribunal on Tax Revenue from 
*				Trade and Agriculture, Bourbon Period (1714-1810)
*-------------------------------------------------------------------------------
...
esttab using "`tablesdir'TableB2_2.tex",
