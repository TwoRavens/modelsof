	...
	**					Bourbon Mexico
	** 	
	**		DETAILS: 	This code produces Table B.1.1: Parallel 
	**					Trends in Civil Administration and Tax 
	**					Revenue from Trade and Agriculture (1759-1776)
	**					
	**
	** 
	**
...
*-------------------------------------------------------------------------------
* Table B.1.1: 	Parallel Trends in Civil Administration and Tax Revenue from 
*				Trade and Agriculture (1759-1776)
*-------------------------------------------------------------------------------
...
esttab using "`tablesdir'TableB1_1.tex",
