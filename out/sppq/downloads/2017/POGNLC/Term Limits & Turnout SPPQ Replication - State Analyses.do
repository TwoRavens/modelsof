***Table 2 Regression Analyses - Turnout Rates (All States)***
reg turnout tlness lcr2 mmds regd straight iuse2 squire ranney income2 diversity3 preselec redistrict year, robust
...
***Table 2 Regression Analyses - Turnout Rates (TL States)***
reg turnout tlness lcr2 mmds regd straight iuse2 squire ranney income2 diversity3 preselec redistrict year if tlstate==1, robust
***Calculating p-values from one tailed signifance tests for directional hypotheses***
test _b[tlness]=0
local sign_tlness = sign(_b[tlness])
display "one-tailed p-value = " ttail(r(df_r),`sign_tlness'*sqrt(r(F)))
...
local sign_redistrict = sign(_b[redistrict])
display "one-tailed p-value = " ttail(r(df_r),`sign_redistrict'*sqrt(r(F)))
***Table 3 Regression Analyses - Roll-off Rates (All States)***
reg rolloff tlness lcr2 mmds regd straight iuse2 squire ranney income2 diversity3 preselec redistrict year, robust
***Calculating p-values from one tailed signifance tests for directional hypotheses***
test _b[tlness]=0
local sign_tlness = sign(_b[tlness])
display "one-tailed p-value = " 1-ttail(r(df_r),`sign_tlness'*sqrt(r(F)))
test _b[lcr2]=0
local sign_lcr2 = sign(_b[lcr2])
display "one-tailed p-value = " 1-ttail(r(df_r),`sign_lcr2'*sqrt(r(F)))
test _b[mmd]=0
local sign_mmd = sign(_b[mmd])
display "one-tailed p-value = " ttail(r(df_r),`sign_mmd'*sqrt(r(F)))
test _b[straight]=0
local sign_straight = sign(_b[straight])
display "one-tailed p-value = " 1-ttail(r(df_r),`sign_straight'*sqrt(r(F)))
test _b[squire]=0
local sign_squire = sign(_b[squire])
display "one-tailed p-value = " 1-ttail(r(df_r),`sign_squire'*sqrt(r(F)))
test _b[preselec]=0
local sign_preselec = sign(_b[preselec])
display "one-tailed p-value = " ttail(r(df_r),`sign_preselec'*sqrt(r(F)))
test _b[redistrict]=0
local sign_redistrict = sign(_b[redistrict])
display "one-tailed p-value = " 1-ttail(r(df_r),`sign_redistrict'*sqrt(r(F)))
***Table 3 Regression Analyses - Roll-off Rates (TL States)***
reg rolloff tlness lcr2 mmds regd straight iuse2 squire ranney income2 diversity3 preselec redistrict year if tlstate==1, robust
***Calculating p-values from one tailed signifance tests for directional hypotheses***
test _b[tlness]=0
local sign_tlness = sign(_b[tlness])
display "one-tailed p-value = " 1-ttail(r(df_r),`sign_tlness'*sqrt(r(F)))
