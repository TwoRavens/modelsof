...
*Candidate Disagreement
	...
	*# Agreeing Respondents
		...
		replace d1_agree = 1 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 3
		replace d1_agree = 1 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 1
		replace d1_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc1Part == 1
		replace d1_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc1Part == 3
		replace d1_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc1Part == 4
		replace d1_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 1
		replace d1_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 2
		replace d1_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 4
		replace d1_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 2
		replace d1_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 3
		replace d1_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 4
		...
		replace d2_agree = 1 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 3
		replace d2_agree = 1 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 1
		replace d2_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc2Part == 1
		replace d2_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc2Part == 3
		replace d2_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc2Part == 4
		replace d2_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 1
		replace d2_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 2
		replace d2_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 4
		replace d2_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 2
		replace d2_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 3
		replace d2_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 4
		...
		replace d3_agree = 1 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 3
		replace d3_agree = 1 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 1
		replace d3_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc3Part == 1
		replace d3_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc3Part == 3
		replace d3_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc3Part == 4
		replace d3_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 1
		replace d3_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 2
		replace d3_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 4
		replace d3_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 2
		replace d3_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 3
		replace d3_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 4
		label var d3_agree "D3: Same Cand Pref?"
		label values d3_agree agre
		
		gen d4_agree = . 
		replace d4_agree = 1 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 2
		replace d4_agree = 1 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 3
		replace d4_agree = 1 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 1
		replace d4_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 1
		replace d4_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 3
		replace d4_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 4
		replace d4_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 1
		replace d4_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 2
		replace d4_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 4
		replace d4_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 2
		replace d4_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 3
		replace d4_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 4
		label var d4_agree "D4: Same Cand Pref?"
		label values d4_agree agre
		
		gen d5_agree = . 
		replace d5_agree = 1 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 2
		replace d5_agree = 1 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 3
		replace d5_agree = 1 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 1
		replace d5_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 1
		replace d5_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 3
		replace d5_agree = 0 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 4
		replace d5_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 1
		replace d5_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 2
		replace d5_agree = 0 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 4
		replace d5_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 2
		replace d5_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 3
		replace d5_agree = 0 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 4
	...
	*Candidate **Disagreement
		...
		gen d1_dagree = . 
		replace d1_dagree = 0 if H_Vote92 == 1 & Z_US92_E_Disc1Part == 2
		replace d1_dagree = 0 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 3
		replace d1_dagree = 0 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 1
		replace d1_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc1Part == 1
		replace d1_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc1Part == 3
		replace d1_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc1Part == 4
		replace d1_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 1
		replace d1_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 2
		replace d1_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc1Part == 4
		replace d1_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 2
		replace d1_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 3
		replace d1_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc1Part == 4
		label var d1_dagree "D1: Same Cand Pref?"
		label values d1_dagree disa
	
			
		gen d2_dagree = . 
		replace d2_dagree = 0 if H_Vote92 == 1 & Z_US92_E_Disc2Part == 2
		replace d2_dagree = 0 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 3
		replace d2_dagree = 0 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 1
		
		replace d2_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc2Part == 1
		replace d2_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc2Part == 3
		replace d2_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc2Part == 4
		replace d2_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 1
		replace d2_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 2
		replace d2_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc2Part == 4
		replace d2_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 2
		replace d2_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 3
		replace d2_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc2Part == 4
		label var d2_dagree "D2: Same Cand Pref?"
		label values d2_dagree disa
	
	
		gen d3_dagree = . 
		replace d3_dagree = 0 if H_Vote92 == 1 & Z_US92_E_Disc3Part == 2
		replace d3_dagree = 0 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 3
		replace d3_dagree = 0 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 1
		
		replace d3_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc3Part == 1
		replace d3_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc3Part == 3
		replace d3_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc3Part == 4
		replace d3_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 1
		replace d3_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 2
		replace d3_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc3Part == 4
		replace d3_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 2
		replace d3_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 3
		replace d3_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc3Part == 4
		label var d3_dagree "D3: Same Cand Pref?"
		label values d3_dagree disa
		
		gen d4_dagree = . 
		replace d4_dagree = 0 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 2
		replace d4_dagree = 0 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 3
		replace d4_dagree = 0 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 1
		
		replace d4_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 1
		replace d4_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 3
		replace d4_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc4Part == 4
		replace d4_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 1
		replace d4_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 2
		replace d4_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc4Part == 4
		replace d4_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 2
		replace d4_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 3
		replace d4_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc4Part == 4
		label var d4_dagree "D4: Same Cand Pref?"
		label values d4_dagree disa
		
		gen d5_dagree = . 
		replace d5_dagree = 0 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 2
		replace d5_dagree = 0 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 3
		replace d5_dagree = 0 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 1
		
		replace d5_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 1
		replace d5_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 3
		replace d5_dagree = 1 if H_Vote92 == 1 & Z_US92_E_Disc5Part == 4
		replace d5_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 1
		replace d5_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 2
		replace d5_dagree = 1 if H_Vote92 == 3 & Z_US92_E_Disc5Part == 4
		replace d5_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 2
		replace d5_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 3
		replace d5_dagree = 1 if H_Vote92 == 5 & Z_US92_E_Disc5Part == 4
