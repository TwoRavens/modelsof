/*
Do file for replicating the results of Table 4 in Appendix C
using an alternative measure of success
*/
...
use "Lektzian_Patterson_Political_Cleavages_and_Economic_Sanctions.dta", clear
	...
	* Sanction Years Data
		logit success TradeOpenPKM CdAbtoMdSc TOPKMCdAbtoMdSc  ///
...
use "Lektzian_Patterson_Political_Cleavages_and_Economic_Sanctions.dta", clear
	...
	* Sanction Years Data
		logit success TradeOpenPKM CdSctoAbMd TOPKMCdSctoAbMd  ///
		STEcCstMS numsansenders USSen MZTotMIDCountTS    ///
		ATatopallyTSP Inst POLpolity2 time time2 time3 , cluster(caseid)
