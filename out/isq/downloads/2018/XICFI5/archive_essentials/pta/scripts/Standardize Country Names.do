...
replace countryname = "Afghanistan" if countryname == "Afgan"
...
replace countryname = "Antigua & Barbuda" if countryname == "Antigua&Barbuda"
...
replace countryname = "Antilles" if countryname == "NETHERLANDS ANTILLES" 
replace countryname = "Antilles" if countryname == "Nethantilles"
...
replace countryname = "Austria" if countryname == "Austria (1919+)"
...
replace countryname = "Bosnia-Herzegovina" if countryname == "Bosnia And Herzegovina (1992+)"
...
replace countryname = "Bosnia-Herzegovina" if countryname == "Bosniaandherz."
...
replace countryname = "Central African Republic" if countryname == "Central Afr.R."
replace countryname = "Central African Republic" if countryname == "Centralafrep"
...
replace countryname = "Comoros" if countryname == "Comorois"
...
replace countryname = "Congo, Democratic Republic of (Zaire)" if countryname == "Democratic Republic Of Congo (Zaire)"
replace countryname = "Congo, Democratic Republic of (Zaire)" if countryname == "Democratic Republic Of Congo (Zaire)"
replace countryname = "Congo, Democratic Republic of (Zaire)" if countryname == "Congo, The Democratic Republic Of"
...
replace countryname = "Cote D'Ivoire" if countryname == "Ivorycoast"
...
replace countryname = "Croatia" if countryname == "croatia"
replace countryname = "Croatia" if countryname == "Croatia (1991+)"
...
replace countryname = "Czechoslovakia" if countryname == "Czechos"
...
replace countryname = "Dominican Republic" if countryname == "Domrep"
...
replace countryname = "Equatorial Guinea" if countryname == "Eqguinea"
...
replace countryname = "Federated States of Micronesia" if countryname == "Micronesia,Fed. States                                                     "
capture replace microstateinyeart_g=1 if countryname=="Federated States of Micronesia" & year >=1986
...
replace countryname = "Hungary" if countryname == "Hungary (1918+)"
...
replace countryname = "Korea, People's Republic of" if countryname == "Korea, Dpr"
replace countryname = "Korea, People's Republic of" if countryname == "Korea Dem.People'S Rep."
replace countryname = "Korea, People's Republic of" if countryname == "People'S Republic Of Korea"
replace countryname = "Korea, People's Republic of" if countryname == "Korea North (1949+)"
...
replace countryname = "Korea, Republic of" if countryname == "Korea, Rep.                                                                "
replace countryname = "Korea, Republic of" if countryname == "Korea,Republic Of"
replace countryname = "Korea, Republic of" if countryname == "Korea South (1949+)"
...
replace countryname = "Kyrgyz Republic" if countryname == "Kyrgyzrep"
...
replace countryname = "Macedonia (Former Yugoslav Republic of)" if countryname == "The Former Yugoslav Republic of Macedonia"
replace countryname = "Macedonia (Former Yugoslav Republic of)" if countryname == "The Fmr Yug Rep Macedonia"
replace countryname = "Macedonia (Former Yugoslav Republic of)" if countryname == "Macedonia Fyr (1991+)"
replace countryname = "Macedonia (Former Yugoslav Republic of)" if countryname == "Macedonia, The Former Yugoslav Republic Of"
capture replace stateinyeart_g=1 if countryname=="Macedonia (Former Yugoslav Republic of)" & year >=1991

replace countryname = "Madagascar (Malagasy)" if countryname == "Madagasgar"
...
replace countryname = "Marshall Islands" if countryname == "Marshallis"
...
replace countryname = "Papua New Guinea" if countryname == "Papuang"
...
replace countryname = "Samoa/Western Samoa" if countryname == "Wsamoa"
...
replace countryname = "Sao Tome and Principe" if countryname == "Saot&P"
...
replace countryname = "Slovakia" if countryname == "Slovakrep"
...
replace countryname = "Slovenia" if countryname == "Slovenia (1991+)"
capture replace stateinyeart_g=1 if countryname=="Slovenia" & year >=1991

replace countryname = "Solomon Islands" if countryname == "Solomanis"
...
replace countryname = "Somalia" if countryname == "Somolia"
...
replace countryname = "Trinidad and Tobago" if countryname == "Trin&Tobago"
...
replace countryname = "United Arab Emirates" if countryname == "Uarabemir"
...
replace countryname = "United States of America" if countryname == "Us"
...
replace countryname = "Vietnam, Democratic Republic of" if countryname =="Democratic Republic Of Vietnam"
...
replace countryname = "Vietnam, Republic of" if countryname =="Republic Of Vietnam"
...
replace countryname = "Yemen, People's Republic of" if countryname == "Yemenpdr"
...
replace countryname = "Yemen, People's Republic of" if countryname == "People'S Republic Of Yemen"
