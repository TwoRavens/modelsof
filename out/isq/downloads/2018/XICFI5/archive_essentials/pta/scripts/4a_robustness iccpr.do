...
log using "pta/results/4_iccpr pta models robustness.smcl", replace
cd "pta/madedata"
...
** Without Matching
  ** treaty members
    ** Original specification
	...
	capture noisily  logit pta012345 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
    capture noisily  logit pta012 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
    capture noisily  logit pta123 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
	
    ** L1 controls only
	capture noisily  logit pta012345 treated l1* if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
    capture noisily  logit pta012 treated l1* if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
    capture noisily  logit pta123 treated l1* if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
	
    ** Random Effects
    capture noisily  xtlogit pta012345 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, re l(90) iter(200)
    capture noisily  xtlogit pta012 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, re l(90) iter(200)
    capture noisily  xtlogit pta123 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, re l(90) iter(200)
	
    ** Fixed Effects
    capture noisily  xtlogit pta012345 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, fe l(90) iter(200)
    capture noisily  xtlogit pta012 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, fe l(90) iter(200)
    capture noisily  xtlogit pta123 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, fe l(90) iter(200)
	...
	** one year outcome
    capture noisily  logit f1nohs_rat2_onset2 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
    capture noisily  logit f2nohs_rat2_onset2 treated l1* `lags' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
...
** non-ratification episode data
  ** treaty members
	...
	*local ctrls physint polity2_04 polconiiiA  ptadum_new llntradenew llnGDP_gled08 ldGDP_gled08V2 larmconflict latopally fmrcol_new lcontig_new lndistance lheg_new pcw89 llnGDPratio_g onsetperc2 lnewgatt i.region nohs2_ptaonsp1_r2 nohs2_ptaonsp2_r2 nohs2_ptaonsp3_r2
    ...
    capture noisily  logit pta treat012345 `ctrls' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
    capture noisily  logit pta treat012 `ctrls' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
    capture noisily  logit pta treat123 `ctrls' if iccprname_1==1 & iccprname_2==0, cluster(dyadid) l(90) iter(200)
	
    ** L1 controls only
    ** NA
   
    ** Random Effects
    capture noisily  xtlogit pta treat012345 `ctrls' if iccprname_1==1 & iccprname_2==0, re l(90) iter(200)
    capture noisily  xtlogit pta treat012 `ctrls' if iccprname_1==1 & iccprname_2==0, re l(90) iter(200)
    capture noisily  xtlogit pta treat123 `ctrls' if iccprname_1==1 & iccprname_2==0, re l(90) iter(200)
	
    ** Fixed Effects
    capture noisily  xtlogit pta treat012345 `ctrls' if iccprname_1==1 & iccprname_2==0, fe l(90) iter(200)
    capture noisily  xtlogit pta treat012 `ctrls' if iccprname_1==1 & iccprname_2==0, fe l(90) iter(200)
    capture noisily  xtlogit pta treat123 `ctrls' if iccprname_1==1 & iccprname_2==0, fe l(90) iter(200)
