...
gen treat = 0 
replace treat = 1 if catname_2[_n]==1 & catname_2[_n-1]==0 & (name_1[_n]==name_1[_n-1]) & (name_2[_n]==name_2[_n-1]) & ((year[_n-1]+1)==year[_n])
...
** xi: areg imports i.year catname_2 physint1 empinx1 gattFF gattFO ptarecip ptanonrecip gsp currencyunion colorbit gdp distance share_language share_border landlocked island land_area if OECD==1 & OECDname2==0, absorb(directed_dyad_id) cluster(directed_dyad_id) robust
...
local controls imports catname_2 physint1 empinx1 gattFF gattFO ptarecip ptanonrecip gsp currencyunion colorbit gdp distance share_language share_border landlocked island land_area 
...
local keepme name_1 name_2 directed_dyad_id year f1* f2* f3* f4* f5* l1* l2* l3* l4* l5*  ///
             imports catname_2 physint1 empinx1 gattFF gattFO ptarecip ptanonrecip gsp currencyunion colorbit gdp distance share_language share_border landlocked island land_area ///
             elig catname_1 eimports
...
gen dropme = 0
replace dropme = 1 if catname_2==1
foreach i of numlist 1/6 {
  replace dropme = 1 if catname_2[_n+`i']==1 & (name_1[_n]==name_1[_n+`i']) & (name_2[_n]==name_2[_n+`i']) & (year[_n]+`i'==year[_n+`i'])
}
...
save "trade/madedata/alltradeCAT.dta", replace
...
library(foreign)
dat <- read.dta("trade/madedata/alltradeCAT.dta", convert.underscore=T)
...
for(i in 1:ncol(dat)){
  if(length(grep("l1",names(dat)[i]))>0){
    ...
    if(names(dat)[i]=="l1catname.2"){next}
...
#setwd("C:\\Documents and Settings\\Rich\\Desktop\\Rewards for Ratification\\Matching analysis")
library(foreign)
#write.dta(mout$match.dat,"trade/madedata/mahmatches_CATtrade.dta")

write.dta(cdat,"trade/madedata/mahmatchescaliper_CATtrade.dta")
...
use "trade/madedata/mahmatchescaliper_CATtrade.dta", clear

xtset directed_dyad_id


** This is trade between OECD treaty ratifiers and non-OECD countries
xtreg imports012345 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
table treated if e(sample)==1

xtreg imports012345 treated l1* l2* l3* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
table treated if e(sample)==1

** This is all trade with all countries
xtreg imports012345 treated l1* l2* l3* if catname_1==1, cluster(directed_dyad_id) robust re
table treated if e(sample)==1

** with OECDname2==0 and treaty members
xtreg imports012345 treated l1* l2* l3* if OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
table treated if e(sample)==1


** 21 May 2012 -- Additional robustness checks
log using "trade/results/trade_CAT.smcl", replace
...
xtreg imports012 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
xtreg imports123 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
...
** No controls
reg imports012345 treated if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust
reg imports012 treated if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust
reg imports123 treated if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust
...
** Fixed effects
areg imports012345 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, a(directed_dyad_id)
areg imports012 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, a(directed_dyad_id)
areg imports123 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, a(directed_dyad_id)
...
xtreg diffimports01234 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
xtreg diffimports012 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
xtreg diffimports123 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
...
xtreg imports treated l1* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
...
xtreg f1imports treated imports physint1 empinx1 gattFF gattFO ptarecip ptanonrecip gsp currencyunion gdp distance  share_language  share_border  landlocked island land_area if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
...
xtreg imports21012 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
xtreg imports210 treated l1* l2* l3* l4* l5* if OECD==1 & OECDname2==0 & catname_1==1, cluster(directed_dyad_id) robust re
...
use "trade/madedata/alltradeCAT.dta", clear
xtset directed_dyad_id
