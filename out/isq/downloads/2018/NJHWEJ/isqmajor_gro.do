...
generate z_gammahi = MG_b11*(`a')
					...
					+ MG_b14*g_d_un
					+ MG_b15*g_du_gov
					+ MG_b16*(g_d_gro+0.022)
					+ MG_b17*(g_dg_gov+0.022)*(`a')
					+ MG_b18*g_cap_1;
