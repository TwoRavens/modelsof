	...
	**
	**		DETAILS: 	This code prepares Table B.4: Crop 
	**					Suitability (1961-1990) and Present-Day 
	**					Production (2013), Part 2
	**					
	** 
	**
	**				
...
*-------------------------------------------------------------------------------
* Table B.4: Crop Suitability (1961-1990) and Present-Day Production (2013) Pt.2
*-------------------------------------------------------------------------------
...
esttab using "`tablesdir'15_TableB4.tex",
...
mtitles("Barley" "Barley" "Cacao" "Cacao" "Coffee" "Coffee" "Cotton" "Cotton")
stats(mean sd r2 N, 
