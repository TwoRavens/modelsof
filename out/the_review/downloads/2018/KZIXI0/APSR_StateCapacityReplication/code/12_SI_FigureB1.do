	...
	**
	**		DETAILS: 	This code prepares Figure B.1: Share of 
...
*-------------------------------------------------------------------------------
* Figure B.1: Share of Planted Area (2013) & Crop Suitability (1961-1990)
*			  (Wheat, Maize, Sugarcane, Rice, Banana)
*-------------------------------------------------------------------------------


local crops "wheat maize sugar banana rice" 
...
twoway (scatter sharesemb_sample_`crop' suit_`crop', 
	...
	graph export "`figuresdir'12_FigureB1_`crop'.pdf", replace;
#delimit cr	
}
