	...
	**
	**		DETAILS: 	This code prepares Table 4: Commodity Shocks 
	**					and Long Term Local State Capacity
	**					
	**					
	** 
	**
...
*-------------------------------------------------------------------------------
* Table 4: Commodity Shocks and Long Term Local State Capacity
*-------------------------------------------------------------------------------
...
eststo: reg ap2000per1000 Llogwmean_shockma10 Dwmean_shockma10 logpop1930 	///
...
eststo: xi: reg ap2000per1000 Llogwmean_shockma10 Dwmean_shockma10 			///
...
eststo: reg prtax Llogwmean_shockma10 Dwmean_shockma10 logpop1930 			///
	apper1930 logarea loc_ha1930 prpop_agr1930 prpop_ciudad1930 			///
	if hac1930==1 & year==1940, r
...
eststo: xi: reg prtax Llogwmean_shockma10 Dwmean_shockma10 logpop1930 		///
...
esttab using "`tablesdir'8_Table4.tex",
