	...
	**
	**		DETAILS: 	This code prepares Table C.10: Commodity 
...
*-------------------------------------------------------------------------------
* Table C.10: Commodity Shocks and Local Bureaucrats (1940)
*			  Excluding Commodity Potential (1920s)
*-------------------------------------------------------------------------------
...
eststo: reg aplocper1000 Dwmean_shockma10 									///
...
eststo: reg aplocper1000 Dwmean_shockma10 apper1930 logarea 				///
...
eststo: reg apper1000 Dwmean_shockma10 										///
	if hac1930==1 & year==1940, r
...
eststo: reg apper1000 Dwmean_shockma10 apper1930 logarea 					///
	loc_ha1930 logpop1930 prpop_agr1930 prpop_ciudad1930 					///
	if hac1930==1 & year==1940, r
egen apper1000_mean=mean(apper1000) if e(sample)==1
egen apper1000_sd=sd(apper1000) if e(sample)==1
...
eststo: reg repartoriegocum Dwmean_shockma10 repartoriegocum1930 			///
	if hac1930==1 & year==1940, r
...
eststo: reg repartoriegocum Dwmean_shockma10 logarea loc_ha1930 			///
	logpop1930 prpop_agr1930 prpop_ciudad1930 repartoriegocum1930 			///
	if hac1930==1 & year==1940, r
egen repartoriegocum_mean=mean(repartoriegocum) if e(sample)==1
egen repartoriegocum_sd=sd(repartoriegocum) if e(sample)==1
qui sum repartoriegocum_mean
...
esttab using "`tablesdir'29_TableC10.tex",
b(a2) replace keep(Dwmean_shockma10 logpop1930 								///
