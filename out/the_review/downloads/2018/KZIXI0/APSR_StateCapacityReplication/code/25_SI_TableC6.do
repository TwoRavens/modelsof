	...
	**
	**		DETAILS: 	This code prepares Table C.6: Commodity 
...
*-------------------------------------------------------------------------------
* Table C.6: Commodity Shocks and Bureaucrats
*			 Spatial Dependence of Errors
*-------------------------------------------------------------------------------
...
eststo: reg2hdfespatial apper1000 logwmean_shockma10 						///
	if hac1930==1 & e(sample)==1, 											///
	lat(lat) lon(lon) t(year) p(cve_geoest) dist(500) lag(50)
qui areg apper1000 logwmean_shockma10 y1940 								///
...
eststo: reg2hdfespatial apper1000 logwmean_shockma10 y1940logarea			/// 
	y1940logpop1930 y1940loc_ha1930 y1940prpop_agr1930 						///
	y1940shock_1930 y1940prpop_ciudad1930   								///
	if hac1930==1, lat(lat) lon(lon) t(year) p(cve_geoest) dist(1200) lag(1000)
qui areg apper1000 logwmean_shockma10 y1940 y1940logarea y1940logpop1930	/// 
	y1940loc_ha1930 y1940prpop_agr1930 y1940prpop_ciudad1930 				///
	y1940shock_1930   if e(sample)==1, cl(cve_geoest) a(cve_geoest)
...
eststo: reg2hdfespatial apper1000 logwmean_shockma10 y1940logarea		 	///
	y1940logpop1930 y1940loc_ha1930 y1940prpop_agr1930 						///
	y1940prpop_ciudad1930 y1940shock_1930   								///
...
eststo: reg2hdfespatial apper1000 logwmean_shockforma10 y1940logarea 		///
	y1940logpop1930 y1940loc_ha1930 y1940prpop_agr1930 						///
	y1940prpop_ciudad1930 y1940shock_1930   								///
	if hac1930==1, lat(lat) lon(lon) t(year) p(cve_geoest) dist(1200) lag(1000)
qui areg apper1000 logwmean_shockforma10 y1940 y1940logarea 				///
	y1940logpop1930 y1940loc_ha1930 y1940prpop_agr1930 						///
	y1940prpop_ciudad1930 y1940shock_1930   								///
	if  e(sample)==1, cl(cve_geoest) a(cve_geoest)	
...
esttab using "`tablesdir'25_TableC6.tex",
