 ...
 * Model 1 *
 reg d.mood l.mood d.iv1 l.iv1 d.iv3 l.iv3 d.iv4 l.iv4

  * Model 1 coefficient values
 scalar m1a1 = _b[l.mood]
 scalar m1b0 = _b[d.iv1]
 scalar m1b1 = _b[l.iv1]
 scalar m1b2 = _b[d.iv3]
 scalar m1b3 = _b[l.iv3]
 scalar m1b4 = _b[d.iv4]
 scalar m1b5 = _b[l.iv4]
 * Model 1 standard errors
 scalar m1sea1 = _se[l.mood]
 scalar m1se0 = _se[d.iv1]
 scalar m1se1 = _se[l.iv1]
 scalar m1se2 = _se[d.iv3]
 scalar m1se3 = _se[l.iv3]
 scalar m1se4 = _se[d.iv4]
 scalar m1se5 = _se[l.iv4]
 ...
 * Model 3 *
 reg d.mood l.mood d.iv1 l.iv1 d.iv2 l.iv2 d.iv3 l.iv3 d.iv4 l.iv4

  * Model 3 coefficient values
 scalar m3a1 = _b[l.mood]
 ...
 scalar m3b6 = _b[d.iv4]
 scalar m3b7 = _b[l.iv4]
 * Model 3 standard errors
 scalar m3sea1 = _se[l.mood]
 ...
 scalar m3se6 = _se[d.iv4]
 scalar m3se7 = _se[l.iv4]
 ...
 * Calculating significance totals (Model 4)
 ...
 post `sim' (m1a1) (m1sea1) (m1ta1) (m1b0) (m1se0) (m1tb0) (m1b1) (m1se1) (m1tb1) (m1b2) (m1se2) (m1tb2) (m1b3) (m1se3) (m1tb3) (m1b4) (m1se4) (m1tb4) (m1b5) (m1se5) (m1tb5) ///
      ...
      (m3a1) (m3sea1) (m3ta1) (m3b0) (m3se0) (m3tb0) (m3b1) (m3se1) (m3tb1) (m3b2) (m3se2) (m3tb2) (m3b3) (m3se3) (m3tb3) (m3b4) (m3se4) (m3tb4) (m3b5) (m3se5) (m3tb5) ///
 			(m3b6) (m3se6) (m3tb6) (m3b7) (m3se7) (m3tb7) (m3asig) (m3asigMCV) (m3dxsig) (m3xlsig) (m3dxecm) (m3dxecmMCV) (m3lxecm) (m3lxecmMCV) ///
 		(m4a1) (m4sea1) (m4ta1) (m4b0) (m4se0) (m4tb0) (m4b1) (m4se1) (m4tb1) (m4b2) (m4se2) (m4tb2) (m4b3) (m4se3) (m4tb3) (m4asig) (m4asigMCV) (m4dxsig) (m4xlsig) ///
 		  (m4dxecm) (m4dxecmMCV) (m4lxecm) (m4lxecmMCV) (p2[1,1]) (rej2) (m4dw) ///
 		  
 }
 }
 postclose `sim'

 use KE_MC_TBLE10, clear
