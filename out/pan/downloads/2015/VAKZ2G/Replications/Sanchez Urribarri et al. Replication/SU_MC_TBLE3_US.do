...
* generating errors
 ...
 postfile `sim' da1 dsea1 dta1 db0 dse0 dtb0 db1 dse1 dtb1 db2 dse2 dtb2 db3 dse3 dtb3 db4 dse4 dtb4 db5 dse5 dtb5 db6 dse6 dtb6 db7 dse7 dtb7 db8 dse8 dtb8 db9 dse9 dtb9 dasig dasigMCV dadfull ddxsig dxlsig /// 
 	ddxecm ddxecmMCV dlxecm dlxecmMCV  using SU_MC_TBLE3_US, replace     
 ...
 replace iv1 = e in 2/$nobs
 replace iv2 = u in 2/$nobs
 replace iv3 = v in 2/$nobs
 replace iv4 = w in 2/$nobs
 replace iv5 = o in 2/$nobs
 ...
 * t-statistics
 ...
 post `sim' (da1) (dsea1) (dta1) (db0) (dse0) (dtb0) (db1) (dse1) (dtb1) (db2) (dse2) (dtb2) (db3) (dse3) (dtb3) (db4) (dse4) (dtb4) (db5) (dse5) (dtb5) (db6) (dse6) (dtb6) (db7) (dse7) (dtb7) ///
 		(db8) (dse8) (dtb8) (db9) (dse9) (dtb9) (dasig) (dasigMCV) (dadfull) (ddxsig) (dxlsig) (ddxecm) (ddxecmMCV) (dlxecm) (dlxecmMCV)
     
 }
 }
 postclose `sim'

 use SU_MC_TBLE3_US, clear

 sum dasig dasigMCV dadfull dta1 da1 ddxsig dxlsig ddxecm ddxecmMCV dlxecm dlxecmMCV
