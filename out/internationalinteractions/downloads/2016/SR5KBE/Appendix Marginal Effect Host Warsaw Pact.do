...
foreach var of varlist sample4 {

xtpcse defenseburden l.lntroops l.lntroops_spmean l.interaction l.spatial_lag l.polity l.growth l.lntpop l.IMR l.threat_environment war movav3 borderstates civilwar l.meanregionalallies l.meanregionalusallies l.warsawpact if `var'==1 , corr(ar1) pairwise	
...
graph export "MarginalEffect_Host_WarsawPact_20160408.pdf", replace
