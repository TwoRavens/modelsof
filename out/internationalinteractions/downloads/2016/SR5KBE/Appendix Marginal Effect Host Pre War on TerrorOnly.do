...
gen sample1 = 0
replace sample1 = 1 if year <= 2000
label var sample1 "All States"
gen sample2 = 0
replace sample2 = 1 if year <= 2000 & usally == 1 & NATO == 0
label var sample2 "Non-NATO Allies"
gen sample3 = 0
replace sample3 = 1 if year <= 2000 & NATO == 1
label var sample3 "NATO Allies"
gen sample4 = 0
replace sample4 = 1 if year <= 2000 & usally == 0
...
graph export "MarginalEffect_Host_PreWOT.pdf", replace
