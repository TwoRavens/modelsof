...
replace lntroops = 0 if troops<20
...
xtpcse defenseburden l.lntroops20 l.lntroops_spmean20 l.interaction20 l.spatial_lag l.polity l.growth l.lntpop l.IMR l.threat_environment war movav3 borderstates civilwar l.meanregionalallies l.meanregionalusallies if `var'==1 , corr(ar1) pairwise	
...
graph export "MarginalEffect_Host_TroopThreshold20_20160104.pdf", replace
