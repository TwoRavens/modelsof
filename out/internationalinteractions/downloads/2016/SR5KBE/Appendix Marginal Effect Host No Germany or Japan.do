...
xtpcse defenseburden l.lntroops l.lntroops_spmean l.interaction l.spatial_lag l.polity l.growth l.lntpop l.IMR l.threat_environment war movav3 borderstates civilwar l.meanregionalallies l.meanregionalusallies if `var'==1 & ccode!= 260 & ccode != 255 & ccode !=740 , corr(ar1) pairwise	
...
graph export "MarginalEffect_Host_NoGerJap_20150524.pdf", replace
